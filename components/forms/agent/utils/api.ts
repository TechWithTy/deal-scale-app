...
let agents: Agent[] = [
	{
		...
		name: "Q3 Phone Call Top Performer",
		type: "phone-call",
	...
	},
	{
		...
		id: "4",
		image: "/placeholder-agent.png",
		name: "Text Message Follow-up Agent",
		type: "text-message",
		description: "Handles SMS follow-up and reply-focused message sequences.",
		campaignGoal: "Book qualified SMS replies",
		salesScript: "Text follow-up sequence",
		persona: "Brief & helpful",
	},
	{
		isPublic: false,
		isFree: true,
		...
		id: "2",
		image: "/placeholder-agent.png",
		name: "LinkedIn DM Specialist",
		type: "linkedin",
		description: "Handles LinkedIn outreach and profile-first messaging.",
		campaignGoal: "Book qualified LinkedIn replies",
		salesScript: "LinkedIn intro sequence",
		persona: "Professional & concise",
	},
	{
		isPublic: false,
		isFree: true,
		...
		id: "3",
		image: "/placeholder-agent.png",
		name: "Facebook Messenger Specialist",
		type: "facebook",
		description: "Handles Facebook Messenger follow-up and local lead replies.",
		campaignGoal: "Convert Facebook conversations",
		salesScript: "Facebook messenger sequence",
		persona: "Friendly & responsive",
	},
];
