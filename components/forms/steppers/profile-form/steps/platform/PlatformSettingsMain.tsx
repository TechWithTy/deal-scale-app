"use client";
/**
 * PlatformSettingsMain: Platform Integration Settings Component
...
export interface PlatformSettingsMainProps {
	loading: boolean;
}
...
export const PlatformSettingsMain: React.FC<PlatformSettingsMainProps> = ({
	loading,
}) => {
