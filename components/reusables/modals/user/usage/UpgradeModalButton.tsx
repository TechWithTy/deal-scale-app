	...
	if (currentMembership.name === "Basic") {
		return (
			<Button
				...
				className="inline-flex items-center whitespace-nowrap rounded-full border bg-white text-gray-700 transition-colors duration-300 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
			>
