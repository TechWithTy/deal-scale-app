...
export default function QuickStartPage() {
	...
	}, [hasLeadListsAvailable, handleSmartCampaign, scheduleTimeout]);
	...
	const handleLoadSavedLookalikeConfig = useCallback(
		...
		[handleCloseSavedSearches, scheduleTimeout],
	);
	...
	const handleGenerateLookalike = useCallback(
		...
		[lookalikeStore, seedLeadListData, scheduleTimeout],
	);
