...
export default (api, options = {}) => {
	...
	const isCallerDevelopment = api.caller((caller) =>
		caller == null ? void 0 : caller.isDev,
	);
	...
	const useJsxRuntime =
		((_options_presetreact = options["preset-react"]) == null
			? void 0
			: _options_presetreact.runtime) === "automatic" ||
		(Boolean(api.caller((caller) => !!caller && caller.hasJsxRuntime)) &&
			((_options_presetreact1 = options["preset-react"]) == null
				? void 0
				: _options_presetreact1.runtime) !== "classic");
