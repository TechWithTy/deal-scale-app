...
const _headmanager = /*#__PURE__*/ _interop_require_default._(
	require("./head-manager"),
);
const _pageloader = /*#__PURE__*/ _interop_require_default._(
	require("./page-loader"),
);
const _performancerelayer = /*#__PURE__*/ _interop_require_default._(
	require("./performance-relayer"), // TODO: remove in the next major version
);
...
const _reporttosocket = /*#__PURE__*/ _interop_require_default._(
	require("./tracing/report-to-socket"),
);
	...
	return pageLoader
		...
		.then((param) => {
			...
			return Promise.resolve(
				(
					(_renderErrorProps_props = renderErrorProps.props) == null
						? void 0
						: _renderErrorProps_props.err
				)
...
function markHydrateComplete() {
	...
	if (hasBeforeRenderMark) {
		...
		if (
			process.env.NODE_ENV === "development" && // Old versions of Safari don't return `PerformanceMeasure`s from `performance.measure()`
...
function doRender(input) {
	...
	renderReactElement(appElement, (callback) =>
		/*#__PURE__*/ (0, _jsxruntime.jsx)(Root, {
			...
			children: process.env.__NEXT_STRICT_MODE
