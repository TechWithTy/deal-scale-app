...
function PseudoHtmlDiff(param) {
	...
	const [isHtmlCollapsed, toggleCollapseHtml] = (0, _react.useState)(
		shouldCollapse,
	);
	const htmlComponents = (0, _react.useMemo)(() => {
		...
		componentStack.forEach((component, index, componentList) => {
			...
			if ((isHtmlTagsWarning && isAdjacentTag) || isLastFewFrames) {
				...
				lastText = component;
				const wrappedCodeLine = /*#__PURE__*/ (0, _jsxruntime.jsxs)(
					_react.Fragment,
					{
						children: [
							codeLine,
				...
				if (!isHtmlCollapsed || isLastFewFrames) {
					nestedHtmlStack.push(
						/*#__PURE__*/ (0, _react.createElement)("span", {
							...adjProps,
		...
		if (!isHtmlTagsWarning) {
			...
			if (hydrationMismatchType === "text") {
				...
				wrappedCodeLine = /*#__PURE__*/ (0, _jsxruntime.jsxs)(
					_react.Fragment,
					{
						children: [
							/*#__PURE__*/ (0, _jsxruntime.jsx)("span", {
