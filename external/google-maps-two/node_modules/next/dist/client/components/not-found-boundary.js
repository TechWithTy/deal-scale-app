...
class NotFoundErrorBoundary extends _react.default.Component {
	componentDidCatch() {
		if (
			process.env.NODE_ENV === "development" && // A missing children slot is the typical not-found case, so no need to warn
...
function NotFoundBoundary(param) {
	...
	return notFound
		? /*#__PURE__*/ (0, _jsxruntime.jsx)(NotFoundErrorBoundary, {
				pathname: pathname,
				notFound: notFound,
