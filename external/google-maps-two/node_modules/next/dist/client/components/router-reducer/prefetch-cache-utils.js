 ...
 */ function createPrefetchCacheKey(url, nextUrl) {
	const pathnameFromUrl = (0, _createhreffromurl.createHrefFromUrl)(
		url, // Ensures the hash is not part of the cache key as it does not impact the server fetch
		false,
	);
...
function getOrCreatePrefetchCacheEntry(param) {
	...
	return createLazyPrefetchEntry({
		...
		prefetchCache,
		kind:
			kind || // in dev, there's never gonna be a prefetch entry so we want to prefetch here
