...
const _ondemandentriesclient = /*#__PURE__*/ _interop_require_default._(
	require("./dev/on-demand-entries-client"),
);
const _devbuildwatcher = /*#__PURE__*/ _interop_require_default._(
	require("./dev/dev-build-watcher"),
);
				...
				switch (payload.event) {
					...
					case _hotreloadertypes.HMR_ACTIONS_SENT_TO_BROWSER
						...
						if (!_.router.clc && pages.includes(_.router.pathname)) {
							...
							buildIndicatorHandler == null
								? void 0
								: buildIndicatorHandler.show();
							const clearIndicator = () =>
								buildIndicatorHandler == null
									? void 0
									: buildIndicatorHandler.hide();
							_.router
								.replace(
									_.router.pathname +
										"?" +
