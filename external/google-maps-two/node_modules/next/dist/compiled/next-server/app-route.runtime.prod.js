(() => {
			...
			"./dist/compiled/react/cjs/react.production.min.js": (e, t) => {
						...
						!(function e(t, o, a, s, i) {
									...
									case "object":
										switch (t.$$typeof) {
											...
											case n:
												...
												break;
											case f:
												return e((h = t._init)(t._payload), o, a, s, i);
										}
								}
							if (h)
								return (
							...
							if (w(t))
								...
								for (t = y.call(t), y = 0; !(s = t.next()).done; )
									(d = m + N((s = s.value), y++)), (h += e(s, o, a, d, i));
							else if ("object" === d) {
				...
				(t.Children = {
							...
							for (var n = arguments.length; r < n; r++) {
								...
								if (
									...
									null === a && (t.o = a = new WeakMap()),
										void 0 === (t = a.get(o)) && ((t = H()), a.set(o, t));
								} else
					...
					(t.cloneElement = function (e, t, n) {
						...
						if (null != t) {
							if (
								(void 0 !== t.ref && ((s = t.ref), (i = E.current)),
	...
	(() => {
		...
		r.r(v),
			r.d(v, {
				AppRouterContext: () => ex,
				GlobalLayoutRouterContext: () => eS,
				LayoutRouterContext: () => ew,
		...
		var I = r("./dist/compiled/react/index.js");
		...
		let ey = require("next/dist/client/components/request-async-storage.external.js"),
			eg = require("next/dist/client/components/action-async-storage.external.js");
		function ev(e) {
			if (
				"object" != typeof e ||
				null === e ||
		...
		class e_ extends x {
			...
			constructor({
				...
				if (
					...
					(this.requestAsyncStorage = ey.requestAsyncStorage),
					(this.staticGenerationAsyncStorage = E.staticGenerationAsyncStorage),
					(this.serverHooks = g),
					(this.actionAsyncStorage = eg.actionAsyncStorage),
				...
				let s = await this.actionAsyncStorage.run(
					{
						...
						isAction: (function (e) {
							...
							e.headers instanceof Headers
								? ((t = e.headers.get(w.toLowerCase()) ?? null),
									(r = e.headers.get("content-type")))
								: ((t = e.headers[w.toLowerCase()] ?? null),
																...
																"string" == typeof w &&
																	...
																	((f && "default" === w) ||
																		(function (...e) {
																			...
																			`fetch for ${c} on ${u.urlPathname} specified "cache: ${w}" and "revalidate: ${y}", only one should be specified.`,
																		),
																	(w = void 0)),
																	"force-cache" === w
																		? (y = !1)
