	...
	(function () {
			...
			if (config != null) {
				...
				for (propName in config) {
					if (
						...
						propName !== "key" &&
						enableRefAsProp && // Even though we don't use these anymore in the runtime, we don't want
			...
			if (config != null) {
				...
				for (propName in config) {
					if (
						hasOwnProperty.call(config, propName) && // Skip over reserved prop names
						propName !== "key" &&
						enableRefAsProp && // ...and maybe these, too, though we currently rely on them for
		...
		var TaintRegistryObjects = ReactServerSharedInternals.TaintRegistryObjects,
			...
			TaintRegistryPendingRequests =
				ReactServerSharedInternals.TaintRegistryPendingRequests; // This is the shared constructor of all typed arrays.

		var TypedArrayConstructor = getPrototypeOf(
