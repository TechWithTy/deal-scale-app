...
declare class EventTarget<
	TEventMap extends Record<string, Event$1> = Record<string, Event$1>,
...
declare namespace EventTarget {
	 ...
	 */
	type EventData<
		TEventMap extends Record<string, Event$1>,
		TMode extends "standard" | "strict",
		TEventType extends string,
	> = TMode extends "strict"
		? IsValidEventMap<TEventMap> extends true
			? ExplicitType<TEventType> &
					Omit<TEventMap[TEventType], keyof Event$1> &
					Partial<Omit<Event$1, "type">>
			: never
		: never;
	/**
	...
	> = TMode extends "standard"
		? EventListener<TEventTarget, Event$1> | null | undefined
		: never;
	/**
	...
	type FallbackEvent<TMode extends "standard" | "strict"> =
		TMode extends "standard" ? Event$1 : never;
	/**
