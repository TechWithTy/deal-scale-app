...
function assertValidReturnValue(kind, value) {
	...
	if (1 === kind) {
		...
		var hint;
		throw (
			((hint = 0 === kind ? "field" : 5 === kind ? "class" : "method"),
...
function applyMemberDec(
	...
	var desc,
		...
		set,
		decs = decInfo[0];
	decoratorsHaveThis || Array.isArray(decs) || (decs = [decs]),
		isPrivate
			? (desc =
					0 === kind || 1 === kind
						? {
	...
	for (
		var inc = decoratorsHaveThis ? 2 : 1, i = decs.length - 1;
		i >= 0;
		i -= inc
	) {
		var newInit;
		if (
			...
			(newValue = memberDec(
				decs[i],
				decoratorsHaveThis ? decs[i - 1] : void 0,
				name,
				desc,
				initializers,
				kind,
	...
	if (0 === kind || 1 === kind) {
		if (void 0 === init)
			...
			init = function init(instance, _init2) {
				for (var value = _init2, i = ownInitializers.length - 1; i >= 0; i--)
		...
		for (
			...
			try {
				var nextNewClass = classDecs[i].call(
					decoratorsHaveThis ? classDecs[i - 1] : void 0,
					newClass,
					{
						kind: "class",
						name: name,
			...
			void 0 !== nextNewClass &&
				(assertValidReturnValue(5, nextNewClass), (newClass = nextNewClass));
		}
		return [
			newClass,
			function () {
