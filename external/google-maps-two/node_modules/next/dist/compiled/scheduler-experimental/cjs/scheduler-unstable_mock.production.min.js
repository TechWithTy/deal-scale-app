...
function k(a) {
	...
	if (c !== b) {
		a[0] = c;
		a: for (var d = 0, e = a.length, z = e >>> 1; d < z; ) {
			var u = 2 * (d + 1) - 1,
				A = a[u],
				v = u + 1,
				F = a[v];
			if (0 > g(A, c))
				v < e && 0 > g(F, A)
					? ((a[d] = F), (a[v] = c), (d = v))
					: ((a[d] = A), (a[u] = c), (d = u));
			else if (v < e && 0 > g(F, c)) (a[d] = F), (a[v] = c), (d = v);
			else break a;
		}
	}
	return b;
...
function M(a) {
	...
	if (!t)
		if (null !== h(l)) (t = !0), (y = N);
			...
			var b = h(m);
			null !== b && ((a = b.startTime - a), (B = M), (C = x + a));
		}
}
function N(a, b) {
	t = !1;
