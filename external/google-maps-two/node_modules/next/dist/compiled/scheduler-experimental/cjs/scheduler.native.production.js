...
const unstable_IdlePriority =
	typeof nativeRuntimeScheduler !== "undefined"
		...
		: IdlePriority;
const unstable_LowPriority =
	typeof nativeRuntimeScheduler !== "undefined"
		? nativeRuntimeScheduler.unstable_LowPriority
		: LowPriority;
const unstable_ImmediatePriority =
	typeof nativeRuntimeScheduler !== "undefined"
...
const unstable_now =
	typeof nativeRuntimeScheduler !== "undefined"
		...
		: getCurrentTime; // These were never implemented on the native scheduler because React never calls them.
