...
function P(a, b, c) {
	...
	if (a && a.defaultProps)
		for (e in ((k = a.defaultProps), k)) void 0 === d[e] && (d[e] = k[e]);
	return { $$typeof: l, type: a, key: f, ref: h, props: d, _owner: O.current };
}
function Q(a, b) {
	return {
		$$typeof: l,
...
function W(a, b, c, e, d) {
	...
	if (I(a))
		for (var g = 0; g < a.length; g++)
			(e = a[g]), (f = k + T(e, g)), (h += W(e, b, c, f, d));
	else if (((g = A(a)), "function" === typeof g))
		for (a = g.call(a), g = 0; !(e = a.next()).done; )
			(e = e.value), (f = k + T(e, g++)), (h += W(e, b, c, f, d));
	else if ("object" === f) {
...
exports.cloneElement = function (a, b, c) {
	...
	if (null != b) {
		...
		for (g in b)
			N.call(b, g) &&
				...
				"__self" !== g &&
				"__source" !== g &&
				(e[g] = void 0 === b[g] && void 0 !== k ? k[g] : b[g]);
	}
	...
	return { $$typeof: l, type: a.type, key: d, ref: f, props: e, _owner: h };
};
...
exports.lazy = function (a) {
	return { $$typeof: y, _payload: { _status: -1, _result: a }, _init: aa };
};
