...
// @ts-ignore
const https_proxy_agent_1 = __importDefault(
	require("next/dist/compiled/https-proxy-agent"),
);
// @ts-ignore
const http_proxy_agent_1 = __importDefault(
	require("next/dist/compiled/http-proxy-agent"),
);
/**
