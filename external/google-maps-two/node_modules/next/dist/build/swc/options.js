...
function getParserOptions({ filename, jsConfig, ...rest }) {
	...
	const enableDecorators = Boolean(
		jsConfig == null
			? void 0
			: (_jsConfig_compilerOptions = jsConfig.compilerOptions) == null
				? void 0
...
function getBaseSWCOptions({
	...
	var _jsConfig_compilerOptions,
		...
		_jsConfig_compilerOptions3,
		_jsConfig_compilerOptions4;
	...
	const enableDecorators = Boolean(
		jsConfig == null
			? void 0
			: (_jsConfig_compilerOptions1 = jsConfig.compilerOptions) == null
				? void 0
				: _jsConfig_compilerOptions1.experimentalDecorators,
	);
	const emitDecoratorMetadata = Boolean(
		jsConfig == null
			...
			: (_jsConfig_compilerOptions2 = jsConfig.compilerOptions) == null
				? void 0
				: _jsConfig_compilerOptions2.emitDecoratorMetadata,
	);
	const useDefineForClassFields = Boolean(
		jsConfig == null
			? void 0
			: (_jsConfig_compilerOptions3 = jsConfig.compilerOptions) == null
				? void 0
				: _jsConfig_compilerOptions3.useDefineForClassFields,
	);
	...
	return {
			...
			transform: {
				...
				react: {
					importSource:
						(jsConfig == null
							? void 0
							: (_jsConfig_compilerOptions4 = jsConfig.compilerOptions) == null
								? void 0
								: _jsConfig_compilerOptions4.jsxImportSource) ??
						((compilerOptions == null ? void 0 : compilerOptions.emotion) &&
						!isReactServerLayer
							? "@emotion/react"
							: "react"),
					runtime: "automatic",
		...
		removeConsole:
			compilerOptions == null ? void 0 : compilerOptions.removeConsole,
		...
		...(!isReactServerLayer && {
			...
			styledComponents: getStyledComponentsOptions(
				compilerOptions == null ? void 0 : compilerOptions.styledComponents,
				development,
			),
		}),
		serverComponents:
...
function getLoaderSWCOptions({
	...
	if (isAppBrowserLayer && isNodeModules) {
		...
		if (
			(_options_jsc_transform_optimizer_globals =
				options.jsc.transform.optimizer.globals) == null
				? void 0
				: _options_jsc_transform_optimizer_globals.typeofs
		) {
