...
function normalizeCatchAllRoutes(
	appPaths,
	normalizer = new _apppathnamenormalizer.AppPathnameNormalizer(),
) {
	const catchAllRoutes = [
		...new Set(
			Object.values(appPaths)
				.flat()
				.filter(isCatchAllRoute) // Sorting is important because we want to match the most specific path.
	...
	const filteredAppPaths = Object.keys(appPaths).filter(
		(route) => !(0, _interceptionroutes.isInterceptionRouteAppPath)(route),
	);
