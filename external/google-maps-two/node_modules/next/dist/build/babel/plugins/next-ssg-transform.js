...
function decorateSsgExport(t, path, state) {
	const gsspName = state.isPrerender
		? _constants1.STATIC_PROPS_ID
		: _constants1.SERVER_PROPS_ID;
		...
		if (b == null ? void 0 : b.referenced) {
			...
			if (b.path.type === "FunctionDeclaration") {
				return !b.constantViolations
					.concat(b.referencePaths) // Check that every reference is contained within the function:
							...
							VariableDeclarator(variablePath, variableState) {
								if (variablePath.node.id.type === "Identifier") {
									...
									elements.forEach((e) => {
										...
										let local;
										if (
											((_e_node = e.node) == null ? void 0 : _e_node.type) ===
											"Identifier"
										) {
											local = e;
										} else if (
											((_e_node1 = e.node) == null ? void 0 : _e_node1.type) ===
											"RestElement"
										) {
