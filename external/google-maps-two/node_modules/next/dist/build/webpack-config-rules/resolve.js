...
const mainFieldsPerCompiler = {
	...
	[_constants.COMPILER_NAMES.server]: ["main", "module"],
	[_constants.COMPILER_NAMES.client]: ["browser", "module", "main"],
...
function getMainField(compilerType, preferEsm) {
	...
	return preferEsm
		...
		: mainFieldsPerCompiler[_constants.COMPILER_NAMES.server];
}
