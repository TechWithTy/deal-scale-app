...
const _unistore = /*#__PURE__*/ _interop_require_default(
...
buildStore.subscribe((state) => {
	...
	if (
		client.loading ||
		server.loading ||
		(edgeServer == null ? void 0 : edgeServer.loading)
	) {
		_store.store.setState(
			{
				bootstrap: false,
	...
	let partialState = {
		...
		totalModulesCount:
			...
			(edgeServerWasLoading
				? (edgeServer == null ? void 0 : edgeServer.totalModulesCount) || 0
				: 0),
...
function watchCompilers(client, server, edgeServer) {
	...
	function tapCompiler(key, compiler, onEvent) {
		...
		compiler.hooks.done.tap(`NextJsDone-${key}`, (stats) => {
			...
			const { errors, warnings } = (0, _formatwebpackmessages.default)(
				stats.toJson({
