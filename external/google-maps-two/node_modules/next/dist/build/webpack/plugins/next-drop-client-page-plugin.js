				...
				function findEntryModule(mod) {
					...
					for (const module1 of queue) {
						const incomingConnections =
							compilation.moduleGraph.getIncomingConnections(module1);
				...
				function handler(parser) {
					...
					parser.hooks.preDeclarator.tap(PLUGIN_NAME, (declarator) => {
						...
						if (
							(declarator == null
								? void 0
								: (_declarator_id = declarator.id) == null
									? void 0
									: _declarator_id.name) ===
							_constants.STRING_LITERAL_DROP_BUNDLE
						) {
							markAsAmpFirst();
						}
					});
							...
							if (
								module1 == null
									...
									: (_module_buildInfo = module1.buildInfo) == null
										? void 0
										: _module_buildInfo.NEXT_ampFirst
							) {
