...
const _postcssmoduleslocalbydefault = /*#__PURE__*/ _interop_require_default(
	require("next/dist/compiled/postcss-modules-local-by-default"),
);
...
const _camelcase = /*#__PURE__*/ _interop_require_default(
	require("./camelcase"),
);
...
function requestify(url, rootContext) {
	...
	return url.charAt(0) === "/"
		? (0, _loaderutils3.urlToRequest)(url, rootContext)
		: (0, _loaderutils3.urlToRequest)(url);
}
		...
		if (localName) {
			code = code.replace(new RegExp(replacementName, "g"), () =>
				options.modules.namedExport
					? `" + ${importName}_NAMED___[${JSON.stringify((0, _camelcase.default)(localName))}] + "`
