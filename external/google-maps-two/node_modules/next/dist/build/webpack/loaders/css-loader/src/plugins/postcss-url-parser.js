...
const _postcssvalueparser = /*#__PURE__*/ _interop_require_default(
	require("next/dist/compiled/postcss-value-parser"),
);
					...
					const resolvedDeclarations = await Promise.all(
						parsedDeclarations.map(async (parsedDeclaration) => {
							...
							const request = (0, _utils.requestify)(
								pathname,
								rootContext, // @ts-expect-error TODO: only 2 arguments allowed.
								needToResolveURL,
							);
							if (!needToResolveURL) {
								// eslint-disable-next-line consistent-return
