...
const _postcssnextfont = /*#__PURE__*/ _interop_require_default(
	require("./postcss-next-font"),
);
...
async function nextFontLoader() {
	...
	return nextFontLoaderSpan.traceAsyncFn(async () => {
		...
		if (/pages[\\/]_document\./.test(relativeFilePathFromRoot)) {
			const err = new Error(
				`${(0, _picocolors.bold)("Cannot")} be used within ${(0, _picocolors.cyan)("pages/_document.js")}.`,
			);
		...
		try {
			...
			let { css, fallbackFonts, adjustFontFallback, weight, style, variable } =
				await nextFontLoaderSpan.traceChild("font-loader").traceAsyncFn(() =>
					fontLoader({
						...
						emitFontFile,
						resolve: (src) =>
							(0, _util.promisify)(this.resolve)(
			...
			const fontFamilyHash = _loaderutils3.default.getHashDigest(
				Buffer.from(css),
				"sha1",
				"hex",
				6,
