...
const _CssSyntaxError = /*#__PURE__*/ _interop_require_default(
	require("./CssSyntaxError"),
);
const _Warning = /*#__PURE__*/ _interop_require_default(
	require("../../postcss-loader/src/Warning"),
);
		...
		.traceAsyncFn(async () => {
			...
			if (shouldUseURLPlugin(options)) {
				...
				plugins.push(
					urlParser({
						...
						urlHandler: (url) =>
							(0, _stringifyrequest.stringifyRequest)(this, url),
					}),
				);
			}
			...
			try {
				...
				throw error.name === "CssSyntaxError"
					? new _CssSyntaxError.default(error)
					: error;
			}
