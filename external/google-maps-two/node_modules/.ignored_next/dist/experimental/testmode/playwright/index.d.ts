...
export declare function defineConfig<T extends NextOptionsConfig, W>(
	config: base.PlaywrightTestConfig<T, W>,
): base.PlaywrightTestConfig<T, W>;
export declare const test: base.TestType<
	base.PlaywrightTestArgs &
		base.PlaywrightTestOptions & {
			next: NextFixture;
			nextOptions: NextOptions;
		},
	base.PlaywrightWorkerArgs &
		base.PlaywrightWorkerOptions & {
