...
export const getContentType =
	"getType" in send.mime
		? (extWithoutDot) => send.mime.getType(extWithoutDot)
		: (extWithoutDot) => send.mime.lookup(extWithoutDot);
export const getExtension =
	"getExtension" in send.mime
		? (contentType) => send.mime.getExtension(contentType)
		: (contentType) => send.mime.extension(contentType);
