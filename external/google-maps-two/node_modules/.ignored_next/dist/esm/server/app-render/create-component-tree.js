...
async function createComponentTreeInternal({
	...
	const parallelRouteMap = await Promise.all(
		Object.keys(parallelRoutes).map(async (parallelRouteKey) => {
			...
			if (
				...
				isPrefetch &&
				(Loading || !hasLoadingComponentInTree(parallelRoute)) && // The approach with PPR is different — loading.tsx behaves like a
	...
	const loadingData = Loading
		? [/*#__PURE__*/ _jsx(Loading, {}), loadingStyles, loadingScripts]
		: null;
