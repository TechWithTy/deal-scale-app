...
async function renderToHTMLOrFlightImpl(
	...
	(_getTracer_getRootSpanAttributes = getTracer().getRootSpanAttributes()) ==
	null
		? void 0
		...
		async ({ asNotFound, tree, formState }) => {
			...
			try {
					...
					if (usedDynamicAPIs(prerenderState)) {
						...
						if (usedDynamicAPIs(prerenderState)) {
							...
							if (postponed != null) {
								...
								const resumeChildren = /*#__PURE__*/ _jsx(
				...
				const errorServerStream = ComponentMod.renderToReadableStream(
					/*#__PURE__*/ _jsx(ReactServerError, {
						tree: tree,
						ctx: ctx,
						errorType: errorType,
					}),
