...
function assignDefaults(dir, userConfig, silent) {
	...
	if (
		(_defaultConfig_experimental = defaultConfig.experimental) == null
			? void 0
...
export default async function loadConfig(
	...
	if (path == null ? void 0 : path.length) {
		...
		if (nonJsPath == null ? void 0 : nonJsPath.length) {
			throw new Error(
				`Configuring Next.js via '${basename(nonJsPath)}' is not supported. Please replace the file with 'next.config.js' or 'next.config.mjs'.`,
			);
		}
	}
