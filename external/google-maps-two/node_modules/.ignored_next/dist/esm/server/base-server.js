...
export default class Server {
	...
	async renderToResponseWithComponentsImpl(
		...
		if (
			...
			isRSCRequest &&
			!isDynamicRSCRequest &&
			(!isEdgeRuntime(opts.runtime) || this.serverOptions.webServerConfig)
		) {
			stripFlightHeaders(req.headers);
		}
		...
		if (!cachedData) {
			...
			if (
				...
				((_cachedData_headers = cachedData.headers) == null
					? void 0
					: _cachedData_headers[NEXT_CACHE_TAGS_HEADER])
			) {
				res.setHeader(
	...
	async renderPageComponent(ctx, bubbleNoFallback) {
		...
		if (result) {
			...
			(_getTracer_getRootSpanAttributes =
				getTracer().getRootSpanAttributes()) == null
				? void 0
