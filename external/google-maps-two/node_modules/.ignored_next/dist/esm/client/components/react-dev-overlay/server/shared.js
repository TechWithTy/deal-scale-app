...
/** React that's compiled with `next`. Used by App Router. */ const reactVendoredRe =
	/[\\/]next[\\/]dist[\\/]compiled[\\/](react|react-dom|react-server-dom-(webpack|turbopack)|scheduler)[\\/]/;
/** React the user installed. Used by Pages Router, or user imports in App Router. */ const reactNodeModulesRe =
...
/** Given a frame, it parses which package it belongs to. */ export function findSourcePackage(
	param,
) {
 ...
 */ export function getOriginalCodeFrame(frame, source) {
	...
	if (
		...
		((_frame_file = frame.file) == null
			? void 0
			: _frame_file.includes("node_modules")) ||
	...
	return codeFrameColumns(
		source,
		{
			start: {
				...
				line:
					(_frame_lineNumber = frame.lineNumber) != null
						? _frame_lineNumber
						: -1,
