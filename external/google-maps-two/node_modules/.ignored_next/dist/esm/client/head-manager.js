...
if (process.env.__NEXT_STRICT_NEXT_HEAD) {
	updateElements = (type, components) => {
		...
		if (!headEl) return;
		const headMetaTags =
			headEl.querySelectorAll('meta[name="next-head"]') || [];
		const oldTags = [];
		if (type === "meta") {
		...
		for (let i = 0; i < headMetaTags.length; i++) {
			...
			if (
				(headTag == null
					? void 0
					: (_headTag_tagName = headTag.tagName) == null
						? void 0
						: _headTag_tagName.toLowerCase()) === type
			) {
		...
		oldTags.forEach((t) => {
			...
			if (metaTag && metaTag.getAttribute("name") === "next-head") {
				var _t_parentNode1;
				(_t_parentNode1 = t.parentNode) == null
					? void 0
					: _t_parentNode1.removeChild(metaTag);
			}
			(_t_parentNode = t.parentNode) == null
				? void 0
				: _t_parentNode.removeChild(t);
		});
		newTags.forEach((t) => {
			var _t_tagName;
			...
			if (
				!(
					((_t_tagName = t.tagName) == null
						? void 0
						: _t_tagName.toLowerCase()) === "meta" && t.getAttribute("charset")
				)
			) {
	...
	updateElements = (type, components) => {
		...
		for (
			...
			if (
				(j == null
					? void 0
					: (_j_tagName = j.tagName) == null
						? void 0
						: _j_tagName.toLowerCase()) === type
			) {
				oldTags.push(j);
			}
		}
		...
		oldTags.forEach((t) => {
			var _t_parentNode;
			return (_t_parentNode = t.parentNode) == null
				? void 0
				: _t_parentNode.removeChild(t);
		});
