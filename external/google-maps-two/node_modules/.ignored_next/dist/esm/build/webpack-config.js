...
export default async function getBaseWebpackConfig(
	...
	if (!loggedSwcDisabled && !useSWCLoader && babelConfigFile) {
		Log.info(
			`Disabled SWC as replacement for Babel because of custom Babel configuration "${path.relative(dir, babelConfigFile)}" https://nextjs.org/docs/messages/swc-disabled`,
		);
					...
					test(module) {
						const resource =
							module.nameForCondition == null
								? void 0
								: module.nameForCondition.call(module);
						return resource
