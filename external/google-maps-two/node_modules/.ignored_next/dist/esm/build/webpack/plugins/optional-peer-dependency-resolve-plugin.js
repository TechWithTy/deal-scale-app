	...
	apply(resolver) {
		...
		target.tapAsync(
			...
			(request, resolveContext, callback) => {
				...
				(_resolveContext_stack = resolveContext.stack) == null
					? void 0
					: _resolveContext_stack.delete(
							Array.from(resolveContext.stack).pop(),
						);
				resolver.doResolve(
					target, // when we call doResolve again, we need to make sure we don't
					...
					(err, result) => {
						...
						if (
							...
							(request == null
								? void 0
								: (_request_descriptionFileData =
											request.descriptionFileData) == null
									? void 0
									: _request_descriptionFileData.peerDependenciesMeta) &&
							request.request
						) {
