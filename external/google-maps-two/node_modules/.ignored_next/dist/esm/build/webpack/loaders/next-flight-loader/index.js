...
export default function transformSource(source, sourceMap) {
	...
	if (
		(_this__module = this._module) == null
			...
			: (_this__module_matchResource = _this__module.matchResource) == null
				? void 0
				: _this__module_matchResource.startsWith(BARREL_OPTIMIZATION_PREFIX)
	) {
	...
	if (
		((_buildInfo_rsc = buildInfo.rsc) == null
			? void 0
			: _buildInfo_rsc.type) === RSC_MODULE_TYPES.client
	) {
...
export { e${cnt++} as ${ref} };`;
	...
	if (
		((_buildInfo_rsc1 = buildInfo.rsc) == null
			? void 0
			: _buildInfo_rsc1.type) !== RSC_MODULE_TYPES.client
	) {
