...
export function isActionServerLayerEntryModule(mod) {
	...
	return !!(
		(rscInfo == null ? void 0 : rscInfo.actions) &&
		(rscInfo == null ? void 0 : rscInfo.type) === RSC_MODULE_TYPES.server
	);
}
...
function isActionClientLayerModule(mod) {
	...
	return !!(
		(rscInfo == null ? void 0 : rscInfo.actions) &&
		(rscInfo == null ? void 0 : rscInfo.type) === RSC_MODULE_TYPES.client
	);
}
...
export function getActionsFromBuildInfo(mod) {
	...
	return (_mod_buildInfo = mod.buildInfo) == null
		? void 0
		: (_mod_buildInfo_rsc = _mod_buildInfo.rsc) == null
			? void 0
			: _mod_buildInfo_rsc.actions;
}
...
export async function getLoaderModuleNamedExports(resourcePath, context) {
	...
	const exportNames =
		((_mod_dependencies = mod.dependencies) == null
			? void 0
			: _mod_dependencies
					.filter((dep) => {
						return (
