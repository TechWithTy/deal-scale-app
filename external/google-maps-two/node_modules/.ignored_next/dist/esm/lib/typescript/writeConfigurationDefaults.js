...
export async function writeConfigurationDefaults(
	...
	Log.info(
		`We detected TypeScript in your project and reconfigured your ${cyan("tsconfig.json")} file for you. Strict-mode is set to ${cyan("false")} by default.`,
	);
	if (suggestedActions.length) {
		Log.info(
			`The following suggested values were added to your ${cyan("tsconfig.json")}. These values ${cyan("can be changed")} to fit your project's needs:\n`,
		);
