...
*/
"use strict";
var e = require("next/dist/compiled/react-experimental"),
	f = {
...
exports.preconnect = function (b, a) {
	...
	c &&
		...
		(a
			? ((a = a.crossOrigin),
				(a =
					"string" === typeof a ? ("use-credentials" === a ? a : "") : void 0))
			: (a = null),
		c.preconnect(b, a));
};
...
exports.preinit = function (b, a) {
	...
	if (c && "string" === typeof b && a && "string" === typeof a.as) {
		var d = a.as,
			g = k(d, a.crossOrigin),
			p = "string" === typeof a.integrity ? a.integrity : void 0,
			q = "string" === typeof a.fetchPriority ? a.fetchPriority : void 0;
		"style" === d
			? c.preinitStyle(
					b,
					"string" === typeof a.precedence ? a.precedence : void 0,
					{ crossOrigin: g, integrity: p, fetchPriority: q },
				)
			: "script" === d &&
				c.preinitScript(b, {
					crossOrigin: g,
