...
function updateFormStateImpl(
	...
	const _updateReducerImpl = updateReducerImpl(
			stateHook,
			currentStateHook,
			formStateReducer,
		),
...
function observeVisibleRects(hostRoot, selectors, callback, options) {
	...
	const _setupIntersectionObs = setupIntersectionObserver(
			instanceRoots,
			callback,
			options,
		),
...
function commitRootImpl(
	...
	if (
		...
		didIncludeRenderPhaseUpdate ||
		didIncludeCommitPhaseUpdate || // Was the finished render the result of an update (not hydration)?
