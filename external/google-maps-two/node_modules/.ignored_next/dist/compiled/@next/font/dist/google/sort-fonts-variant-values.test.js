...
describe("sortFontsVariantValues", () => {
	it("should correctly compare and return result for plain integer values", () => {
		...
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("100", "200"),
		).toBe(-100);
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("200", "100"),
		).toBe(100);
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("50", "150"),
		).toBe(-100);
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("150", "50"),
		).toBe(100);
	});
	it("should correctly compare and return result for comma-separated values", () => {
		// Testing "ital,wght" format
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("1,100", "0,200"),
		).toBe(1);
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("0,200", "1,100"),
		).toBe(-1);
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("1,100", "1,200"),
		).toBe(-100);
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("1,200", "1,100"),
		).toBe(100);
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("0,100", "0,200"),
		).toBe(-100);
		expect(
			(0, sort_fonts_variant_values_1.sortFontsVariantValues)("0,200", "0,100"),
		).toBe(100);
	});
