...
function findFontFilesInCss(css, subsetsToPreload) {
	...
	for (const line of css.split("\n")) {
		...
		if (newSubset) {
			...
			const googleFontFileUrl =
				(_b = /src: url\((.+?)\)/.exec(line)) === null || _b === void 0
					? void 0
					: _b[1];
			if (
				googleFontFileUrl &&
				...
				fontFiles.push({
					googleFontFileUrl,
					preloadFontFile: !!(subsetsToPreload === null ||
					subsetsToPreload === void 0
						? void 0
						: subsetsToPreload.includes(currentSubset)),
				});
			}
		}
	}
