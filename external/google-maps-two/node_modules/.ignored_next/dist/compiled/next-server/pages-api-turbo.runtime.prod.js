(() => {
	...
	(() => {
		...
		(function (e) {
			...
			((N || (N = {})).executeRoute = "Router.executeRoute"),
			((j || (j = {})).runHandler = "Node.runHandler"),
			...
			((A || (A = {})).execute = "Middleware.execute");
		...
		let O = (e) => {
			...
			P = (e, t = !1) =>
				(t ? 'W/"' : '"') + O(e).toString(36) + e.length.toString(36) + '"';
		...
		var q = r("./dist/compiled/@edge-runtime/cookies/index.js"),
			$ = r("./dist/compiled/content-type/index.js");
		async function I(e, t) {
			let n, o;
			try {
				n = (0, $.parse)(e.headers["content-type"] || "text/plain");
			} catch {
				n = (0, $.parse)("text/plain");
			}
		...
		async function K(e, t, n, s, d, c, g, y) {
			try {
				...
				null == (w = c.api) || w.externalResolver,
					v(
						{ req: e },
						"cookies",
						((S = e.headers),
				...
				let g = 0,
					y = m && "boolean" != typeof m ? H().parse(m) : 4194304,
					R = t.write,
					C = t.end;
				(t.write = (...e) => (
					(g += Buffer.byteLength(e[0] || "")), R.apply(t, e)
				)),
					(t.end = (...r) => (
						r.length &&
							"function" != typeof r[0] &&
							(g += Buffer.byteLength(r[0] || "")),
						m &&
							g >= y &&
							console.warn(
								`API response for ${e.url} exceeds ${H().format(y)}. API Routes are meant to respond quickly. https://nextjs.org/docs/messages/api-routes-response-size-limit`,
							),
						C.apply(t, r)
					)),
