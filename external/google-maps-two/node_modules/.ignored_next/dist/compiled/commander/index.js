			...
			class Command extends n {
				...
				_registerOption(t) {
					...
					if (e) {
						...
						throw new Error(
							`Cannot add option '${t.flags}'${this._name && ` to command '${this._name}'`} due to conflicting flag '${i}'\n-  already used by option '${e.flags}'`,
						);
					}
					this.options.push(t);
				}
				...
				_checkForConflictingLocalOptions() {
					...
					e.forEach((e) => {
						const i = t.find((t) =>
							e.conflictsWith.includes(t.attributeName()),
						);
						if (i) {
		...
		853: (t, e, i) => {
			...
			class Help {
				...
				optionDescription(t) {
					...
					if (t.argChoices) {
						e.push(
							`choices: ${t.argChoices.map((t) => JSON.stringify(t)).join(", ")}`,
						);
					}
				...
				formatHelp(t, e) {
					...
					const h = e
						.visibleArguments(t)
						.map((t) =>
							formatItem(e.argumentTerm(t), e.argumentDescription(t)),
						);
					if (h.length > 0) {
