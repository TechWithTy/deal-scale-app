			...
			(function (e, i) {
				...
				pe.parsePropertyValue = function (e, t, i, s, r, a, n, o) {
					...
					if (this.eat(m.colon)) {
						...
						this.type !== m.comma && this.type !== m.braceR &&
						this.type !== m.eq
					) {
						if (i || s) {
							this.unexpected();
				...
				var xe = ge + " Extended_Pictographic";
				var ve = xe;
				var ye = ve + " EBase EComp EMod EPres ExtPict";
				var ke = ye;
				var be = ke;
				var _e = { 9: ge, 10: xe, 11: ve, 12: ye, 13: ke, 14: be };
				var Se =
				...
				var Te =
					Ne + " Hrkt Katakana_Or_Hiragana Kawi Nag_Mundari Nagm Unknown Zzzz";
				var Ve = { 9: Ee, 10: Ie, 11: Ae, 12: Pe, 13: Ne, 14: Te };
				var Le = {};
				function buildUnicodeData(e) {
					var t = (Le[e] = {
						binary: wordsRegexp(_e[e] + " " + we),
						binaryOfStrings: wordsRegexp(Ce[e]),
						nonBinary: {
							General_Category: wordsRegexp(we),
							Script: wordsRegexp(Ve[e]),
						},
					});
				...
				var Be = K.prototype;
				var Me = function RegExpValidationState(e) {
					this.parser = e;
					this.validFlags =
						"gim" +
					...
					this.unicodeProperties =
						Le[e.options.ecmaVersion >= 14 ? 14 : e.options.ecmaVersion];
					this.source = "";
					this.flags = "";
					this.start = 0;
					this.switchU = false;
				...
				Me.prototype.reset = function reset(e, t, i) {
					var s = i.indexOf("v") !== -1;
					var r = i.indexOf("u") !== -1;
					this.start = e | 0;
					this.source = t + "";
				...
				Me.prototype.raise = function raise(e) {
					this.parser.raiseRecoverable(
						this.start,
						"Invalid regular expression: /" + this.source + "/: " + e,
					);
				};
				Me.prototype.at = function at(e, t) {
					if (t === void 0) t = false;
					var i = this.source;
					var s = i.length;
					if (e >= s) {
				...
				Me.prototype.nextIndex = function nextIndex(e, t) {
					if (t === void 0) t = false;
					var i = this.source;
					var s = i.length;
					if (e >= s) {
				...
				Me.prototype.current = function current(e) {
					if (e === void 0) e = false;
					return this.at(this.pos, e);
				};
				Me.prototype.lookahead = function lookahead(e) {
					if (e === void 0) e = false;
					return this.at(this.nextIndex(this.pos, e), e);
				};
				Me.prototype.advance = function advance(e) {
					if (e === void 0) e = false;
					this.pos = this.nextIndex(this.pos, e);
				};
				Me.prototype.eat = function eat(e, t) {
					if (t === void 0) t = false;
					if (this.current(t) === e) {
						this.advance(t);
						return true;
				...
				Me.prototype.eatChars = function eatChars(e, t) {
					if (t === void 0) t = false;
					var i = this.pos;
				...
				Be.regexp_validateUnicodePropertyNameAndValue = function (e, t, i) {
				...
				Be.regexp_classContents = function (e) {
					if (e.current() === 93) {
						return Ue;
					}
					if (e.switchV) {
				...
				Be.regexp_nonEmptyClassRanges = function (e) {
				...
				Be.regexp_classSetExpression = function (e) {
					var t = Ue,
						i;
				...
				Be.regexp_eatClassSetRange = function (e) {
					var t = e.pos;
				...
				Be.regexp_eatClassSetOperand = function (e) {
					if (this.regexp_eatClassSetCharacter(e)) {
						return Ue;
					}
					return (
				...
				Be.regexp_eatNestedClass = function (e) {
					var t = e.pos;
					if (e.eat(91)) {
						var i = e.eat(94);
				...
				Be.regexp_eatClassStringDisjunction = function (e) {
					var t = e.pos;
				...
				Be.regexp_classStringDisjunctionContents = function (e) {
					var t = this.regexp_classString(e);
					while (e.eat(124)) {
						if (this.regexp_classString(e) === qe) {
							t = qe;
						}
					}
					return t;
				};
				Be.regexp_classString = function (e) {
					var t = 0;
				...
				Be.regexp_eatClassSetCharacter = function (e) {
					var t = e.pos;
					if (e.eat(92)) {
						if (
							this.regexp_eatCharacterEscape(e) ||
				...
				Be.regexp_eatClassSetReservedPunctuator = function (e) {
					var t = e.current();
