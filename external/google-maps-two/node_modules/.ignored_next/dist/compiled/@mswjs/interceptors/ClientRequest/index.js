	...
	var e = {
		501: function (e, t, r) {
			...
			function cloneIncomingMessage(e) {
				...
				Object.defineProperty(t, d, { enumerable: true, value: true });
				return t;
			}
			...
			var v = class extends i.ClientRequest {
				...
				write(...e) {
					...
					this.logger.info("write:", { chunk: r, encoding: n, callback: s });
					...
					this.emitter.emit("request", { request: a, requestId: t });
					c.until
						.call(void 0, async () => {
							await this.emitter.untilIdle(
								"request",
								({ args: [{ requestId: e }] }) => e === t,
							);
				...
				emit(e, ...t) {
					...
					if (e === "error") {
						...
						if (
							this.responseSource === "mock" &&
							v.suppressErrorCodes.includes(r)
						) {
				...
				passthrough(e, t, r) {
					...
					return super.end(...[e, t, r].filter(Boolean));
				}
				respondWith(e) {
					...
					if (n) {
						...
						n.forEach((e, t) => {
							...
							this.response.headers[r] = n
								? Array.prototype.concat([], n, e)
								: e;
						});
					}
			...
			function cloneObject(e) {
				...
				return isPlainObject(e)
					? t
					: Object.assign(Object.getPrototypeOf(e), t);
			}
			function isObject(e) {
			...
			function normalizeClientRequestArgs(e, ...t) {
				...
				if (typeof t[0] === "string") {
					...
					if (r.hostname === null) {
						...
						return isObject(t[1])
							? normalizeClientRequestArgs(e, { path: r.path, ...t[1] }, t[2])
							: normalizeClientRequestArgs(e, { path: r.path }, t[1]);
					}
					P.info("given legacy url is absolute");
					const n = new URL(r.href);
					return t[1] === void 0
						? normalizeClientRequestArgs(e, n)
						: typeof t[1] === "function"
							? normalizeClientRequestArgs(e, n, t[1])
							: normalizeClientRequestArgs(e, n, t[1], t[2]);
				...
				if (typeof n.agent === "undefined") {
					const e =
						n.protocol === "https:"
							? new (0, a.Agent)({ rejectUnauthorized: n.rejectUnauthorized })
							: new (0, i.Agent)();
					n.agent = e;
				...
				if (!n._defaultAgent) {
					...
					n._defaultAgent =
						n.protocol === "https:" ? a.globalAgent : i.globalAgent;
				}
			...
			var L = class extends s.Interceptor {
				...
				setup() {
					...
					for (const [t, r] of this.modules) {
						...
						const i = { emitter: this.emitter, logger: this.logger };
		...
		331: function (e, t, r) {
			"use strict";
			Object.defineProperty(t, "__esModule", { value: true });
			var n = ((e) => (true ? require : 0))(function (e) {
				if (true) return require.apply(this, arguments);
			...
			function createDeferredExecutor() {
				const executor = (e, t) => {
					...
					executor.resolve = (t) => {
						...
						return e(
							t instanceof Promise ? t : Promise.resolve(t).then(onFulfilled),
						);
					};
					executor.reject = (e) => {
						if (executor.state !== "pending") {
			...
			var h = class {
				constructor(e) {
					...
					if (n) {
						...
						this.success = isDefinedAndNotEquals(r, "success")
							? noop
							: this.success;
						this.warning = isDefinedAndNotEquals(r, "warning")
							? noop
							: this.warning;
		...
		426: function (e) {
			...
			function flattenHeadersList(e) {
				return e.map(([e, t]) => [e, [].concat(t).join(", ")]);
			}
		...
		576: function (e) {
			...
			var __toCommonJS = (e) =>
				__copyProps(t({}, "__esModule", { value: true }), e);
			var i = {};
			__export(i, { isNodeProcess: () => isNodeProcess });
			e.exports = __toCommonJS(i);
		...
		162: function (e) {
			...
			var __toCommonJS = (e) =>
				__copyProps(t({}, "__esModule", { value: true }), e);
			var i = {};
			__export(i, { Emitter: () => u, MemoryLeakError: () => o });
			e.exports = __toCommonJS(i);
