...
var t = { current: null },
	u = { ReactCurrentDispatcher: t, ReactCurrentOwner: { current: null } },
	v = { ReactCurrentCache: n };
function w(a) {
...
function R(a, b, d, c, e) {
			...
			case "object":
				switch (a.$$typeof) {
					...
					case z:
						...
						break;
					case G:
						return (g = a._init), R(g(a._payload), b, d, c, e);
				}
		}
	if (g)
		return (
	...
	if (x(a))
		for (var h = 0; h < a.length; h++)
			(c = a[h]), (f = k + O(c, h)), (g += R(c, b, d, f, e));
	else if (((h = I(a)), "function" === typeof h))
		for (a = h.call(a), h = 0; !(c = a.next()).done; )
			(c = c.value), (f = k + O(c, h++)), (g += R(c, b, d, f, e));
	else if ("object" === f) {
		if ("function" === typeof a.then) return R(Q(a), b, d, c, e);
		b = String(a);
		throw Error(
			w(
				31,
...
exports.Children = {
	...
	only: function (a) {
		if (!M(a)) throw Error(w(143));
		return a;
	},
};
exports.Fragment = A;
exports.Profiler = C;
exports.StrictMode = B;
exports.Suspense = E;
...
exports.cache = function (a) {
	return function () {
		...
		try {
			...
			throw ((g = b), (g.s = 2), (g.v = k), k);
		}
	};
};
exports.cloneElement = function (a, b, d) {
	if (null === a || void 0 === a) throw Error(w(267, a));
	var c = m({}, a.props),
		e = a.key,
		f = a.ref,
		g = a._owner;
	if (null != b) {
		void 0 !== b.ref && ((f = b.ref), (g = K.current));
		...
		for (h in b)
			J.call(b, h) &&
				...
				"__self" !== h &&
				"__source" !== h &&
				(c[h] = void 0 === b[h] && void 0 !== k ? k[h] : b[h]);
	}
	...
	return { $$typeof: y, type: a.type, key: e, ref: f, props: c, _owner: g };
};
exports.createElement = function (a, b, d) {
	...
	if (1 === k) e.children = d;
		...
		for (var h = Array(k), l = 0; l < k; l++) h[l] = arguments[l + 2];
		e.children = h;
	}
	if (a && a.defaultProps)
		for (c in ((k = a.defaultProps), k)) void 0 === e[c] && (e[c] = k[c]);
	return { $$typeof: y, type: a, key: f, ref: g, props: e, _owner: K.current };
};
...
exports.lazy = function (a) {
	return { $$typeof: G, _payload: { _status: -1, _result: a }, _init: T };
};
exports.memo = function (a, b) {
	return { $$typeof: F, type: a, compare: void 0 === b ? null : b };
};
exports.startTransition = function (a) {
	var b = W.transition,
		d = new Set();
	W.transition = { _callbacks: d };
	var c = W.transition;
	try {
		var e = a();
		"object" === typeof e &&
