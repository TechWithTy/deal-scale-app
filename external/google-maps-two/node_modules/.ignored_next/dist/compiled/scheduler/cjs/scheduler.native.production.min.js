...
function k(a) {
	...
	if (b !== c) {
		a[0] = b;
		a: for (var d = 0, e = a.length, x = e >>> 1; d < x; ) {
			var y = 2 * (d + 1) - 1,
				D = a[y],
				m = y + 1,
				z = a[m];
			if (0 > g(D, b))
				m < e && 0 > g(z, D)
					? ((a[d] = z), (a[m] = b), (d = m))
					: ((a[d] = D), (a[y] = b), (d = y));
			else if (m < e && 0 > g(z, b)) (a[d] = z), (a[m] = b), (d = m);
			else break a;
		}
	}
	return c;
...
void 0 !== navigator.scheduling.isInputPending
	...
	: null;
function H(a) {
	for (var c = h(t); null !== c; ) {
		if (null === c.callback) k(t);
		else if (c.startTime <= a) k(t), (c.sortIndex = c.expirationTime), f(r, c);
		else break;
		c = h(t);
	}
}
function I(a) {
	...
	H(a);
	if (!B)
		if (null !== h(r)) (B = !0), J || ((J = !0), K());
		else {
			var c = h(t);
			null !== c && L(I, c.startTime - a);
		}
}
function M(a, c, b) {
	var d = l();
	"object" === typeof b && null !== b
		? ((b = b.delay), (b = "number" === typeof b && 0 < b ? d + b : d))
		: (b = d);
	switch (a) {
		case 1:
			var e = -1;
	...
	b > d
		? ((a.sortIndex = b),
			...
			null === h(r) &&
				a === h(t) &&
				(C ? (F(N), (N = -1)) : (C = !0), L(I, b - d)))
		: ((a.sortIndex = e), f(r, a), B || A || ((B = !0), J || ((J = !0), K())));
	return a;
}
function O(a) {
	a.callback = null;
		...
		try {
			a: {
				...
				try {
					b: {
						H(a);
						for (v = h(r); null !== v && !(v.expirationTime > a && R()); ) {
							var d = v.callback;
							if ("function" === typeof d) {
								v.callback = null;
								w = v.priorityLevel;
								var e = d(v.expirationTime <= a);
								a = l();
...
exports.unstable_IdlePriority =
	"undefined" !== typeof nativeRuntimeScheduler
		...
		: 5;
exports.unstable_ImmediatePriority = aa;
exports.unstable_LowPriority = Y;
exports.unstable_NormalPriority = X;
exports.unstable_Profiling = null;
exports.unstable_UserBlockingPriority = W;
exports.unstable_cancelCallback = ca;
exports.unstable_continueExecution = Z;
exports.unstable_forceFrameRate = Z;
exports.unstable_getCurrentPriorityLevel = da;
exports.unstable_getFirstCallbackNode = Z;
exports.unstable_next = Z;
exports.unstable_now = ha;
exports.unstable_pauseExecution = Z;
exports.unstable_requestPaint = fa;
exports.unstable_runWithPriority = Z;
exports.unstable_scheduleCallback = ba;
exports.unstable_shouldYield = ea;
