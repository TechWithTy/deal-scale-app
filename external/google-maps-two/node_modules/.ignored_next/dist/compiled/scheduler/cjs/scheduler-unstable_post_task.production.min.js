...
function n(c, d, b, f) {
	...
	try {
		...
		if ("function" === typeof e) {
			var p = { signal: b._controller.signal },
				q = n.bind(null, c, d, b, e);
			void 0 !== h.yield
				? h.yield(p).then(q).catch(r)
				: h.postTask(q, p).catch(r);
		}
	} catch (t) {
		g(function () {
			throw t;
...
exports.unstable_scheduleCallback = function (c, d, b) {
	...
	var e = new TaskController({ priority: f });
	b = {
		delay: "object" === typeof b && null !== b ? b.delay : 0,
		signal: e.signal,
	};
	e = { _controller: e };
	h.postTask(n.bind(null, c, f, e, d), b).catch(r);
	return e;
};
