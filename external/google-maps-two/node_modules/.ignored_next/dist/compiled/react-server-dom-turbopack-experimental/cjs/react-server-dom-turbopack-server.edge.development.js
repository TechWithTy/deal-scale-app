...
if (process.env.NODE_ENV !== "production") {
	(function () {
		...
		var requestStorage = supportsRequestStorage
			...
			: null; // We use the Node version but get access to async_hooks from a global.
		...
		var TaintRegistryObjects = ReactSharedServerInternals.TaintRegistryObjects,
			...
			TaintRegistryByteLengths =
				ReactSharedServerInternals.TaintRegistryByteLengths,
			TaintRegistryPendingRequests =
				ReactSharedServerInternals.TaintRegistryPendingRequests,
