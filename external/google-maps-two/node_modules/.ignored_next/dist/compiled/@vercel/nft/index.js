	...
	var __webpack_modules__ = {
		...
		2821: (e, t, r) => {
			...
			function get_node_abi(e, t) {
				...
				if (!t) {
					throw new Error(
						"get_node_abi requires valid process.versions object",
					);
				}
		...
		1121: function (e, t, r) {
			...
			const E = s(r(5841));
			const w = r(7310);
			const x = f.Parser.extend(r(1913).J);
			const C = s(r(2037));
			const F = r(3939);
			const S = s(r(2382));
			const A = {
			...
			async function analyze(e, t, r) {
							...
							if (r) {
								for (const t of e.specifiers) {
									if (t.type === "ImportNamespaceSpecifier")
										...
										setKnownBinding(t.local.name, {
											value: r[t.imported.name],
										});
								}
							}
						} else if (
				...
				async function backtrack(e, t) {
					if (!Z)
						throw new Error(
							"Internal error: No staticChildNode for backtrack.",
						);
			...
			class Job {
				...
				async emitDependency(e, t) {
					...
					if (e.endsWith(".js") || e.endsWith(".ts")) {
						...
						if (t)
							await this.emitFile(t + c.sep + "package.json", "resolve", e);
					}
					let s;
		...
		9770: (e, t, r) => {
			...
			const a = {
				...
				CallExpression: async function CallExpression(e, r) {
					...
					let f;
					let d =
						e.arguments.length > 0 && e.callee.property?.name !== "concat";
					const p = [];
			...
			const parse = (e, t = {}) => {
				...
				while (R < k) {
					...
					if (T === o) {
						push({
							type: "text",
							value: (t.keepEscaping ? T : "") + advance(),
						});
						continue;
					}
					if (T === D) {
		...
		3844: (e, t) => {
			...
			t.horizontalAbsolute = function horizontalAbsolute(e) {
				if (e == null)
					throw new Error(
						"horizontalAboslute requires a column to position to",
					);
				return r + e + "G";
			};
		...
		7783: (e, t, r) => {
			...
			const fillNumbers = (e, t, r = 1, s = {}) => {
				...
				let push = (e) =>
					D[e < 0 ? "negatives" : "positives"].push(Math.abs(e));
				let y = [];
				let m = 0;
				while (u ? a >= o : a <= o) {
			...
			const _ = function dataToEsm(e, t = {}) {
				...
				for (const [f, d] of Object.entries(e)) {
					if (f === m(f)) {
						...
						u += `export ${o} ${f}${s}=${s}${serialize(d, t.compact ? null : r, "")};${a}`;
					} else {
						c.push(
