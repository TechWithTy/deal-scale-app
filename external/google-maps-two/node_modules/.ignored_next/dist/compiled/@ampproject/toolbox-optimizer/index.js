(() => {
	var __webpack_modules__ = {
			...
			class FileSystemCache {
				static create(e = {}) {
					...
					try {
						...
						l.debug(
							"No filesystem access, falling back to in-memory cache only",
							e,
						);
						return new c(t.maxItems);
					}
					return new FileSystemCache(t);
				}
				constructor(e) {
					this.opts = e;
					this.cache = new c(e.maxItems);
				}
				async get(e, t = null) {
				...
				async clear() {
					...
					let t = await i.readdir(e, { withFileTypes: true });
					await Promise.all(
						t.map((t) => {
							let r = u.join(e, t.name);
							return t.isFile() && t.name.endsWith(".json")
								? i.unlink(r)
								: Promise.resolve();
						}),
					);
		...
		6564: (e) => {
			"use strict";
			const t = { value: 0, isExpired: () => true };
			class MaxAge {
				static zero() {
					return t;
				}
				...
				toObject() {
					return { timestampInMs: this.timestampInMs_, maxAge: this.maxAge };
				}
			}
			e.exports = MaxAge;
		},
		8414: (e, t, r) => {
			...
			async function oneBehindFetch(e, t) {
				let r = s.get(e);
				if (!r) {
					r = { maxAge: Promise.resolve(n.zero()) };
					s.set(e, r);
				}
				...
				r = {
					responsePromise: l,
					maxAge: l.then((e) => n.parse(e.headers.get("cache-control"))),
				};
				s.set(e, r);
				const c = o || l;
				const u = await c;
		...
		8846: (e, t, r) => {
			...
			e.exports = {
				...
				isTemplate: (e) => {
					...
					if (
						e.tagName === "script" &&
						i(e, "template") &&
						e.attribs.template === "amp-mustache"
					) {
						return true;
					}
					return false;
				...
				isAmpStory: (e) => {
					for (const t of e.children) {
						if (
							isAmpScriptImport(t) &&
							t.attribs["custom-element"] === "amp-story"
						) {
							return true;
						}
					}
			...
			function isAmpScriptImport(e) {
				...
				const t =
					e.attribs["custom-element"] || e.attribs["custom-template"] || "";
				if (!t.startsWith("amp-")) {
					return false;
				}
				return true;
		...
		3338: (e, t, r) => {
			function __ncc_wildcard$0(e) {
				if (e === "AddAmpLink") return r(4311);
				else if (e === "AddBlurryImagePlaceholders") return r(4949);
				else if (e === "AddMandatoryTags") return r(8256);
				else if (e === "AddTransformedFlag") return r(9494);
				else if (e === "AmpBoilerplateErrorHandler") return r(4975);
				else if (e === "AmpBoilerplateTransformer") return r(9097);
				else if (e === "AmpScriptCsp") return r(5557);
				else if (e === "ApplyCommonAttributes") return r(6070);
				else if (e === "ApplyLayout") return r(9464);
				else if (e === "AutoExtensionImporter") return r(5414);
				else if (e === "GoogleFontsPreconnect") return r(5141);
				else if (e === "Markdown") return r(9433);
				else if (e === "MinifyHtml") return r(1031);
				else if (e === "OptimizeAmpBind") return r(8046);
				else if (e === "OptimizeHeroImages") return r(6037);
				else if (e === "OptimizeImages") return r(714);
				else if (e === "PreloadHeroImage") return r(743);
				else if (e === "PreloadImages") return r(3842);
				else if (e === "PruneDuplicateResourceHints") return r(3144);
				else if (e === "RemoveAmpAttribute") return r(1865);
				else if (e === "RemoveCspNonce") return r(9401);
				else if (e === "ReorderHeadTransformer") return r(707);
				else if (e === "RewriteAmpUrls") return r(7185);
				else if (e === "SeparateKeyframes") return r(2079);
				else if (e === "ServerSideRendering") return r(4626);
			}
			("use strict");
			const i = r(3484);
			const n = r(255);
			...
			e.exports = {
				...
				DEFAULT_CONFIG: f,
				TRANSFORMATIONS_AMP_FIRST: c,
				TRANSFORMATIONS_PAIRED_AMP: u,
				TRANSFORMATIONS_MINIMAL: d,
			};
		},
		9170: (e) => {
			"mode strict";
			...
			function findRuntimeScript(e) {
				for (let t = e.firstChild; t !== null; t = t.nextSibling) {
					if (
						t.tagName === "script" &&
						t.attribs.src &&
						t.attribs.src.match(/^https:\/\/.+\/v0(\.js|\.mjs)$/)
					) {
						return t;
					}
				}
		...
		4056: (e) => {
			"use strict";
			const t = ["px", "em", "rem", "vh", "vw", "vmin", "vmax"];
			const r = [
				"nodisplay",
				"fixed",
				"responsive",
			...
			function cssLength(e, r = false, i = false) {
				const n = {
					isValid: false,
					isSet: false,
					isAuto: false,
		...
		859: (e, t, r) => {
			"use strict";
			const { AMP_CACHE_HOST: i, appendRuntimeVersion: n } = r(8846);
			function calculateHost({
				...
				if (r && s) {
					throw new Error(
						"lts flag is not compatible with runtime version parameter",
					);
				}
				e = e.replace(/\/$/, "");
				if (t && s) {
			...
			e.exports = { calculateHost: calculateHost };
		},
		3484: (e, t, r) => {
			"use strict";
			const { Parser: i } = r(250);
			const { DomHandler: n, NodeWithChildren: s } = r(945);
			const { appendAll: a } = r(2547);
			const o = r(4404)["default"];
			const l = { decodeEntities: false };
			class TreeParser {
				constructor(e) {
					this.options = e;
				}
		...
		3741: (e) => {
			...
			e.exports = { isValidImageSrcURL: isValidImageSrcURL };
		},
		351: (e, t, r) => {
			"use strict";
			...
			const a = i.create({
				log: s,
				baseDir: n.join(__dirname, "..", ".cache"),
			});
			e.exports = a;
		},
		5900: (e, t, r) => {
		...
		2412: (e, t, r) => {
			...
			const {
				AMP_CACHE_HOST: a,
				AMP_RUNTIME_CSS_PATH: o,
				AMP_VALIDATION_RULES_URL: l,
				appendRuntimeVersion: c,
			} = r(8846);
			const u = "validator-rules";
			const d = 10 * 60;
			let f = false;
			async function fetchRuntimeParameters(e, t = {}) {
			...
			async function initValidatorRules(e, t, r) {
				try {
					e.validatorRules =
						t.validatorRules ||
						r.validatorRules ||
						(await fetchValidatorRulesFromCache_(r));
				} catch (e) {
				...
				try {
					e.componentVersions =
						t.componentVersions ||
						r.componentVersions ||
						(await fetchComponentVersionsFromCache_(r, e));
				} catch (t) {
			...
			async function fetchComponentVersionsFromCache_(e, t) {
				const i = `component-versions-${t.ampRuntimeVersion}`;
			...
			async function fetchComponentVersions_(e, t) {
				...
				const n = `https://raw.githubusercontent.com/ampproject/amphtml/${r}/build-system/compile/bundles.config.extensions.json`;
				const s = await e.fetch(n);
				if (!s.ok) {
					throw new Error(
						`Failed fetching latest component versions from ${i} with status: ${s.status}`,
					);
				}
				return s.json();
			}
			async function fetchValidatorRulesFromCache_(e) {
				...
				if (!t) {
					...
					r = await n.fetch({ rules: t });
				}
				return r;
			}
			async function fetchValidatorRules_(e) {
				const t = await e.fetch(l);
				if (!t.ok) {
					return null;
				}
				return n.fetch({ rules: await t.json() });
			}
			...
			async function fetchAmpRuntimeVersion_(e) {
				const t = `version-${e.ampUrlPrefix}-${e.lts}`;
			...
			async function fetchLatestRuntimeData_(
				...
				n = {
					...
					maxAge: s.create(d).toObject(),
				};
				if (!n.version && t !== a) {
					e.log.error(
						`Could not download runtime version from ${t}. Falling back to ${a}`,
					);
					n = await fetchLatestRuntimeData_(
						{ config: e, ampUrlPrefix: a, lts: r },
						i,
					);
				} else if (n.version && i) {
					writeToCache_(e, i, n);
			...
			async function fetchAmpRuntimeStyles_(e, t, r) {
				if (t && !isAbsoluteUrl_(t)) {
					e.log.warn(
						`AMP runtime styles cannot be fetched from relative ampUrlPrefix, please use the 'ampRuntimeStyles' parameter to provide the correct runtime style. Falling back to latest v0.css on ${a}`,
					);
					t = a;
				...
				if (!n) {
					e.log.error(
						`Could not download ${i}. Falling back to latest v0.css.`,
					);
					if (t || r) {
						return fetchAmpRuntimeStyles_(
							e,
							a,
							await e.runtimeVersion.currentVersion(),
						);
					} else {
						return "";
					}
			...
			async function downloadAmpRuntimeStyles_(e, t) {
				...
				if (!r) {
					...
					e.log.debug(`Downloaded AMP runtime styles from ${t}`);
					if (e.cache !== false) {
						writeToCache_(e, t, r);
					}
				}
			...
			const parseSizes = (e) => {
				...
				for (let i = 0; i < r.length; i++) {
					...
					if (i === r.length - 1) {
						...
						const r = n.split(/\)\s+/);
						if (r.length !== 2) {
							throw new Error(`Invalid sizes definition '${e}'`);
						}
						t.values.push({ media: `${r[0]})`, size: r[1] });
					}
				}
				return t;
			};
		...
		4311: (e, t, r) => {
			"use strict";
			const { firstChildByTag: i, createElement: n, appendChild: s } = r(2547);
			class AddAmpLink {
				transform(e, t) {
					if (!t.ampUrl) return;
					const r = i(e, "html");
					...
					const a = i(r, "head");
					if (!a) return;
					const o = n("link", { rel: "amphtml", href: t.ampUrl });
					s(a, o);
				}
			}
		...
		4949: (e, t, r) => {
			...
			const { URL: l } = r(7310);
			const { skipNodeAndChildren: c } = r(7041);
			const u = r(1150);
			const d = 60;
			const f = 100;
			const p = 30;
			const h = -1;
			const { isTemplate: m } = r(8846);
			const g = {
				"#": "%23",
				"%": "%25",
				":": "%3A",
			...
			class AddBlurryImagePlaceholders {
				constructor(e) {
					...
					this.jimp = r(4645);
					this.maxBlurredPlaceholders_ = e.maxBlurredPlaceholders || f;
				...
				transform(e, t) {
					if (
						(!t.blurredPlaceholders && !this.blurredPlaceholders_) ||
						this.missingDependencies_
					) {
						return;
					}
					const r = o(e, "html");
				...
				async getDataURI_(e) {
					const t = /^https?:\/\//.test(e)
						? { headers: { "User-Agent": "AMP Optimizer" }, url: e }
						: e;
				...
				getBitmapDimensions_(e, t) {
					...
					i = Math.sqrt(i);
					const n = d / i;
					return { width: Math.round(n), height: Math.round(i) };
				}
				hasPlaceholder_(e) {
					return (
						e.childNodes.find(
							(e) => e.attribs && e.attribs.placeholder !== undefined,
						) !== undefined
					);
				}
				shouldAddBlurryPlaceholder_(e, t, r) {
					...
					const i = new l(t, "https://example.com");
					...
					const s =
						r == "amp-img" &&
						(e.attribs.layout == "intrinsic" ||
							e.attribs.layout == "responsive" ||
							e.attribs.layout == "fill");
					return n || s;
				}
			}
		...
		8256: (e, t, r) => {
			...
			const { AMP_FORMATS: u, AMP_TAGS: d } = r(8846);
			const f = "AMP";
			const p = "data-auto";
			const h = {
				AMP: [
					{
						matcher: { tagName: "meta", attribs: { charset: "utf-8" } },
						node: { tagName: "meta", attribs: { charset: "utf-8" } },
					},
					{
						matcher: { tagName: "meta", attribs: { name: "viewport" } },
						node: {
							tagName: "meta",
							attribs: {
								name: "viewport",
					...
					{
						matcher: { tagName: "noscript" },
						node: {
							tagName: "noscript",
							children: [
								{
									tagName: "style",
									attribs: { "amp-boilerplate": "" },
					...
					{
						matcher: { tagName: "style", attribs: { "amp-boilerplate": "" } },
						node: {
							tagName: "style",
							attribs: { "amp-boilerplate": "" },
					...
					},
					{
						matcher: {
							tagName: "script",
							attribs: { src: /^https:\/\/.+\/v0\.js$/ },
						},
						node: {
							tagName: "script",
							attribs: { async: "", src: "https://cdn.ampproject.org/v0.js" },
						},
					},
					{
						matcher: { tagName: "link", attribs: { rel: "canonical" } },
						node: {
							tagName: "link",
							attribs: {
								rel: "canonical",
								href: (e, t) => {
									if (!e.canonical) {
										t.warn(
											"No canonical param is given. Setting canonical href to `.`",
										);
										e.canonical = ".";
									}
									return e.canonical;
			...
			class AddMandatoryTags {
				constructor(e) {
					this.enabled =
						e.autoAddBoilerplate !== false && e.autoAddMandatoryTags !== false;
					this.format = e.format || f;
				...
				async transform(e, t) {
					...
					let n = e.children.find(
						(e) => e.type === "directive" && e.name === "!doctype",
					);
					if (!n) {
						n = o();
						a(e, n, e.firstChild);
					}
					if (!Object.keys(i.attribs).some((e) => d.includes(e))) {
		...
		9494: (e, t, r) => {
			"use strict";
			const { firstChildByTag: i } = r(2547);
		...
		9097: (e, t, r) => {
			"use strict";
			const { insertText: i, hasAttribute: n, firstChildByTag: s } = r(2547);
			class AmpBoilerplateTransformer {
				...
				transform(e, t) {
					...
					let { ampRuntimeVersion: o, ampRuntimeStyles: l } = t;
					if (!o || !l) {
						this.log_.error(
		...
		5557: (e, t, r) => {
			...
			class AmpScriptCsp {
				...
				_findOrCreateCspMeta(e) {
					...
					const t = s("meta", { name: "amp-script-src" });
					n(e, t);
					return t;
				}
			}
		...
		6070: (e, t, r) => {
			...
			const { isCustomElement: l } = r(9170);
			const c = "i-amp-";
			...
			class SizesTransformer {
				...
				toString() {
					...
					for (const { sizes: t, defaultSize: r, id: i } of this.sizes) {
						...
						e += `${n}{width:${r}}`;
						for (const r of t) {
							e += `@media ${r.media}{${n}{width:${r.size}}}`;
						}
					}
					return e;
				}
			...
			class HeightsTransformer {
				...
				toString() {
					...
					for (const { heights: t, defaultHeight: r, id: i } of this.heights) {
						const n = `#${i}>:first-child`;
						e += `${n}{padding-top:${r}}`;
						for (const r of t) {
							e += `@media ${r.media}{${n}{padding-top:${r.size}}}`;
						}
					}
					return e;
				}
			...
			class ApplyCommonAttributes {
						...
						for (const [i, n] of Object.entries(
							...
							if (o(e, i)) {
								try {
									...
									this.log.debug(
										`Cannot remove boilerplate. Failed transforming ${i}="${e.attribs[i]}".`,
										t,
									);
				...
				getOrCreateId(e) {
					...
					e.attribs = e.attribs || [];
					const t = c + this.transformedNodesCounter;
					this.transformedNodesCounter++;
					if (this.ids.has(t)) {
		...
		9464: (e, t, r) => {
			...
			const {
				...
				calculateLayout: d,
				getLayoutClass: f,
				isLayoutSizeDefined: p,
				getLayoutSizeDefinedClass: h,
			} = r(4056);
			const m = [
				"",
				"nodisplay",
			...
			function apply(e, t, r, i) {
				...
				switch (e) {
					case "nodisplay":
						...
						break;
					case "fixed":
						n = `width:${t.numeral}${t.unit};height:${r.numeral}${r.unit};`;
						break;
					case "fixed-height":
						n = `height:${r.numeral}${r.unit};`;
						break;
					case "responsive":
						break;
					case "intrinsic":
			...
			function createIntrinsicSizer(e, t) {
				const r = s("i-amphtml-sizer", { class: "i-amphtml-sizer" });
				const i = s("img", {
					alt: "",
					"aria-hidden": "true",
					...
					src:
						...
						Buffer.from(
							`<svg height="${t.numeral}" width="${e.numeral}" xmlns="http://www.w3.org/2000/svg" version="1.1"/>`,
						).toString("base64"),
				});
				a(r, i);
				return r;
		...
		5414: (e, t, r) => {
			...
			const { findMetaViewport: l, findRuntimeScript: c } = r(7041);
			const { AMP_FORMATS: u, AMP_CACHE_HOST: d } = r(8846);
			const f = "bind";
			const p = "data-amp-bind-";
			const h = "AMP";
			const m = new Map([["lightbox", "amp-lightbox-gallery"]]);
			...
			class AutoExtensionImporter {
				constructor(e) {
					...
					this.experimentBindAttributeEnabled =
						e.experimentBindAttribute === true;
				...
				createExtensionsSpec(e) {
					...
					for (const e of t.extensions) {
						if (e.htmlFormat.includes(this.format)) {
							r.set(e.name, {
								name: e.name,
								type:
									e.extensionType === "CUSTOM_TEMPLATE"
										? "custom-template"
										: "custom-element",
					...
					for (const e of t.getTagsForFormat(this.format)) {
						...
						for (const i of e.attrs) {
							if (m.has(i.name)) {
								i.requiresExtension = [m.get(i.name)];
							}
				...
				async transform(e, t) {
					...
					if (!t.validatorRules) {
						this.log_.error(
							"Missing validation rules, cannot auto import extensions",
						);
						return;
					}
					...
					const f = new Set();
					const p = new Set();
					this.findExistingExtensionsAndExtensionsToImportInHead_(i, f, p);
					await this.findExtensionsToImportInBody_(o, f);
					if (f.length === 0) {
						return;
					}
					let h = c(i);
				...
				findExistingExtensionsAndExtensionsToImportInHead_(e, t, r) {
					...
					while (n) {
						...
						if (e) {
							...
							n.tagName === "script" &&
							n.attribs["id"] === "amp-subscriptions"
						) {
				...
				getJson(e) {
					for (const t of e.children || []) {
						...
						try {
							...
							this.log_.error(
								'Could not parse JSON in <script id="amp-access">',
								e.message,
							);
						}
					}
		...
		5141: (e, t, r) => {
			"use strict";
			const { insertAfter: i, createElement: n, firstChildByTag: s } = r(2547);
			const { findMetaViewport: a } = r(7041);
			class GoogleFontsPreconnect {
				...
				transform(e) {
					...
					for (let e = r.firstChild; e !== null; e = e.nextSibling) {
						if (this.isGoogleFontsLinkNode_(e)) {
							...
							i(r, e, s);
							this.log_.debug(
								'adding <link rel="preconnect" href="' +
									e.attribs.href +
									'" crossorigin>',
							);
							i(r, t, e);
							this.log_.debug(
								'adding <link rel="dns-prefetch" href="' +
									t.attribs.href +
									'">',
							);
							return;
				...
				isGoogleFontsLinkNode_(e) {
					return (
						e.tagName === "link" &&
						e.attribs.rel === "stylesheet" &&
						e.attribs.href.startsWith("https://fonts.googleapis.com")
					);
				}
			}
		...
		9433: (e, t, r) => {
			"use strict";
			const i = r(1150);
			const { fetchImageDimensions: n } = r(5900);
			const {
				remove: s,
				insertAfter: a,
				createElement: o,
			...
			class Markdown {
				...
				async transformImg(e, t) {
					...
					const l = this.createAmpImgOrAmpAnim(o, e);
					a(e.parent, l, e);
					s(e);
				}
		...
		1031: (e, t, r) => {
			...
			class MinifyHtml {
				...
				async minifyNode(e, t, r) {
					...
					if (
						t.canCollapseWhitespace &&
						!this.canCollapseWhitespace(e.tagName)
					) {
				...
				isInlineAmpScript(e) {
					return (
						e.attribs &&
						e.attribs.type === "text/plain" &&
						e.attribs.target === "amp-script"
					);
				}
				isJson(e) {
					return (
						e.attribs &&
						(e.attribs.type === "application/json" ||
							e.attribs.type === "application/ld+json")
					);
				}
				canCollapseWhitespace(e) {
					return (
						"script" !== e && "style" !== e && "pre" !== e && "textarea" !== e
					);
				}
				canTrimWhitespace(e) {
		...
		8046: (e, t, r) => {
			const { nextNode: i, firstChildByTag: n, setAttribute: s } = r(2547);
			const { skipNodeAndChildren: a } = r(7041);
			const { isTemplate: o } = r(8846);
		...
		6037: (e, t, r) => {
			...
			const { findMetaViewport: u, skipNodeAndChildren: d } = r(7041);
			const { isValidImageSrcURL: f } = r(3741);
			const { isTemplate: p, isAmpStory: h } = r(8846);
			const m = 150;
			const g = 2;
			class OptimizeHeroImage {
				constructor(e) {
					this.log = e.log;
					this.enabled =
						e.optimizeHeroImages !== false || e.preloadHeroImage !== false;
				...
				async transform(e, t) {
					...
					if (
						!this.enabled ||
						t.optimizeHeroImages === false ||
						t.preloadHeroImage === false
					) {
						return;
					}
					...
					if (l > r) {
						this.log.warn(
							`Found ${l} hero elements on the page, but the maximum is set to ${r}. The limit can be configured via the 'maxHeroImage' parameter.`,
						);
						l = r;
					}
					const d = h(n);
				...
				addImageWithDataHero(e, t) {
					if (e.tagName === "amp-img" && s(e, "data-hero")) {
						...
						t.push({ ampImg: e, src: r, media: i, srcset: n });
				...
				isCandidateImageForPreloading(e) {
					...
					return { ampImg: e, src: t, srcset: n, media: a };
				}
				isTinyNode(e, t, r) {
				...
				generateImg(e) {
					...
					const l = [];
					const c = e.attribs["object-fit"];
					if (c) {
						l.push(`object-fit:${c}`);
					}
					const u = e.attribs["object-position"];
					if (u) {
						l.push(`object-position:${u}`);
					}
					if (l.length > 0) {
						t.attribs.style = l.join(";");
					}
					i(e, t);
				}
				getNoscriptFallbackImage(e) {
					const t = c(e, "noscript");
					if (!t) {
						return null;
					}
					return c(t, "img");
		...
		714: (e, t, r) => {
			"use strict";
			const { hasAttribute: i, nextNode: n, firstChildByTag: s } = r(2547);
			const { skipNodeAndChildren: a } = r(7041);
			const { isValidImageSrcURL: o } = r(3741);
			const { isTemplate: l } = r(8846);
			const c = 100;
			const u = [
				39, 47, 56, 68, 82, 100, 120, 150, 180, 220, 270, 330, 390, 470, 560,
				680, 820, 1e3, 1200, 1440, 1750, 2e3, 2500,
			];
			const d = u[u - 1];
			const f = 3;
			class SrcsetWidth {
				constructor(e, t = -1, r = f) {
					this.widthList_ = [];
					this.setBaseWidth(e, t, r);
				}
				setBaseWidth(e, t = -1, r = f) {
			...
			class OptimizeImages {
				constructor(e) {
					...
					this.maxImageWidth = d;
					this.maxSrcsetValues = f;
				}
				async transform(e) {
				...
				async optimizeImage(e) {
					...
					const l = n === "responsive" || (!n && s && a);
					if (l && r < c) {
						return;
					}
					const u = new SrcsetWidth(
						r,
						this.maxImageWidth,
						this.maxSrcsetValues,
					);
					if (!u.isValid()) {
						return;
					}
		...
		3842: (e, t, r) => {
			...
			const { findMetaViewport: o, skipNodeAndChildren: l } = r(7041);
			const { isTemplate: c } = r(8846);
			const u = 5;
			class PreloadImages {
				transform(e, t) {
				...
				createPreload(e, t) {
					const r = i("link", { rel: "preload", href: e, as: "image" });
					if (t) {
						r.attribs.media = t;
					}
					return r;
		...
		9401: (e, t, r) => {
			"use strict";
			const { hasAttribute: i, firstChildByTag: n, nextNode: s } = r(2547);
		...
		707: (e, t, r) => {
			...
			const { isRenderDelayingExtension: o } = r(9170);
			class HeadNodes {
				constructor() {
				...
				_sortExtensions(e) {
					const t = new Map([...e].sort((e, t) => e[0].localeCompare(t[0])));
		...
		7185: (e, t, r) => {
			...
			const { AMP_CACHE_HOST: c } = r(8846);
			const { findMetaViewport: u } = r(7041);
			const { calculateHost: d } = r(859);
			class RewriteAmpUrls {
				...
				transform(e, t) {
					...
					while (c) {
						if (
							c.tagName === "script" &&
							this._usesAmpCacheUrl(c.attribs.src)
						) {
							c.attribs.src = this._replaceUrl(c.attribs.src, o);
							if (p) {
								const e = this._addEsm(c, h);
								if (h && e) {
									m.push(e);
								}
							} else if (h) {
								m.push(this._createPreload(c.attribs.src, "script"));
							}
						} else if (
							c.tagName === "link" &&
							c.attribs.rel === "stylesheet" &&
							this._usesAmpCacheUrl(c.attribs.href)
						) {
							c.attribs.href = this._replaceUrl(c.attribs.href, o);
							if (h) {
								m.push(this._createPreload(c.attribs.href, "style"));
							}
						} else if (
							c.tagName === "link" &&
							c.attribs.rel === "preload" &&
							this._usesAmpCacheUrl(c.attribs.href)
						) {
				...
				_addEsm(e, t) {
					...
					const l = e.attribs["custom-template"];
					if (l) {
						s.attribs["custom-template"] = l;
					}
					o(e.parent, s, e);
				...
				_createPreload(e, t) {
					...
					return i("link", { rel: "preload", href: e, as: t });
				}
				_shouldPreload(e) {
					return e.endsWith("v0.js") || e.endsWith("v0.css");
				}
				_addMeta(e, t, r) {
					const n = i("meta", { name: t, content: r });
					o(e, n, s(e, "script"));
				}
				isAbsoluteUrl_(e) {
					try {
		...
		2079: (e, t, r) => {
			...
			class SeparateKeyframes {
				...
				async transform(e) {
					...
					const { css: b } = await l([...h, keyframesPlugin])
						.process(m, { from: undefined, parser: o })
						.catch((e) => {
					...
					if (!p) {
						...
						if (!p) {
							p = n("style", { "amp-keyframes": "" });
						}
					}
					const v = p.children[0];
					const y = l.parse((v && v.data) || "");
					y.nodes = g.nodes.concat(y.nodes);
					let x = "";
					l.stringify(y, (e) => {
						x += e;
					});
					if (h.length > 0) {
						const e = await l(h).process(x, { from: undefined, parser: o });
						x = e.css;
					}
					if (!v) {
						i(p, x);
				...
				logInvalid(e, t) {
					this.log_.warn(
						`Found invalid keyframe property '${t}' in '${e}' not moving to style[amp-keyframes]`,
					);
				}
				isAmpStory(e) {
		...
		4626: (e, t, r) => {
			...
			const { skipNodeAndChildren: c } = r(7041);
			const { isRenderDelayingExtension: u, isCustomElement: d } = r(9170);
			const { applyLayout: f } = r(9464);
			const { isTemplate: p } = r(8846);
			const h = r(6070);
			class ServerSideRendering {
				...
				transform(e) {
					...
					const c = l(r, "head");
					if (
						typeof r.attribs["i-amphtml-layout"] !== "undefined" &&
						r.attribs["i-amphtml-layout"] !== null
					) {
						return;
					}
					...
					t.apply();
					const m = s("style", { "amp-runtime": "" });
					const g = c.children && c.children.length ? c.children[0] : null;
					a(c, m, g);
					let b;
					for (let e = c.firstChild; e; e = e.nextSibling) {
						if (
							e.tagName === "script" &&
							i(e, "custom-element") &&
							e.attribs["custom-element"] === "amp-experiment"
						) {
							continue;
						}
						if (u(e)) {
					...
					for (let e = c.firstChild; e; e = e.nextSibling) {
						if (
							e.tagName === "noscript" ||
							(e.tagName === "style" && i(e, "amp-boilerplate"))
						) {
							v.push(e);
						}
					}
				...
				isAmpExperimentUsed(e) {
					...
					for (const r of e.children || []) {
						if (
							r.tagName === "script" &&
							r.attribs &&
							r.attribs["type"] === "application/json"
						) {
							t = r;
							break;
						}
		...
		4178: (e, t, r) => {
			...
			const a = "/version.txt";
			const o = { canary: 0, prod: 1, lts: 2 };
			class RuntimeVersion {
				constructor(e) {
					this.fetch_ = e;
				}
				async currentVersion(e = {}) {
				...
				async getVersionFromRuntimeMetadata_(e, t) {
					...
					if (!n || !n.ok) {
						i.debug(
							"RTV metadata endpoint did not respond with a successful status code",
						);
						return;
					}
					let a;
					...
					if (t === o.canary) {
						if (
							Array.isArray(a.diversions) &&
							a.diversions[0] &&
							a.diversions[0].startsWith(this.getRtvConfigCode_(t))
						) {
							l = a.diversions[0];
						}
						if (!l) {
							i.debug(
								"RTV metadata JSON malformed, canary version not in diversions array",
							);
						}
					} else if (t === o.lts) {
						...
						if (!l) {
							i.debug(
								"RTV metadata JSON malformed, lts version not in ltsRuntimeVersion",
							);
						}
					} else if (t === o.prod) {
						...
						if (!l) {
							i.debug(
								"RTV metadata JSON malformed, production version not in ampRuntimeVersion",
							);
						}
					}
					return l;
				...
				async getVersionFromVersionTxt_(e, t) {
					...
					if (!n || !n.ok) {
						i.debug(
							"version.txt endpoint did not respond with a successful status code",
						);
						return;
					}
					let s;
		...
		9874: (e, t, r) => {
			...
			e.exports = { calculateHash: i };
		},
		649: (e, t, r) => {
			const i = r(6113);
			const n = new Set(["sha384"]);
			const s = "sha384";
			function calculateHash(e, { algorithm: t = s } = {}) {
			...
			e.exports = { calculateHash: calculateHash };
		},
		4934: (e, t, r) => {
			"use strict";
			const i = r(1379);
		...
		1822: (e) => {
			class AmpValidatorRules {
				...
				getTagsForFormat(e, t = false) {
					e = e.toLowerCase();
					return this.tags
						.filter(
							(r) =>
								r.htmlFormat.includes(e.toUpperCase()) &&
								this.checkEntityFormat_(r, e) &&
								this.checkEntityTransformed_(r, t),
						)
						.map((r) => {
							r = Object.assign({}, r);
							r.attrs = r.attrs.filter(
								(r) =>
									this.checkEntityFormat_(r, e) &&
									this.checkEntityTransformed_(r, t),
							);
				...
				initAttrLists_(e) {
					...
					this.specialAttrLists_.$GLOBAL_ATTRS.forEach(
						(e) => (e.global = true),
					);
				}
				initTags_(e) {
					this.tags = e.tags
						.filter((e) => !e.extensionSpec)
						.map((e) => {
							e.attrs = e.attrs || [];
							if (e.attrLists) {
				...
				initExtensions_(e) {
					this.extensions = e.tags
						.filter((e) => e.extensionSpec)
						.map((e) =>
							Object.assign({}, e.extensionSpec, { htmlFormat: e.htmlFormat }),
						);
		...
		1379: (e, t, r) => {
			...
			async function loadRules({ url: e }) {
				e = e || n;
				return loadRemote(e);
			}
			e.exports = loadRules;
				...
				return Object.keys(e)
					.map(function (r) {
						...
						if (t.xmlMode === "foreign") {
							r =
								(n = c.attributeNames.get(r)) !== null && n !== void 0 ? n : r;
						}
						...
						return (
							r +
							'="' +
							(t.decodeEntities ? l.encodeXML(s) : s.replace(/"/g, "&quot;")) +
							'"'
						);
					})
					.join(" ");
				...
				if (t.xmlMode === "foreign") {
					e.name =
						(r = c.elementNames.get(e.name)) !== null && r !== void 0
							? r
							: e.name;
					if (e.parent && f.has(e.parent.name)) {
		...
		945: function (e, t, r) {
			...
			var l = (function () {
				...
				DomHandler.prototype.oncdatastart = function () {
					var e = new s.Text("");
					var t = new s.NodeWithChildren("cdata", [e]);
					this.addNode(t);
					e.parent = t;
					this.lastNode = e;
				};
			...
			function cloneNode(e, t) {
				...
				switch (e.type) {
					...
					case "style": {
						...
						var p = new f(s.name, i({}, s.attribs), a);
		...
		3527: function (e, t, r) {
			...
			function cloneNode(e, t) {
				...
				if (isText(e)) {
					...
					var i = t ? cloneChildren(e.children) : [];
					var o = new f(s.ElementType.CDATA, i);
					i.forEach(function (e) {
						return (e.parent = o);
					});
					r = o;
		...
		4236: (e, t, r) => {
			...
			function existsOne(e, t) {
				return t.some(function (t) {
					return (
						i.isTag(t) &&
						(e(t) || (t.children.length > 0 && existsOne(e, t.children)))
					);
				});
			}
			...
			function getInverse(e, t) {
				return function (r) {
					return r
						...
						.replace(d, astralReplacer)
						.replace(u, singleCharReplacer);
				};
			}
			var f = getInverseReplacer(s);
			function escape(e) {
				return e
					.replace(f, singleCharReplacer)
					.replace(d, astralReplacer)
					.replace(u, singleCharReplacer);
			}
			t.escape = escape;
			...
			var p = (function (e) {
				...
				FeedHandler.prototype.onend = function () {
					...
					if (r.name === "feed") {
						...
						var n =
							(t =
								(e = getOneElement("channel", r.children)) === null ||
								e === void 0
									? void 0
		...
		9825: function (e, t, r) {
			...
			var f = (function () {
				function Parser(e, t) {
					...
					(o = (a = this.cbs).onparserinit) === null || o === void 0
						? void 0
						: o.call(a, this);
				}
				...
				Parser.prototype.onopentagname = function (e) {
					...
					if (
						...
						while (
							this.stack.length > 0 &&
							o[e].has((i = this.stack[this.stack.length - 1]))
						) {
							this.onclosetag(i);
						}
					}
				...
				Parser.prototype.oncdata = function (e) {
					...
					if (this.options.xmlMode || this.options.recognizeCDATA) {
						...
						(n = (i = this.cbs).ontext) === null || n === void 0
							? void 0
							: n.call(i, e);
						(a = (s = this.cbs).oncdataend) === null || a === void 0
							? void 0
							: a.call(s);
					} else {
		...
		3562: function (e, t, r) {
			...
			var x = ifElseState("T", 43, 1);
			var _ = consumeSpecialNameChar("Y", 45);
			var w = consumeSpecialNameChar("L", 46);
			var C = consumeSpecialNameChar("E", 47);
			var T = ifElseState("Y", 49, 1);
			var S = ifElseState("L", 50, 1);
			...
			var O = ifElseState("I", 58, 1);
			var P = ifElseState("T", 59, 1);
			var I = ifElseState("L", 60, 1);
			var V = ifElseState("E", 61, 1);
			var M = ifElseState("#", 63, 64);
			var L = ifElseState("X", 66, 65);
			var R = (function () {
				function Tokenizer(e, t) {
					...
					this.decodeEntities =
						(r = e === null || e === void 0 ? void 0 : e.decodeEntities) !==
							null && r !== void 0
							? r
							: true;
				}
		...
		8937: (e) => {
			"use strict";
			e.exports = require("next/dist/compiled/cssnano-simple");
		},
		7330: (e) => {
			"use strict";
			e.exports = require("next/dist/compiled/lru-cache");
		},
		4429: (e) => {
			"use strict";
			e.exports = require("next/dist/compiled/node-fetch");
		},
		7595: (e) => {
			"use strict";
			e.exports = require("next/dist/compiled/postcss-safe-parser");
		},
		6794: (e) => {
			"use strict";
			e.exports = require("next/dist/compiled/terser");
		},
		2037: (e) => {
			"use strict";
	...
	var __webpack_exports__ = __nccwpck_require__(8483);
