...
async function webpackBuildWithWorker(compilerNamesArg) {
	...
	const { nextBuildSpan, ...prunedBuildContext } =
	...
	for (const compilerName of compilerNames) {
		...
		const worker = new _worker.Worker(
			_path.default.join(__dirname, "impl.js"),
			{
		...
		const curResult = await worker.workerMain({
			...
			traceState: {
				...
				defaultParentSpanId:
					nextBuildSpan == null ? void 0 : nextBuildSpan.getId(),
		...
		if (
			(_curResult_buildTraceContext = curResult.buildTraceContext) == null
				? void 0
				: _curResult_buildTraceContext.entriesTrace
		) {
			...
			if (
				(_curResult_buildTraceContext1 = curResult.buildTraceContext) == null
					? void 0
					: _curResult_buildTraceContext1.chunksTrace
			) {
