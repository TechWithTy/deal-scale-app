...
export declare function computeFromManifest(
	manifests: {
		build: BuildManifest;
...
export declare function serializePageInfos(
	input: PageInfos,
): SerializedPageInfos;
export declare function deserializePageInfos(
	input: SerializedPageInfos,
): PageInfos;
...
export declare function getJsPageSizeInKb(
 ...
 */
export declare function collectGenerateParams(
	tree: LoaderTree,
): Promise<GenerateParamsResults>;
export declare function buildAppStaticPaths({
	dir,
	page,
	distDir,
	configFileName,
...
export declare function isWebpackServerOnlyLayer(
...
export declare function isWebpackAppLayer(
	layer: WebpackLayerName | null | undefined,
): boolean;
export {};
