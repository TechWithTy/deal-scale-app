...
const _VAR_MODULE_DOCUMENT = /*#__PURE__*/ _interop_require_default(
	require("VAR_MODULE_DOCUMENT"),
);
const _VAR_MODULE_APP = /*#__PURE__*/ _interop_require_default(
	require("VAR_MODULE_APP"),
);
const _VAR_USERLAND = /*#__PURE__*/ _interop_require_wildcard(
	require("VAR_USERLAND"),
);
...
const getServerSideProps = (0, _helpers.hoist)(
	_VAR_USERLAND,
	"getServerSideProps",
);
const config = (0, _helpers.hoist)(_VAR_USERLAND, "config");
const reportWebVitals = (0, _helpers.hoist)(_VAR_USERLAND, "reportWebVitals");
const unstable_getStaticProps = (0, _helpers.hoist)(
	_VAR_USERLAND,
	"unstable_getStaticProps",
);
const unstable_getStaticPaths = (0, _helpers.hoist)(
	_VAR_USERLAND,
	"unstable_getStaticPaths",
);
const unstable_getStaticParams = (0, _helpers.hoist)(
	_VAR_USERLAND,
	"unstable_getStaticParams",
);
const unstable_getServerProps = (0, _helpers.hoist)(
	_VAR_USERLAND,
	"unstable_getServerProps",
);
const unstable_getServerSideProps = (0, _helpers.hoist)(
	_VAR_USERLAND,
