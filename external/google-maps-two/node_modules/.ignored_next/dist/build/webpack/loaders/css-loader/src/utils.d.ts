...
declare function getModulesPlugins(
	options: any,
	loaderContext: any,
	meta: any,
): any[];
declare function normalizeSourceMap(map: any, resourcePath: string): any;
declare function getPreRequester({
	loaders,
	loaderIndex,
}: any): (number: any) => any;
declare function getImportCode(imports: any, options: any): string;
declare function normalizeSourceMapForRuntime(
	map: any,
	loaderContext: any,
): string;
declare function getModuleCode(
	result: {
		map: any;
		css: any;
	},
...
declare function getExportCode(
	exports: any,
	replacements: any,
	options: {
		modules: {
...
declare function resolveRequests(
