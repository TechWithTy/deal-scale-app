		...
		compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation) => {
			...
			compilation.hooks.statsPrinter.tap(PLUGIN_NAME, (statsPrinter) => {
				statsPrinter.hooks.print
					.for("asset.info.minimized") // @ts-ignore
	...
	async transformAssets(compilation) {
		...
		await Promise.all(
			assets.map(async (asset) => {
				...
				const code =
					typeof source === "string" ? _buffer.Buffer.from(source) : source;
				...
				compilation.updateAsset(
					asset.name, // @ts-ignore
					sourcemap
						? new _webpacksources3.SourceMapSource(
								codeString,
								asset.name,
						...
						: new _webpacksources3.RawSource(codeString),
					{
						...asset.info,
						minimized: true,
					},
