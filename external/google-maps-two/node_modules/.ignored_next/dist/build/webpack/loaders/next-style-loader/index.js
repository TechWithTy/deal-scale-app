...
if (module.hot) {
  ...
  module.hot.dispose(function() {
    update();
				...
				return `${
					esModule
						? `import api from ${(0, _stringifyrequest.stringifyRequest)(this, `!${_path.default.join(__dirname, "runtime/injectStylesIntoLinkTag.js")}`)};
            import content from ${(0, _stringifyrequest.stringifyRequest)(this, `!!${request}`)};`
						: `var api = require(${(0, _stringifyrequest.stringifyRequest)(this, `!${_path.default.join(__dirname, "runtime/injectStylesIntoLinkTag.js")}`)});
  ...
  module.hot.dispose(function() {
    if (update) {
      update();
				...
				return `${
					esModule
						? `import api from ${(0, _stringifyrequest.stringifyRequest)(this, `!${_path.default.join(__dirname, "runtime/injectStylesIntoStyleTag.js")}`)};
            import content from ${(0, _stringifyrequest.stringifyRequest)(this, `!!${request}`)};`
						: `var api = require(${(0, _stringifyrequest.stringifyRequest)(this, `!${_path.default.join(__dirname, "runtime/injectStylesIntoStyleTag.js")}`)});
            var content = require(${(0, _stringifyrequest.stringifyRequest)(this, `!!${request}`)});
