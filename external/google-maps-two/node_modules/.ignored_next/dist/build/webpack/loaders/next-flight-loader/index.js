...
function getAssumedSourceType(mod, sourceType) {
	...
	const detectedClientEntryType =
		buildInfo == null
			? void 0
			: (_buildInfo_rsc = buildInfo.rsc) == null
				? void 0
				: _buildInfo_rsc.clientEntryType;
	const clientRefs =
		(buildInfo == null
			? void 0
			: (_buildInfo_rsc1 = buildInfo.rsc) == null
				? void 0
				: _buildInfo_rsc1.clientRefs) || [];
...
function transformSource(source, sourceMap) {
	var _this__module_matchResource,
		_this__module,
		_buildInfo_rsc,
		_buildInfo_rsc1;
	...
	if (
		(_this__module = this._module) == null
			? void 0
			: (_this__module_matchResource = _this__module.matchResource) == null
				? void 0
				: _this__module_matchResource.startsWith(
						_constants1.BARREL_OPTIMIZATION_PREFIX,
					)
	) {
		resourceKey = (0, _utils.formatBarrelOptimizedResource)(
			resourceKey,
	...
	if (
		((_buildInfo_rsc = buildInfo.rsc) == null
			? void 0
			: _buildInfo_rsc.type) === _constants1.RSC_MODULE_TYPES.client
	) {
		var _this__module_parser, _this__module1;
		const assumedSourceType = getAssumedSourceType(
			this._module,
			(_this__module1 = this._module) == null
				? void 0
				: (_this__module_parser = _this__module1.parser) == null
					? void 0
					: _this__module_parser.sourceType,
		);
...
export { e${cnt++} as ${ref} };`;
	...
	if (
		((_buildInfo_rsc1 = buildInfo.rsc) == null
			? void 0
			: _buildInfo_rsc1.type) !== _constants1.RSC_MODULE_TYPES.client
	) {
	...
	const replacedSource = source.replace(
		_constants.RSC_MOD_REF_PROXY_ALIAS,
		MODULE_PROXY_PATH,
	);
