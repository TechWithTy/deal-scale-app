...
export declare function findBestPatternMatch<T>(
	values: readonly T[],
 ...
 */
export declare function matchPatternOrExact(
 ...
 */
export declare function matchedText(
	pattern: Pattern,
	candidate: string,
): string;
 ...
 */
export declare class JsConfigPathsPlugin
	implements webpack.ResolvePluginInstance
{
	paths: Paths;
