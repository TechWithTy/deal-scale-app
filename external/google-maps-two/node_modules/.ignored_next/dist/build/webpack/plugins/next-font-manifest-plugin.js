		...
		compiler.hooks.make.tap(PLUGIN_NAME, (compilation) => {
			...
			compilation.hooks.processAssets.tap(
				...
				(assets) => {
						...
						(0, _utils.traverseModules)(
							...
							(mod, _chunk, chunkGroup) => {
								...
								if (
									mod == null
										? void 0
										: (_mod_request = mod.request) == null
											? void 0
											: _mod_request.includes("/next-font-loader/index.js?")
								) {
									var _mod_buildInfo;
									if (
										!((_mod_buildInfo = mod.buildInfo) == null
											? void 0
											: _mod_buildInfo.assets)
									)
										return;
									...
									const fontFiles = modAssets.filter((file) =>
							...
							(chunkGroup) => {
								...
								return !!((_chunkGroup_name = chunkGroup.name) == null
									? void 0
									: _chunkGroup_name.startsWith("app/"));
							},
						);
					}
					...
					assets[`server/${_constants.NEXT_FONT_MANIFEST}.js`] =
						new _webpack.sources.RawSource(
							`self.__NEXT_FONT_MANIFEST=${JSON.stringify(manifest)}`,
						);
					// Create manifest for server
					assets[`server/${_constants.NEXT_FONT_MANIFEST}.json`] =
						new _webpack.sources.RawSource(manifest);
				},
			);
		});
		return;
