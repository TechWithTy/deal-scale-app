...
const _plimit = /*#__PURE__*/ _interop_require_default(
	require("next/dist/compiled/p-limit"),
);
...
class TerserPlugin {
		...
		return terserSpan.traceAsyncFn(async () => {
			...
			const getWorker = () => {
				...
				initializedWorker = new _jestworker.Worker(
					_path.join(__dirname, "./minify.js"),
					{
	...
	apply(compiler) {
		...
		const { SourceMapSource, RawSource } =
			(compiler == null
				? void 0
				: (_compiler_webpack = compiler.webpack) == null
					? void 0
					: _compiler_webpack.sources) || _webpack.sources;
