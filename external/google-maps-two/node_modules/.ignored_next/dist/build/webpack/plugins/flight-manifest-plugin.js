...
function getAppPathRequiredChunks(chunkGroup, excludedFiles) {
	const deploymentIdChunkQuery = (0,
	_deploymentid.getDeploymentIdQueryOrEmptyString)();
	const chunks = [];
			...
			const recordModule = (modId, mod) => {
				...
				if (
					(_mod_matchResource = mod.matchResource) == null
						? void 0
						: _mod_matchResource.startsWith(
								_constants.BARREL_OPTIMIZATION_PREFIX,
							)
				) {
					...
					resource = (0, _utils.formatBarrelOptimizedResource)(
						resource,
						mod.matchResource,
					);
				}
							...
							if (modId !== null) {
								...
								if (
									((_connection_module = connection.module) == null
										? void 0
										: _connection_module.constructor.name) ===
									"ConcatenatedModule"
								) {
