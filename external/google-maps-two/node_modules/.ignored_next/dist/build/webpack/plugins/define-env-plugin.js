				...
				? {
						...
						remotePatterns:
							(_config_images1 = config.images) == null
								? void 0
								: _config_images1.remotePatterns,
						localPatterns:
							(_config_images2 = config.images) == null
								? void 0
								: _config_images2.localPatterns,
...
function getDefineEnv({
	...
	var _config_experimental_staleTimes,
		_config_experimental_staleTimes1,
		_config_experimental_staleTimes2,
		_config_experimental_staleTimes3,
		_config_i18n;
	const defineEnv = {
		...
		"process.env.__NEXT_CLIENT_ROUTER_DYNAMIC_STALETIME": JSON.stringify(
			isNaN(
				Number(
					(_config_experimental_staleTimes = config.experimental.staleTimes) ==
						null
						? void 0
						: _config_experimental_staleTimes.dynamic,
				),
			)
				? 30 // 30 seconds
				: (_config_experimental_staleTimes1 = config.experimental.staleTimes) ==
						null
					? void 0
					: _config_experimental_staleTimes1.dynamic,
		),
		"process.env.__NEXT_CLIENT_ROUTER_STATIC_STALETIME": JSON.stringify(
			isNaN(
				Number(
					(_config_experimental_staleTimes2 = config.experimental.staleTimes) ==
						null
						? void 0
						: _config_experimental_staleTimes2.static,
				),
			)
				? 5 * 60 // 5 minutes
				: (_config_experimental_staleTimes3 = config.experimental.staleTimes) ==
						null
					? void 0
					: _config_experimental_staleTimes3.static,
		),
		"process.env.__NEXT_CLIENT_ROUTER_FILTER_ENABLED":
			config.experimental.clientRouterFilter ?? true,
		"process.env.__NEXT_CLIENT_ROUTER_S_FILTER":
			(clientRouterFilters == null
				? void 0
		...
		"process.env.__NEXT_I18N_DOMAINS":
			((_config_i18n = config.i18n) == null ? void 0 : _config_i18n.domains) ??
			false,
		...
		...(isNodeOrEdgeCompilation
			? {
					"process.env.__NEXT_EXPERIMENTAL_REACT": (0,
