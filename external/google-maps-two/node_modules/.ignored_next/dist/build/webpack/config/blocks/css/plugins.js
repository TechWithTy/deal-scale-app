...
function isIgnoredPlugin(pluginPath) {
	...
	console.warn(
		`${(0, _picocolors.yellow)((0, _picocolors.bold)("Warning"))}: Please remove the ${(0, _picocolors.underline)(plugin)} plugin from your PostCSS configuration. ` +
...
async function getPostCssPlugins(
	...
	if (invalidKey) {
		console.warn(
			`${(0, _picocolors.yellow)((0, _picocolors.bold)("Warning"))}: Your PostCSS configuration defines a field which is not supported (\`${invalidKey}\`). ` +
	...
	plugins.forEach((plugin) => {
		if (plugin == null) {
			console.warn(
				`${(0, _picocolors.yellow)((0, _picocolors.bold)("Warning"))}: A ${(0, _picocolors.bold)("null")} PostCSS plugin was provided. This entry will be ignored.`,
			);
			...
			if (
				...
				if (typeof pluginName !== "string") {
					console.error(
						`${(0, _picocolors.red)((0, _picocolors.bold)("Error"))}: A PostCSS Plugin must be provided as a ${(0, _picocolors.bold)("string")}. Instead, we got: '${pluginName}'.\n` +
							"Read more: https://nextjs.org/docs/messages/postcss-shape",
					);
				} else {
					console.error(
						`${(0, _picocolors.red)((0, _picocolors.bold)("Error"))}: A PostCSS Plugin was passed as an array but did not provide its configuration ('${pluginName}').\n` +
							"Read more: https://nextjs.org/docs/messages/postcss-shape",
					);
				}
				throw new Error(genericErrorText);
			...
			console.error(
				`${(0, _picocolors.red)((0, _picocolors.bold)("Error"))}: A PostCSS Plugin was passed as a function using require(), but it must be provided as a ${(0, _picocolors.bold)("string")}.\nRead more: https://nextjs.org/docs/messages/postcss-shape`,
			);
			throw new Error(genericErrorText);
		} else {
			console.error(
				`${(0, _picocolors.red)((0, _picocolors.bold)("Error"))}: An unknown PostCSS plugin was provided (${plugin}).\n` +
					"Read more: https://nextjs.org/docs/messages/postcss-shape",
			);
			throw new Error(genericErrorText);
		}
