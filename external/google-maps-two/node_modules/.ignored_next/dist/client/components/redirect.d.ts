 ...
 */
export declare function isRedirectError<U extends string>(
	error: unknown,
 ...
 */
export declare function getURLFromRedirectError<U extends string>(
	error: RedirectError<U>,
): U;
export declare function getRedirectTypeFromError<U extends string>(
	error: RedirectError<U>,
): RedirectType;
export declare function getRedirectStatusCodeFromError<U extends string>(
	error: RedirectError<U>,
): number;
export {};
