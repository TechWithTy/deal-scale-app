...
export declare function updateCacheNodeOnNavigation(
...
export declare function listenForDynamicRequest(
	task: Task,
	responsePromise: Promise<FetchServerResponseResult>,
): void;
export declare function abortTask(task: Task, error: any): void;
export declare function updateCacheNodeOnPopstateRestoration(
	oldCacheNode: CacheNode,
