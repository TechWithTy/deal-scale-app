 ...
 */
export declare function getOrCreatePrefetchCacheEntry({
	url,
	nextUrl,
	tree,
	buildId,
 ...
 */
export declare function createPrefetchCacheEntryForInitialLoad({
	nextUrl,
	tree,
	prefetchCache,
	url,
	...
	treeAtTimeOfPrefetch: import(
		"../../../server/app-render/types",
	).FlightRouterState;
...
export declare function prunePrefetchCache(
