		...
		_react.useMemo(() => {
			const filteredFrames = error.frames.filter((f) => {
				...
				return (
					...
					!((_f_sourceStackFrame_file = f.sourceStackFrame.file) == null
						? void 0
						: _f_sourceStackFrame_file.startsWith("node:internal"))
				);
			});
			...
			return {
				firstFrame:
					(_filteredFrames_firstFirstPartyFrameIndex =
						filteredFrames[firstFirstPartyFrameIndex]) != null
						? _filteredFrames_firstFirstPartyFrameIndex
						: null,
				allLeadingFrames:
	...
	const {
		...
		return {
			canShowMore:
				...
				(all && firstFrame != null),
			stackFramesGroupedByFramework: (0,
			_groupstackframesbyframework.groupStackFramesByFramework)(
				allCallStackFrames,
			),
			leadingFramesGroupedByFramework: (0,
			_groupstackframesbyframework.groupStackFramesByFramework)(leadingFrames),
		};
				...
				? /*#__PURE__*/ (0, _jsxruntime.jsxs)(_react.Fragment, {
						children: [
							...
							/*#__PURE__*/ (0, _jsxruntime.jsx)(
								_GroupedStackFrames.GroupedStackFrames,
								{
