...
class ReactDevOverlay extends _react.PureComponent {
	...
	render() {
		...
		const hasMissingTags = Boolean(
			(_state_rootLayoutMissingTags = state.rootLayoutMissingTags) == null
				? void 0
				: _state_rootLayoutMissingTags.length,
		);
		const isMounted =
				...
				isMounted
					? /*#__PURE__*/ (0, _jsxruntime.jsxs)(_ShadowPortal.ShadowPortal, {
							children: [
								...
								(
									(_state_rootLayoutMissingTags1 =
										state.rootLayoutMissingTags) == null
										? void 0
										: _state_rootLayoutMissingTags1.length
								)
									? /*#__PURE__*/ (0, _jsxruntime.jsx)(
											_rootlayoutmissingtagserror.RootLayoutMissingTagsError,
											{
									...
									: hasBuildError
										...
										: reactError
											? /*#__PURE__*/ (0, _jsxruntime.jsx)(_Errors.Errors, {
													isAppDir: true,
													versionInfo: state.versionInfo,
