...
const _formatwebpackmessages = /*#__PURE__*/ _interop_require_default._(
	require("../internal/helpers/format-webpack-messages"),
);
...
/** Handles messages from the sevrer for the App Router. */ function processMessage(
	obj,
	sendMessage,
	...
	function handleHotUpdate() {
		if (process.env.TURBOPACK) {
			...
			tryApplyUpdates(
				function onBeforeHotUpdate(hasUpdates) {
	...
	switch (obj.action) {
		...
		case _hotreloadertypes.HMR_ACTIONS_SENT_TO_BROWSER.TURBOPACK_MESSAGE: {
			...
			_extractmodulesfromturbopackmessage.extractModulesFromTurbopackMessage)(
				obj.data,
			);
			dispatcher.onBeforeRefresh();
			processTurbopackMessage({
	...
	const handleOnUnhandledError = (0, _react.useCallback)(
		(error) => {
			...
			const componentStack =
				errorDetails == null ? void 0 : errorDetails.componentStack;
			...
			dispatch({
				...
				componentStackFrames: componentStack
					? (0, _parsecomponentstack.parseComponentStack)(componentStack)
					: undefined,
				warning,
			});
		},
			...
			try {
				...
				console.warn(
					"[HMR] Invalid message: " +
						event.data +
						"\n" +
						((_err_stack = err == null ? void 0 : err.stack) != null
							? _err_stack
							: ""),
				);
			}
