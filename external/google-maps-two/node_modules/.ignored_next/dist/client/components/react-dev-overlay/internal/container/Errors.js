...
function Errors(param) {
	...
	const activeError = (0, _react.useMemo)(() => {
		...
		return (_readyErrors_activeIdx = readyErrors[activeIdx]) != null
			? _readyErrors_activeIdx
			: null;
	...
	const minimize = (0, _react.useCallback)(
		() => setDisplayState("minimized"),
		[],
	);
	const hide = (0, _react.useCallback)(() => setDisplayState("hidden"), []);
	const fullscreen = (0, _react.useCallback)(
					...
					/*#__PURE__*/ (0, _jsxruntime.jsxs)(_Dialog.DialogHeader, {
						...
						children: [
							/*#__PURE__*/ (0, _jsxruntime.jsxs)(
								_LeftRightDialogHeader.LeftRightDialogHeader,
								{
											...
											? /*#__PURE__*/ (0, _jsxruntime.jsx)(
													_componentstackpseudohtml.PseudoHtmlDiff,
													{
														...
														componentStackFrames:
															activeError.componentStackFrames,
