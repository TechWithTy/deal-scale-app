...
const _platform = /*#__PURE__*/ _interop_require_default._(
	require("next/dist/compiled/platform"),
);
const _cssescape = /*#__PURE__*/ _interop_require_default._(
	require("next/dist/compiled/css.escape"),
);
...
var focusLabelTabindex = {
	...
	validate: function validate(element, focusTarget, _document) {
		...
		/* eslint-disable no-unused-vars */ var variableToPreventDeadCodeElimination =
...
function getMapByName(name, _document) {
	...
	var map = _document.querySelector(
		'map[name="' + (0, _cssescape.default)(name) + '"]',
	);
	return map || null;
}
function getImageOfArea(element) {
	...
	return (
		_document.querySelector(
			'img[usemap="#' + (0, _cssescape.default)(map.name) + '"]',
		) || null
	);
}
