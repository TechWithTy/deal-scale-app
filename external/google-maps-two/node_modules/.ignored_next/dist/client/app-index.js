...
const _onrecoverableerror = /*#__PURE__*/ _interop_require_default._(
	require("./on-recoverable-error"),
);
...
function Root(param) {
	...
	if (process.env.__NEXT_TEST_MODE) {
		...
		_react.default.useEffect(() => {
			...
			window.__NEXT_HYDRATED_CB == null
				? void 0
				: window.__NEXT_HYDRATED_CB.call(window);
		}, []);
	}
	return children;
}
function hydrate() {
	...
	const reactEl = /*#__PURE__*/ (0, _jsxruntime.jsx)(StrictModeIfEnabled, {
		children: /*#__PURE__*/ (0, _jsxruntime.jsx)(
			_headmanagercontextsharedruntime.HeadManagerContext.Provider,
			{
				...
				children: /*#__PURE__*/ (0, _jsxruntime.jsx)(
					_actionqueue.ActionQueueContext.Provider,
					{
						value: actionQueue,
	...
	const hasMissingTags = !!(rootLayoutMissingTags == null
		? void 0
	...
	if (process.env.NODE_ENV !== "production") {
		...
		const patchConsoleError =
			require("./components/react-dev-overlay/internal/helpers/hydration-error-info").patchConsoleError;
		if (!isError) {
			patchConsoleError();
		}
	}
	if (isError) {
		if (process.env.NODE_ENV !== "production") {
			...
			const ReactDevOverlay =
				require("./components/react-dev-overlay/app/ReactDevOverlay").default;
			const INITIAL_OVERLAY_STATE =
				require("./components/react-dev-overlay/shared").INITIAL_OVERLAY_STATE;
			const getSocketUrl =
				require("./components/react-dev-overlay/internal/helpers/get-socket-url").getSocketUrl;
