...
function autoImplementMethods(handlers) {
	...
	const methods = _http.HTTP_METHODS.reduce(
		(acc, method) => ({
			...acc,
			// If the userland module implements the method, then use it. Otherwise,
			// use the 405 response handler.
			[method]:
				handlers[method] ?? _responsehandlers.handleMethodNotAllowedResponse,
		}),
		{},
	);
	...
	const implemented = new Set(
		_http.HTTP_METHODS.filter((method) => handlers[method]),
	);
