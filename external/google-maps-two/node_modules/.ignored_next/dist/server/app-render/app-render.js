 ...
 */ function makeGetDynamicParamFromSegment(
	...
	return function getDynamicParamFromSegment(
		...
		if (!value) {
			...
			if (isCatchall || isOptionalCatchall) {
				const dynamicParamType =
					_getshortdynamicparamtype.dynamicParamTypes[segmentParam.type];
		...
		const type = (0, _getshortdynamicparamtype.getShortDynamicParamType)(
			segmentParam.type,
		);
		return {
			param: key,
...
async function generateFlight(ctx, options) {
	...
	if (!(options == null ? void 0 : options.skipFlight)) {
		const [MetadataTree, MetadataOutlet] = (0,
		_metadata.createMetadataComponents)({
			tree: loaderTree,
			query,
			metadataContext: (0, _metadata.createMetadataContext)(
				urlPathname,
				ctx.renderOpts,
			),
			getDynamicParamFromSegment,
		...
		flightData = (
			await (0, _walktreewithflightrouterstate.walkTreeWithFlightRouterState)({
				...
				asNotFound:
					ctx.isNotFoundPath || (options == null ? void 0 : options.asNotFound),
	...
	if (
		...
		const pendingPromise = Promise.all([
			(_ctx_staticGenerationStore_incrementalCache =
				ctx.staticGenerationStore.incrementalCache) == null
				? void 0
				: _ctx_staticGenerationStore_incrementalCache.revalidateTag(
						ctx.staticGenerationStore.revalidatedTags || [],
					),
...
function ReactServerEntrypoint({
	...
	preinitScripts();
	const response = (0, _useflightresponse.useFlightStream)(
		reactServerStream,
		clientReferenceManifest,
		nonce,
	);
...
async function renderToHTMLOrFlightImpl(
	...
	_createerrorhandler.createErrorHandler)({
	...
	const flightDataRendererErrorHandler = (0,
	_createerrorhandler.createErrorHandler)({
	...
	const isRSCRequest =
		req.headers[_approuterheaders.RSC_HEADER.toLowerCase()] !== undefined;
	const isPrefetchRSCRequest =
		isRSCRequest &&
		req.headers[_approuterheaders.NEXT_ROUTER_PREFETCH_HEADER.toLowerCase()] !==
			undefined;
	/**
	 ...
	 */ const shouldProvideFlightRouterState =
		...
		(!isPrefetchRSCRequest ||
			!renderOpts.experimental.ppr || // Interception routes currently depend on the flight router state to
			// extract dynamic params.
			(0, _interceptionroutes.isInterceptionRouteAppPath)(pagePath));
	const parsedFlightRouterState = (0,
	_parseandvalidateflightrouterstate.parseAndValidateFlightRouterState)(
		req.headers[_approuterheaders.NEXT_ROUTER_STATE_TREE.toLowerCase()],
	);
	/**
	...
	const getDynamicParamFromSegment = makeGetDynamicParamFromSegment(
		params,
		pagePath, // `FlightRouterState` is unconditionally provided here because this method uses it
	...
	_tracer.getTracer)().getRootSpanAttributes()) == null
		? void 0
		: _getTracer_getRootSpanAttributes.set("next.route", pagePath);
	const renderToStream = (0, _tracer.getTracer)().wrap(
		...
		async ({ asNotFound, tree, formState }) => {
			...
			const serverStream = ComponentMod.renderToReadableStream(
				/*#__PURE__*/ (0, _jsxruntime.jsx)(ReactServerApp, {
					tree: tree,
					ctx: ctx,
					asNotFound: asNotFound,
				}),
			...
			const children = /*#__PURE__*/ (0, _jsxruntime.jsx)(
			...
			try {
				...
				if (prerenderState) {
					...
					if ((0, _dynamicrendering.usedDynamicAPIs)(prerenderState)) {
						if (postponed != null) {
							...
							metadata.postponed = JSON.stringify(
								(0, _staticrenderer.getDynamicHTMLPostponedState)(postponed),
							);
						} else {
							// This is the Dynamic Data case
							metadata.postponed = JSON.stringify(
								(0, _staticrenderer.getDynamicDataPostponedState)(),
							);
						}
						...
						return {
							stream: await (0, _nodewebstreamshelper.continueDynamicPrerender)(
								stream,
								{
						...
						if ((0, _dynamicrendering.usedDynamicAPIs)(prerenderState)) {
							...
							return {
								stream: await (0,
								_nodewebstreamshelper.continueDynamicPrerender)(stream, {
									getServerInsertedHTML,
								}),
							};
						} else {
							...
							if (postponed != null) {
								...
								const resumeRenderer = (0,
								_staticrenderer.createStaticRenderer)({
									ppr: true,
									isStaticGeneration: false,
									postponed: (0, _staticrenderer.getDynamicHTMLPostponedState)(
										postponed,
									),
									streamOptions: {
										signal: (0, _dynamicrendering.createPostponedAbortSignal)(
								...
								const resumeChildren = /*#__PURE__*/ (0, _jsxruntime.jsx)(
									HeadManagerContext.Provider,
									{
										value: {
											appDir: true,
								...
								renderedHTMLStream = (0, _nodewebstreamshelper.chainStreams)(
									stream,
									resumeStream,
								);
							}
							return {
								...
								_nodewebstreamshelper.continueStaticPrerender)(
									...
									{
										inlinedDataStream: (0,
										_useflightresponse.createInlinedDataReadableStream)(
											dataStream,
											nonce,
											formState,
										),
					...
					if (resumed) {
						...
						return {
							stream: await (0,
							_nodewebstreamshelper.continueDynamicHTMLResume)(stream, {
								inlinedDataStream,
								getServerInsertedHTML,
							}),
						};
						...
						return {
							stream: await (0,
							_nodewebstreamshelper.continueDynamicDataResume)(stream, {
								inlinedDataStream,
							}),
						};
					}
					...
					return {
						stream: await (0, _nodewebstreamshelper.continueFizzStream)(
							stream,
							{
								inlinedDataStream: (0,
								_useflightresponse.createInlinedDataReadableStream)(
				...
				if (shouldBailoutToCSR) {
					const stack = (0, _formatservererror.getStackWithoutErrorMessage)(
						err,
					);
				...
				const errorServerStream = ComponentMod.renderToReadableStream(
					/*#__PURE__*/ (0, _jsxruntime.jsx)(ReactServerError, {
						tree: tree,
						ctx: ctx,
						errorType: errorType,
					}),
				...
				try {
					const fizzStream = await (0,
					_nodewebstreamshelper.renderToInitialFizzStream)({
					...
					if (
						process.env.NODE_ENV === "development" &&
						(0, _notfound.isNotFoundError)(finalErr)
					) {
						const bailOnNotFound =
	...
	if (
		...
		const pendingPromise = Promise.all([
			(_staticGenerationStore_incrementalCache =
				staticGenerationStore.incrementalCache) == null
				? void 0
				: _staticGenerationStore_incrementalCache.revalidateTag(
						staticGenerationStore.revalidatedTags || [],
					),
	...
	if (
		...
		(0, _dynamicrendering.usedDynamicAPIs)(
			staticGenerationStore.prerenderState,
		) &&
		((_staticGenerationStore_prerenderState =
			staticGenerationStore.prerenderState) == null
			? void 0
			: _staticGenerationStore_prerenderState.isDebugSkeleton)
	) {
...
const renderToHTMLOrFlight = (req, res, pagePath, query, renderOpts) => {
	...
	return _requestasyncstoragewrapper.RequestAsyncStorageWrapper.wrap(
		...
		(requestStore) =>
			_staticgenerationasyncstoragewrapper.StaticGenerationAsyncStorageWrapper.wrap(
