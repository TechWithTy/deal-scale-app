...
async function walkTreeWithFlightRouterState({
	...
	const currentParams = // Handle null case where dynamic param is optional
		segmentParam && segmentParam.value !== null
			...
			: parentParams;
	const actualSegment = (0,
	_createflightrouterstatefromloadertree.addSearchParamsIfPageSegment)(
	...
	if (!parentRendered && renderComponentsOnThisLevel) {
		const overriddenSegment =
			flightRouterState &&
			(0, _matchsegments.canSegmentBeOverridden)(
				actualSegment,
				flightRouterState[0],
			)
				? flightRouterState[0]
			...
			parallelRoutesKeys.map(async (parallelRouteKey) => {
				...
				return path
					.map((item) => {
						...
						if (
							item[0] === _segment.DEFAULT_SEGMENT_KEY &&
							flightRouterState &&
