...
export declare function createPrerenderState(
 ...
 */
export declare function trackDynamicDataAccessed(
	store: StaticGenerationStore,
	expression: string,
): void;
/**
...
export declare function Postpone({
	reason,
	prerenderState,
	pathname,
}: PostponeProps): never;
export declare function trackDynamicFetch(
	store: StaticGenerationStore,
	expression: string,
): void;
export declare function usedDynamicAPIs(
	prerenderState: PrerenderState,
): boolean;
