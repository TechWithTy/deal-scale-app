...
export declare function normalizeVercelUrl(
	req: BaseNextRequest,
	trustQuery: boolean,
	paramKeys?: string[],
...
export declare function interpolateDynamicPath(
	pathname: string,
	params: ParsedUrlQuery,
	defaultRouteRegex?: ReturnType<typeof getNamedRouteRegex> | undefined,
): string;
export declare function normalizeDynamicRouteParams(
	params: ParsedUrlQuery,
