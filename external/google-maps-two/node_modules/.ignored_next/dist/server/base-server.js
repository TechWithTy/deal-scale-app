...
const _escapepathdelimiters = /*#__PURE__*/ _interop_require_default(
	require("../shared/lib/router/utils/escape-path-delimiters"),
);
...
const _getroutefromassetpath = /*#__PURE__*/ _interop_require_default(
...
class Server {
	constructor(options) {
		...
		this.handleRSCRequest = (req, _res, parsedUrl) => {
			...
			if (
				(_this_normalizers_prefetchRSC = this.normalizers.prefetchRSC) == null
					? void 0
					: _this_normalizers_prefetchRSC.match(parsedUrl.pathname)
			) {
				...
				req.headers[
					_approuterheaders.NEXT_ROUTER_PREFETCH_HEADER.toLowerCase()
				] = "1";
				(0, _requestmeta.addRequestMeta)(req, "isRSCRequest", true);
				(0, _requestmeta.addRequestMeta)(req, "isPrefetchRSCRequest", true);
			} else if (
				(_this_normalizers_rsc = this.normalizers.rsc) == null
					? void 0
					: _this_normalizers_rsc.match(parsedUrl.pathname)
			) {
		...
		this.handleNextDataRequest = async (req, res, parsedUrl) => {
			...
			const params = (0, _matchnextdatapathname.matchNextDataPathname)(
				parsedUrl.pathname,
			);
			...
			if (params.path[0] !== this.buildId) {
				...
				if (
					...
					(0, _requestmeta.getRequestMeta)(req, "middlewareInvoke")
				) {
					return false;
				}
			...
			if (this.i18nProvider) {
				...
				const hostname =
					req == null
						? void 0
						: (_req_headers_host = req.headers.host) == null
							? void 0
							: _req_headers_host.split(":", 1)[0].toLowerCase();
		...
		this.i18nProvider = (
			(_this_nextConfig_i18n = this.nextConfig.i18n) == null
				? void 0
				: _this_nextConfig_i18n.locales
		)
			? new _i18nprovider.I18NProvider(this.nextConfig.i18n)
			: undefined;
		// Configure the locale normalizer, it's used for routes inside `pages/`.
		this.localeNormalizer = this.i18nProvider
			? new _localeroutenormalizer.LocaleRouteNormalizer(this.i18nProvider)
			: undefined;
		...
		this.normalizers = {
			...
			postponed:
				...
				this.minimalMode
					? new _postponed.PostponedPathnameNormalizer()
					: undefined,
			rsc:
				this.enabledDirectories.app && this.minimalMode
					? new _rsc.RSCPathnameNormalizer()
					: undefined,
			prefetchRSC:
				this.enabledDirectories.app &&
				this.nextConfig.experimental.ppr &&
				this.minimalMode
					? new _prefetchrsc.PrefetchRSCPathnameNormalizer()
					: undefined,
			data: this.enabledDirectories.pages
				? new _nextdata.NextDataPathnameNormalizer(this.buildId)
				: undefined,
			action:
				this.enabledDirectories.app && this.minimalMode
					? new _action.ActionPathnameNormalizer()
					: undefined,
		};
		...
		this.renderOpts = {
			...
			ampOptimizerConfig:
				(_this_nextConfig_experimental_amp =
					this.nextConfig.experimental.amp) == null
					? void 0
					: _this_nextConfig_experimental_amp.optimizer,
			...
			domainLocales:
				(_this_nextConfig_i18n1 = this.nextConfig.i18n) == null
					? void 0
					: _this_nextConfig_i18n1.domains,
	...
	getRouteMatchers() {
		...
		const manifestLoader = new _servermanifestloader.ServerManifestLoader(
			(name) => {
				switch (name) {
		...
		const matchers =
			new _defaultroutematchermanager.DefaultRouteMatcherManager();
		// Match pages under `pages/`.
		matchers.push(
			new _pagesroutematcherprovider.PagesRouteMatcherProvider(
				this.distDir,
				manifestLoader,
				this.i18nProvider,
			),
		...
		matchers.push(
			new _pagesapiroutematcherprovider.PagesAPIRouteMatcherProvider(
				this.distDir,
				manifestLoader,
				this.i18nProvider,
			),
		...
		if (this.enabledDirectories.app) {
			...
			matchers.push(
				new _apppageroutematcherprovider.AppPageRouteMatcherProvider(
					this.distDir,
					manifestLoader,
				),
			);
			matchers.push(
				new _approuteroutematcherprovider.AppRouteRouteMatcherProvider(
					this.distDir,
					manifestLoader,
				),
			);
	...
	async handleRequest(req, res, parsedUrl) {
		...
		return tracer.withPropagatedContext(req.headers, () => {
			return tracer.trace(
				_constants1.BaseServerSpan.handleRequest,
				{
	...
	async handleRequestImpl(req, res, parsedUrl) {
		try {
			var _originalRequest_socket,
				_originalRequest_socket1,
				_this_i18nProvider,
				_this_i18nProvider1,
			...
			const xForwardedProto =
				originalRequest == null
					? void 0
					: originalRequest.headers["x-forwarded-proto"];
			const isHttps = xForwardedProto
				? xForwardedProto === "https"
				: !!(originalRequest == null
						? void 0
						: (_originalRequest_socket = originalRequest.socket) == null
							? void 0
							: _originalRequest_socket.encrypted);
			...
			req.headers["x-forwarded-for"] ??=
				(_originalRequest_socket1 = originalRequest.socket) == null
					? void 0
					: _originalRequest_socket1.remoteAddress;
			...
			if (
				!((_this_i18nProvider = this.i18nProvider) == null
					? void 0
					: _this_i18nProvider.validateQuery(parsedUrl.query))
			) {
			...
			const domainLocale =
				(_this_i18nProvider1 = this.i18nProvider) == null
					? void 0
					: _this_i18nProvider1.detectDomainLocale(
			...
			const defaultLocale =
				...
				((_this_nextConfig_i18n = this.nextConfig.i18n) == null
					? void 0
					: _this_nextConfig_i18n.defaultLocale);
			parsedUrl.query.__nextDefaultLocale = defaultLocale;
			...
			if (useMatchedPathHeader) {
				try {
					var _this_normalizers_data,
						_this_normalizers_postponed,
						_this_i18nProvider2,
						_this_getRoutesManifest;
					if (this.enabledDirectories.app) {
					...
					if (
						(_this_normalizers_data = this.normalizers.data) == null
							? void 0
							: _this_normalizers_data.match(urlPathname)
					) {
						parsedUrl.query.__nextDataReq = "1";
					} else if (
						((_this_normalizers_postponed = this.normalizers.postponed) == null
							? void 0
							: _this_normalizers_postponed.match(matchedPath)) &&
						req.method === "POST"
					) {
					...
					const localeAnalysisResult =
						(_this_i18nProvider2 = this.i18nProvider) == null
							? void 0
							: _this_i18nProvider2.analyze(matchedPath, {
									defaultLocale,
								});
					...
					matchedPath = (0, _denormalizepagepath.denormalizePagePath)(
						matchedPath,
					);
					...
					const utils = (0, _serverutils.getUtils)({
						...
						basePath: this.nextConfig.basePath,
						rewrites: ((_this_getRoutesManifest = this.getRoutesManifest()) ==
						null
							? void 0
							: _this_getRoutesManifest.rewrites) || {
							beforeFiles: [],
							afterFiles: [],
							fallback: [],
						},
					...
					if (pageIsDynamic) {
						...
						if (
							...
							pageIsDynamic &&
							!(0, _utils1.isDynamicRoute)(normalizedUrlPath)
						) {
							let matcherParams =
								utils.dynamicRouteMatcher == null
									? void 0
									: utils.dynamicRouteMatcher.call(utils, normalizedUrlPath);
							if (matcherParams) {
						...
						if (
							...
							(0, _utils1.isDynamicRoute)(matchedPath) &&
							!paramsResult.hasValidParams
						) {
							const opts = {};
						...
						if (
							...
							!paramsResult.hasValidParams &&
							!utils.normalizeDynamicRouteParams(
								{
									...params,
								},
								true,
					...
					if (pageIsDynamic || didRewrite) {
						...
						utils.normalizeVercelUrl(req, true, [
							...rewriteParamKeys,
							...Object.keys(
								((_utils_defaultRouteRegex = utils.defaultRouteRegex) == null
									? void 0
									: _utils_defaultRouteRegex.groups) || {},
							),
						]);
					}
					...
					if (
						err instanceof _utils.DecodeError ||
						err instanceof _utils.NormalizeError
					) {
						res.statusCode = 400;
			...
			if (
				...
				!(0, _requestmeta.getRequestMeta)(req, "incrementalCache")
			) {
				let protocol = "https:";
				try {
					const parsedFullUrl = new URL(
						(0, _requestmeta.getRequestMeta)(req, "initURL") || "/",
						"http://n",
					);
			...
			if (useInvokePath) {
				...
				const invokeStatus = (0, _requestmeta.getRequestMeta)(
					req,
					"invokeStatus",
				);
				if (invokeStatus) {
					const invokeQuery = (0, _requestmeta.getRequestMeta)(
						req,
						"invokeQuery",
					);
					if (invokeQuery) {
					...
					let err =
						(0, _requestmeta.getRequestMeta)(req, "invokeError") || null;
					return this.renderError(err, req, res, "/_error", parsedUrl.query);
				}
				const parsedMatchedPath = new URL(invokePath || "/", "http://n");
				const invokePathnameInfo = (0,
				_getnextpathnameinfo.getNextPathnameInfo)(parsedMatchedPath.pathname, {
					nextConfig: this.nextConfig,
					parseData: false,
				});
				...
				const normalizeResult = (0, _normalizelocalepath.normalizeLocalePath)(
					...
					((_this_nextConfig_i18n1 = this.nextConfig.i18n) == null
						? void 0
						: _this_nextConfig_i18n1.locales) || [],
				);
	...
	async run(req, res, parsedUrl) {
		return (0, _tracer.getTracer)().trace(
			_constants1.BaseServerSpan.run,
			async () => this.runImpl(req, res, parsedUrl),
		);
	}
	...
	async pipe(fn, partialContext) {
		return (0, _tracer.getTracer)().trace(
			_constants1.BaseServerSpan.pipe,
			async () => this.pipeImpl(fn, partialContext),
		);
	}
	async pipeImpl(fn, partialContext) {
		const isBotRequest = (0, _isbot.isBot)(
			partialContext.req.headers["user-agent"] || "",
		);
		const ctx = {
			...partialContext,
			renderOpts: {
	...
	async render(
		...
		return (0, _tracer.getTracer)().trace(
			_constants1.BaseServerSpan.render,
			async () =>
				this.renderImpl(req, res, pathname, query, parsedUrl, internalRender),
		);
	}
	getWaitUntil() {
		const builtinRequestContext = (0,
		_builtinrequestcontext.getBuiltinRequestContext)();
	...
	async renderImpl(
		...
		if (
			...
			!this.minimalMode &&
			!query.__nextDataReq &&
			(((_req_url = req.url) == null ? void 0 : _req_url.match(/^\/_next\//)) ||
	...
	async getStaticPaths({ pathname }) {
		...
		const fallbackField =
			(_this_getPrerenderManifest_dynamicRoutes_pathname =
				this.getPrerenderManifest().dynamicRoutes[pathname]) == null
				? void 0
				: _this_getPrerenderManifest_dynamicRoutes_pathname.fallback;
		return {
	...
	async renderToResponseWithComponents(requestContext, findComponentsResult) {
		return (0, _tracer.getTracer)().trace(
			_constants1.BaseServerSpan.renderToResponseWithComponents,
			async () =>
	...
	pathCouldBeIntercepted(resolvedPathname) {
		return (
			(0, _interceptionroutes.isInterceptionRouteAppPath)(resolvedPathname) ||
	...
	async renderToResponseWithComponentsImpl(
		{ req, res, pathname, renderOpts: opts },
		{ components, query },
	) {
		var _components_Component,
			_this_nextConfig_i18n,
			_this_nextConfig_i18n1,
			_cacheEntry_value;
		...
		const hasGetInitialProps = !!((_components_Component =
			components.Component) == null
			? void 0
			: _components_Component.getInitialProps);
		...
		let resolvedUrlPathname =
			(0, _requestmeta.getRequestMeta)(req, "rewroteURL") || urlPathname;
		...
		if (isAppPath && isDynamic) {
			...
			if (this.nextConfig.output === "export") {
				...
				const resolvedWithoutSlash = (0,
				_removetrailingslash.removeTrailingSlash)(resolvedUrlPathname);
				if (
					!(staticPaths == null
						? void 0
		...
		if (
			...
			(staticPaths == null
				? void 0
				: staticPaths.includes(resolvedUrlPathname)) || // this signals revalidation in deploy environments
		...
		const isNextDataRequest =
			!!(
				query.__nextDataReq ||
				(req.headers["x-nextjs-data"] && this.serverOptions.webServerConfig)
			) &&
		 ...
		 */ const isPrefetchRSCRequest =
			(req.headers[
				...
				(0, _requestmeta.getRequestMeta)(req, "isPrefetchRSCRequest")) ??
			false;
		...
		if (opts.supportsDynamicResponse === true) {
			...
			const isSupportedDocument =
				typeof ((_components_Document = components.Document) == null
					? void 0
					: _components_Document.getInitialProps) !== "function" || // The built-in `Document` component also supports dynamic HTML for concurrent mode.
		...
		if (
			...
			isRSCRequest &&
			!isDynamicRSCRequest &&
			(!(0, _isedgeruntime.isEdgeRuntime)(opts.runtime) ||
				this.serverOptions.webServerConfig)
		) {
			(0, _stripflightheaders.stripFlightHeaders)(req.headers);
		}
		...
		if (isSSG) {
			({ isOnDemandRevalidate, revalidateOnlyGenerated } = (0,
			_apiutils.checkIsOnDemandRevalidate)(req, this.renderOpts.previewProps));
		}
		...
		resolvedUrlPathname = (0, _removetrailingslash.removeTrailingSlash)(
			resolvedUrlPathname,
		);
		...
		const handleRedirect = (pageData) => {
			...
			if (redirect.destination.startsWith("/")) {
				redirect.destination = (0, _utils.normalizeRepeatedSlashes)(
		...
		if (ssgCacheKey) {
			...
			ssgCacheKey = ssgCacheKey
				...
				.map((seg) => {
					try {
						seg = (0, _escapepathdelimiters.default)(
		...
		const incrementalCache =
			process.env.NEXT_RUNTIME === "edge" && globalThis.__incrementalCache
		...
		const doRender = async ({ postponed }) => {
			...
			if (routeModule) {
				if ((0, _checks.isAppRouteRouteModule)(routeModule)) {
					...
					try {
						const request = _nextrequest.NextRequestAdapter.fromBaseNextRequest(
							req,
							(0, _nextrequest.signalFromNodeResponse)(res.originalResponse),
						);
						...
						if (isSSG && process.env.NEXT_RUNTIME !== "edge") {
							...
							const headers = (0, _utils3.toNodeOutgoingHttpHeaders)(
								response.headers,
							);
							if (cacheTags) {
							...
							const revalidate =
								((_context_renderOpts_store = context.renderOpts.store) == null
									? void 0
									: _context_renderOpts_store.revalidate) ?? false;
						...
						await (0, _sendresponse.sendResponse)(
							req,
							res,
							response,
						...
						await (0, _sendresponse.sendResponse)(
							req,
							res,
							(0, _responsehandlers.handleInternalServerErrorResponse)(),
						);
						return null;
					}
			...
			const {
				headers = {}, // Add any fetch tags that were on the page to the response headers.
				fetchTags: cacheTags,
			} = metadata;
			if (cacheTags) {
				headers[_constants2.NEXT_CACHE_TAGS_HEADER] = cacheTags;
			...
			if (
				...
				const err = new Error(
					`Page changed from static to dynamic at runtime ${urlPathname}${(staticBailoutInfo == null ? void 0 : staticBailoutInfo.description) ? `, reason: ${staticBailoutInfo.description}` : ``}` +
		...
		const cacheEntry = await this.responseCache.get(
			ssgCacheKey,
			async (hasResolved, previousCacheEntry, isRevalidating) => {
				...
				if (
					fallbackMode === "static" &&
					(0, _isbot.isBot)(req.headers["user-agent"] || "")
				) {
				...
				const isPageIncludedInStaticPaths =
					staticPathKey &&
					(staticPaths == null ? void 0 : staticPaths.includes(staticPathKey));
				...
				if (
					...
					if (
						...
						(isProduction ||
							(staticPaths &&
								(staticPaths == null ? void 0 : staticPaths.length) > 0)) && // When fallback isn't present, abort this render so we 404
						fallbackMode !== "static"
					) {
		...
		const didPostpone =
			((_cacheEntry_value = cacheEntry.value) == null
				? void 0
				: _cacheEntry_value.kind) === "PAGE" && !!cacheEntry.value.postponed;
		if (
			isSSG &&
			!this.minimalMode && // We don't want to send a cache header for requests that contain dynamic
		...
		if (minimalPostponed) {
			...
			if (isPreviewMode || (is404Page && !isNextDataRequest)) {
				...
				const notFoundRevalidate = (0, _requestmeta.getRequestMeta)(
					req,
					"notFoundRevalidate",
				);
				revalidate =
		...
		if (!cachedData) {
			...
			if (cacheEntry.revalidate && !res.getHeader("Cache-Control")) {
				res.setHeader(
					"Cache-Control",
					(0, _revalidate.formatRevalidate)({
						revalidate: cacheEntry.revalidate,
						swrDelta: this.nextConfig.experimental.swrDelta,
					}),
				);
			...
			if (
				...
				((_cachedData_headers = cachedData.headers) == null
					? void 0
					: _cachedData_headers[_constants2.NEXT_CACHE_TAGS_HEADER])
			) {
				res.setHeader(
					_constants2.NEXT_CACHE_TAGS_HEADER,
					cachedData.headers[_constants2.NEXT_CACHE_TAGS_HEADER],
				);
			}
	...
	stripNextDataPath(path, stripLocale = true) {
		if (path.includes(this.buildId)) {
			...
			path = (0, _denormalizepagepath.denormalizePagePath)(
				splitPath.replace(/\.json$/, ""),
			);
		}
	...
	getOriginalAppPaths(route) {
		if (this.enabledDirectories.app) {
			...
			const originalAppPath =
				(_this_appPathRoutes = this.appPathRoutes) == null
					? void 0
					: _this_appPathRoutes[route];
			if (!originalAppPath) {
				return null;
			}
	...
	async renderPageComponent(ctx, bubbleNoFallback) {
		...
		const result = await this.findPageComponents({
			...
			isAppPath,
			sriEnabled: !!((_this_nextConfig_experimental_sri =
		...
		if (result) {
			...
			(_getTracer_getRootSpanAttributes = (0,
			_tracer.getTracer)().getRootSpanAttributes()) == null
				? void 0
				: _getTracer_getRootSpanAttributes.set("next.route", pathname);
			try {
	...
	async renderToResponse(ctx) {
		return (0, _tracer.getTracer)().trace(
			_constants1.BaseServerSpan.renderToResponse,
			{
	...
	async renderToResponseImpl(ctx) {
		...
		const options = {
			i18n:
				(_this_i18nProvider = this.i18nProvider) == null
					? void 0
					: _this_i18nProvider.fromQuery(pathname, query),
		};
		try {
			for await (const match of this.matchers.matchAll(pathname, options)) {
				// when a specific invoke-output is meant to be matched
				// ensure a prior dynamic route/page doesn't take priority
				const invokeOutput = (0, _requestmeta.getRequestMeta)(
					ctx.req,
					"invokeOutput",
				);
				if (
					...
					(0, _utils1.isDynamicRoute)(invokeOutput || "") &&
					...
					JSON.stringify(
						{
							...
							didRewrite: !!(0, _requestmeta.getRequestMeta)(
								ctx.req,
								"rewroteURL",
							),
							rewroteUrl: (0, _requestmeta.getRequestMeta)(
								ctx.req,
								"rewroteURL",
							),
						},
	...
	async renderToHTML(req, res, pathname, query = {}) {
		return (0, _tracer.getTracer)().trace(
			_constants1.BaseServerSpan.renderToHTML,
			async () => {
	...
	async renderError(err, req, res, pathname, query = {}, setHeaders = true) {
		return (0, _tracer.getTracer)().trace(
			_constants1.BaseServerSpan.renderError,
			async () => {
				return this.renderErrorImpl(err, req, res, pathname, query, setHeaders);
			},
		);
	}
	async renderErrorImpl(
		err,
		req,
		res,
		pathname,
	...
	async renderErrorToResponse(ctx, err) {
		return (0, _tracer.getTracer)().trace(
			_constants1.BaseServerSpan.renderErrorToResponse,
			async () => {
	...
	async renderErrorToResponseImpl(ctx, err) {
		...
		try {
			...
			if (
				...
				!result &&
				_constants.STATIC_STATUS_PAGES.includes(statusPage)
			) {
...
function isRSCRequestCheck(req) {
	return (
		req.headers[_approuterheaders.RSC_HEADER.toLowerCase()] === "1" ||
		Boolean((0, _requestmeta.getRequestMeta)(req, "isRSCRequest"))
	);
}
