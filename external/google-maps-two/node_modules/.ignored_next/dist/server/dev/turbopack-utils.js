...
function renderStyledStringToErrorAnsi(string) {
	function decodeMagicIdentifiers(str) {
		return str.replaceAll(_magicidentifier.MAGIC_IDENTIFIER_REGEX, (ident) => {
			try {
				return (0, _picocolors.magenta)(
					`{${(0, _magicidentifier.decodeMagicIdentifier)(ident)}}`,
				);
			} catch (e) {
	...
	switch (string.type) {
		...
		case "strong":
			return (0, _picocolors.bold)(
				(0, _picocolors.red)(decodeMagicIdentifiers(string.value)),
			);
		case "code":
					...
					hooks == null
						...
						: hooks.subscribeToChanges(
								...
								() => {
									return {
										action:
											_hotreloadertypes.HMR_ACTIONS_SENT_TO_BROWSER.RELOAD_PAGE,
									};
								},
							);
				}
				...
				dev.serverFields.middleware = {
					...
					matchers:
						(_manifestLoader_getMiddlewareManifest =
							...
							? void 0
							: _manifestLoader_getMiddlewareManifest.middleware["/"].matchers,
				};
			}
		}
