...
function getUtils({
	...
	function handleRewrites(req, parsedUrl) {
		...
		const matchesPage = () => {
			const fsPathnameNoSlash = (0, _removetrailingslash.removeTrailingSlash)(
				fsPathname || "",
			);
			return (
				fsPathnameNoSlash ===
		...
		const checkRewrite = (rewrite) => {
			...
			if (params) {
				...
				if (i18n) {
					...
					_normalizelocalepath.normalizeLocalePath)(fsPathname, i18n.locales);
							...
							for (const key of Object.keys(obj)) {
								...
								if (
									...
									const normalizedKey = key.substring(
										_constants.NEXT_QUERY_PARAM_PREFIX.length,
									);
	...
	return {
		...
		normalizeDynamicRouteParams: (params, ignoreOptional) =>
		...
		normalizeVercelUrl: (req, trustQuery, paramKeys) =>
			normalizeVercelUrl(
				req,
				trustQuery,
				paramKeys,
