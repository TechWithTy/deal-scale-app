...
const _fresh = /*#__PURE__*/ _interop_require_default(
	require("next/dist/compiled/fresh"),
);
	...
	if (payload !== null) {
		...
		if (type === "rsc") {
			...
			try {
				...
				let scriptTags =
					(_root_querySelector = root.querySelector("body")) == null
						? void 0
						: _root_querySelector.querySelectorAll("script").filter((node) => {
								var _node_innerHTML;
								return (
									!node.hasAttribute("src") &&
									((_node_innerHTML = node.innerHTML) == null
										? void 0
										: _node_innerHTML.includes("__next_f"))
								);
							});
				...
				scriptTags == null
					...
					: scriptTags.forEach((script) => {
							var _root_querySelector;
							return (_root_querySelector = root.querySelector("body")) == null
								? void 0
								: _root_querySelector.appendChild(script);
						});
		...
		const etag = generateEtags
			? (0, _etag.generateETag)(etagPayload)
			: undefined;
