...
async function loadComponentsImpl({ distDir, page, isAppPath, isDev }) {
	...
	const hasClientManifest =
		isAppPath &&
		(page.endsWith("/page") || page === _constants.UNDERSCORE_NOT_FOUND_ROUTE);
	...
	const ComponentMod = await Promise.resolve().then(() =>
		(0, _require.requirePage)(page, distDir, isAppPath),
	);
...
const loadComponents = (0, _tracer.getTracer)().wrap(
	_constants1.LoadComponentsSpan.loadComponents,
	loadComponentsImpl,
);
