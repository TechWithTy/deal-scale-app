...
const zExportMap = _zod.z.record(
	_zod.z.string(),
	_zod.z.object({
		page: _zod.z.string(),
		query: _zod.z.any(),
...
const zRouteHas = _zod.z.union([
	_zod.z.object({
		type: _zod.z.enum(["header", "query", "cookie"]),
		key: _zod.z.string(),
...
const zTurboRuleConfigItem = _zod.z.union([
	...
	_zod.z.record(
		_zod.z.string(),
		_zod.z.lazy(() => zTurboRuleConfigItem),
	),
...
const configSchema = _zod.z.lazy(() =>
	_zod.z.strictObject({
							...
							importMap: _zod.z
								.record(
									...
									_zod.z.record(
										_zod.z.string(),
										_zod.z.object({
											canonicalImport: _zod.z
												.tuple([_zod.z.string(), _zod.z.string()])
												.optional(),
											styledBaseImport: _zod.z
												.tuple([_zod.z.string(), _zod.z.string()])
												.optional(),
										}),
									),
		...
		crossOrigin: _zod.z
			.union([_zod.z.literal("anonymous"), _zod.z.literal("use-credentials")])
			.optional(),
		deploymentId: _zod.z.string().optional(),
		devIndicators: _zod.z
			.object({
				buildActivity: _zod.z.boolean().optional(),
				buildActivityPosition: _zod.z
					.union([
		...
		env: _zod.z
			.record(
				_zod.z.string(),
				_zod.z.union([_zod.z.string(), _zod.z.undefined()]),
			)
			.optional(),
		eslint: _zod.z
			.strictObject({
		...
		experimental: _zod.z
			.strictObject({
				...
				esmExternals: _zod.z
					.union([_zod.z.boolean(), _zod.z.literal("loose")])
					.optional(),
				serverActions: _zod.z
					.object({
				...
				middlewarePrefetch: _zod.z.enum(["strict", "flexible"]).optional(),
				multiZoneDraftMode: _zod.z.boolean().optional(),
				cssChunking: _zod.z.enum(["strict", "loose"]).optional(),
				nextScriptWorkers: _zod.z.boolean().optional(),
				// The critter option is unknown, use z.any() here
				optimizeCss: _zod.z.union([_zod.z.boolean(), _zod.z.any()]).optional(),
				optimisticClientCache: _zod.z.boolean().optional(),
				outputFileTracingRoot: _zod.z.string().optional(),
				outputFileTracingExcludes: _zod.z
					.record(_zod.z.string(), _zod.z.array(_zod.z.string()))
					.optional(),
				outputFileTracingIgnores: _zod.z.array(_zod.z.string()).optional(),
				outputFileTracingIncludes: _zod.z
					.record(_zod.z.string(), _zod.z.array(_zod.z.string()))
					.optional(),
				...
				serverComponentsExternalPackages: _zod.z
					.array(_zod.z.string())
					.optional(),
				scrollRestoration: _zod.z.boolean().optional(),
				sri: _zod.z
					.object({
						algorithm: _zod.z.enum(["sha256", "sha384", "sha512"]).optional(),
					})
					.optional(),
				...
				turbo: _zod.z
					.object({
						loaders: _zod.z
							.record(_zod.z.string(), _zod.z.array(zTurboLoaderItem))
							.optional(),
						rules: _zod.z
							.record(_zod.z.string(), zTurboRuleConfigItemOrShortcut)
							.optional(),
						resolveAlias: _zod.z
							.record(
								_zod.z.string(),
		...
		exportPathMap: _zod.z
			...
			.returns(_zod.z.union([zExportMap, _zod.z.promise(zExportMap)]))
			.optional(),
		generateBuildId: _zod.z
			.function()
			.args()
			.returns(
				_zod.z.union([
					_zod.z.string(),
					_zod.z.null(),
					_zod.z.promise(_zod.z.union([_zod.z.string(), _zod.z.null()])),
				]),
			)
			.optional(),
		...
		headers: _zod.z
			.function()
			.args()
			.returns(_zod.z.promise(_zod.z.array(zHeader)))
			.optional(),
		httpAgentOptions: _zod.z
			.strictObject({
		...
		images: _zod.z
			.strictObject({
				localPatterns: _zod.z
					...
					.max(25)
					.optional(),
				remotePatterns: _zod.z
					.array(
						_zod.z.strictObject({
							hostname: _zod.z.string(),
							pathname: _zod.z.string().optional(),
							port: _zod.z.string().max(5).optional(),
							protocol: _zod.z.enum(["http", "https"]).optional(),
							search: _zod.z.string().optional(),
						}),
					)
					.max(50)
				...
				qualities: _zod.z
					.array(_zod.z.number().int().gte(1).lte(100))
					.min(1)
					.max(20)
					.optional(),
			})
		...
		output: _zod.z.enum(["standalone", "export"]).optional(),
		...
		publicRuntimeConfig: _zod.z
			.record(_zod.z.string(), _zod.z.any())
			.optional(),
		...
		redirects: _zod.z
			.function()
			.args()
			.returns(_zod.z.promise(_zod.z.array(zRedirect)))
			.optional(),
		rewrites: _zod.z
			.function()
			.args()
