...
function addImplicitTags(staticGenerationStore) {
	...
	if (pagePath) {
		...
		for (let tag of derivedTags) {
			...
			if (
				!((_staticGenerationStore_tags = staticGenerationStore.tags) == null
					? void 0
	...
	if (urlPathname) {
		...
		if (
			!((_staticGenerationStore_tags1 = staticGenerationStore.tags) == null
				? void 0
...
function trackFetchMetric(staticGenerationStore, ctx) {
	...
	if (
		...
		((_staticGenerationStore_requestEndedState =
			staticGenerationStore.requestEndedState) == null
			? void 0
			: _staticGenerationStore_requestEndedState.ended) ||
...
function createPatchedFetcher(
	originFetch,
	{ serverHooks: { DynamicServerError }, staticGenerationAsyncStorage },
) {
		...
		return (0, _tracer.getTracer)().trace(
			...
			async () => {
				...
				if (
					...
					if (revalidate === 0) {
						(0, _dynamicrendering.trackDynamicFetch)(
							staticGenerationStore,
							"revalidate: 0",
						);
					}
					...
					pendingRevalidate = pendingResponse
						...
						.finally(() => {
							if (cacheKey) {
								...
								if (
									!((_staticGenerationStore_pendingRevalidates =
										staticGenerationStore.pendingRevalidates) == null
										? void 0
										: _staticGenerationStore_pendingRevalidates[cacheKey])
								) {
									return;
								}
