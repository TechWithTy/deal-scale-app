...
export declare function resolveImages(
...
export declare const resolveOpenGraph: FieldResolverExtraArgs<
	"openGraph",
	[ResolvedMetadataBase, MetadataContext, string | null]
>;
export declare const resolveTwitter: FieldResolverExtraArgs<
	"twitter",
	[ResolvedMetadataBase, MetadataContext, string | null]
>;
export {};
