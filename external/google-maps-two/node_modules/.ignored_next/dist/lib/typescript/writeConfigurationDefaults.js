...
function getDesiredCompilerOptions(ts, tsOptions) {
	const o = {
		...
		...(_semver.default.gte(ts.version, "5.4.0") &&
		(tsOptions == null ? void 0 : tsOptions.module) === ts.ModuleKind.Preserve
			? {}
			: {
					esModuleInterop: {
						value: true,
		...
		...((tsOptions == null ? void 0 : tsOptions.verbatimModuleSyntax) === true
			? undefined
			: {
					isolatedModules: {
						value: true,
...
async function writeConfigurationDefaults(
	...
	const { options: tsOptions, raw: rawConfig } = await (0,
		...
		if ("suggested" in check) {
			...
			if (
				!("parsedValues" in check
					? (_check_parsedValues = check.parsedValues) == null
						? void 0
						: _check_parsedValues.includes(ev)
	...
	if (!("include" in rawConfig)) {
		...
		suggestedActions.push(
			(0, _picocolors.cyan)("include") +
				" was updated to add " +
				(0, _picocolors.bold)(`'${nextAppTypes}'`),
		);
	}
	...
	_log.info(
		`We detected TypeScript in your project and reconfigured your ${(0, _picocolors.cyan)("tsconfig.json")} file for you. Strict-mode is set to ${(0, _picocolors.cyan)("false")} by default.`,
	);
