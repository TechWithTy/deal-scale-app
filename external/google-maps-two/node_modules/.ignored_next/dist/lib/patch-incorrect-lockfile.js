...
const _packagejson = /*#__PURE__*/ _interop_require_default(
...
async function patchIncorrectLockfile(dir) {
	...
	const lockfileVersion = parseInt(
		lockfileParsed == null ? void 0 : lockfileParsed.lockfileVersion,
		10,
	);
	const expectedSwcPkgs = Object.keys(
		_packagejson.default["optionalDependencies"] || {},
	...
	try {
		...
		_log.warn(
			...
			_ciinfo.isCI ? "run next locally to automatically patch" : "patching...",
		);
		if (_ciinfo.isCI) {
