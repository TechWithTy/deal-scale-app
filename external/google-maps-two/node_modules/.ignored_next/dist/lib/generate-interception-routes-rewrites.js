...
function generateInterceptionRoutesRewrites(appPaths, basePath = "") {
	...
	for (const appPath of appPaths) {
		if ((0, _interceptionroutes.isInterceptionRouteAppPath)(appPath)) {
			...
			_interceptionroutes.extractInterceptionRouteInformation)(appPath);
			...
			let interceptingRouteRegex = (0, _pathtoregexp.pathToRegexp)(
				normalizedInterceptingRoute,
			)
				.toString()
				.slice(2, -3);
			rewrites.push({
...
function isInterceptionRouteRewrite(route) {
	...
	return (
		((_route_has = route.has) == null
			? void 0
			: (_route_has_ = _route_has[0]) == null
				? void 0
				: _route_has_.key) === _approuterheaders.NEXT_URL
	);
}
