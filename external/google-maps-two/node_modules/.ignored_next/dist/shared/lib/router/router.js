...
class Router {
	...
	async change(method, url, as, options, forcedScroll) {
		...
		if (process.env.__NEXT_I18N_SUPPORT) {
			...
			if (process.env.__NEXT_I18N_SUPPORT) {
				...
				if (
					!((_this_locales = this.locales) == null
						? void 0
						: _this_locales.includes(nextState.locale))
				) {
	 ...
	 */ async prefetch(url, asPath, options) {
		...
		if (process.env.__NEXT_HAS_REWRITES && asPath.startsWith("/")) {
			...
			const rewritesResult = (0, _resolverewrites.default)(
				(0, _addbasepath.addBasePath)(
					(0, _addlocale.addLocale)(asPath, this.locale),
					true,
				),
				pages,
				rewrites,
	...
	constructor(
		...
		if (process.env.__NEXT_CLIENT_ROUTER_FILTER_ENABLED) {
			...
			const staticFilterData = routerFilterSValue
				? routerFilterSValue
				: undefined;
			const routerFilterDValue = process.env.__NEXT_CLIENT_ROUTER_D_FILTER;
			const dynamicFilterData = routerFilterDValue
				? routerFilterDValue
				: undefined;
