...
export declare function adaptForAppRouterInstance(
 ...
 */
export declare function adaptForSearchParams(
	router: Pick<NextRouter, "isReady" | "query" | "asPath">,
): URLSearchParams;
export declare function adaptForPathParams(
	router: Pick<NextRouter, "isReady" | "pathname" | "query" | "asPath">,
): Params | null;
export declare function PathnameContextProviderAdapter({
	children,
	router,
	...props
