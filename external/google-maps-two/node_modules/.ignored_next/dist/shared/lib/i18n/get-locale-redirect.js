...
function getLocaleFromCookie(i18n, headers) {
	...
	const nextLocale =
		(_getCookieParser = (0, _getcookieparser.getCookieParser)(
			headers || {},
		)()) == null
			? void 0
			: (_getCookieParser_NEXT_LOCALE = _getCookieParser.NEXT_LOCALE) == null
				? void 0
				: _getCookieParser_NEXT_LOCALE.toLowerCase();
	return nextLocale
...
function getAcceptPreferredLocale(i18n, headers) {
	if (
		(headers == null ? void 0 : headers["accept-language"]) &&
		!Array.isArray(headers["accept-language"])
	) {
		try {
			return (0, _acceptheader.acceptLanguage)(
...
function getLocaleRedirect(param) {
	...
	if (
		...
		(0, _denormalizepagepath.denormalizePagePath)(urlParsed.pathname) === "/"
	) {
		...
		const preferredDomain = (0, _detectdomainlocale.detectDomainLocale)(
