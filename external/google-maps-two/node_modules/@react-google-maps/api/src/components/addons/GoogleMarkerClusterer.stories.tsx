...
// @ts-ignore
export const Default: AnnotatedStoryFn<
	ReactRenderer,
...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
export const Grid: AnnotatedStoryFn<ReactRenderer, GoogleMarkerClustererProps> =
	Template.bind({});
...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
export const Noop: AnnotatedStoryFn<ReactRenderer, GoogleMarkerClustererProps> =
	Template.bind({});
Noop.args = {
...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignorex
export const Render: AnnotatedStoryFn<
	ReactRenderer,
	GoogleMarkerClustererProps
> = Template.bind({});
Render.args = {
