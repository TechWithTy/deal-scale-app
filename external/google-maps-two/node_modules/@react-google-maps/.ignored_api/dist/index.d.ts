...
declare class LoadScript extends PureComponent<
	LoadScriptProps,
	LoadScriptState
> {
	static defaultProps: {
...
declare function useLoadScript({
	id,
	version,
	nonce,
	googleMapsApiKey,
...
declare function LoadScriptNext({
	loadingElement,
	onLoad,
	onError,
	onUnmount,
...
declare function useJsApiLoader({
	id,
	version,
	nonce,
	googleMapsApiKey,
...
declare function TrafficLayerFunctional({
	options,
	onLoad,
	onUnmount,
}: TrafficLayerProps): null;
declare const TrafficLayerF: react.MemoExoticComponent<
	typeof TrafficLayerFunctional
>;
declare class TrafficLayer extends PureComponent<
	TrafficLayerProps,
	TrafficLayerState
> {
...
declare function BicyclingLayerFunctional({
	onLoad,
	onUnmount,
}: BicyclingLayerProps): null;
declare const BicyclingLayerF: react.MemoExoticComponent<
	typeof BicyclingLayerFunctional
>;
declare class BicyclingLayer extends PureComponent<
	BicyclingLayerProps,
	BicyclingLayerState
> {
	static contextType: react.Context<google.maps.Map | null>;
...
declare function TransitLayerFunctional({
	onLoad,
	onUnmount,
}: TransitLayerProps): null;
declare const TransitLayerF: react.MemoExoticComponent<
	typeof TransitLayerFunctional
>;
declare class TransitLayer extends PureComponent<
	TransitLayerProps,
	TransitLayerState
> {
	static contextType: react.Context<google.maps.Map | null>;
...
declare function DrawingManagerFunctional({
	options,
	drawingMode,
	onCircleComplete,
	onMarkerComplete,
...
declare const DrawingManagerF: react.MemoExoticComponent<
	typeof DrawingManagerFunctional
>;
declare class DrawingManager extends PureComponent<
	DrawingManagerProps,
	DrawingManagerState
> {
	static contextType: react.Context<google.maps.Map | null>;
...
declare function MarkerFunctional({
	position,
	options,
	clusterer,
	noClustererRedraw,
...
declare function MarkerClustererFunctional(
	props: MarkerClustererProps,
): JSX.Element | null;
declare const MarkerClustererF: react.MemoExoticComponent<
	typeof MarkerClustererFunctional
>;
declare class ClustererComponent extends PureComponent<
...
declare function InfoBoxFunctional({
	children,
	anchor,
	options,
	position,
...
declare class InfoBoxComponent extends PureComponent<
	InfoBoxProps,
	InfoBoxState
> {
	static contextType: react.Context<google.maps.Map | null>;
 ...
 */
declare function GoogleMarkerClusterer({
	children,
	options,
}: GoogleMarkerClustererProps): ReactElement<any, any> | null;
...
declare function InfoWindowFunctional({
	children,
	anchor,
	options,
	position,
...
declare const InfoWindowF: react.MemoExoticComponent<
	typeof InfoWindowFunctional
>;
declare class InfoWindow extends PureComponent<
	InfoWindowProps,
	InfoWindowState
> {
	static contextType: react.Context<google.maps.Map | null>;
...
declare function PolylineFunctional({
	options,
	draggable,
	editable,
	visible,
...
declare function PolygonFunctional({
	options,
	draggable,
	editable,
	visible,
...
declare function RectangleFunctional({
	options,
	bounds,
	draggable,
	editable,
...
declare function CircleFunctional({
	options,
	center,
	radius,
	draggable,
...
declare function DataFunctional({
	options,
	onClick,
	onDblClick,
	onMouseDown,
...
declare function OverlayViewFunctional({
	position,
	bounds,
	mapPaneName,
	zIndex,
	...
	getPixelPositionOffset,
	children,
}: OverlayViewProps): ReactPortal;
declare const OverlayViewF: react.MemoExoticComponent<
	typeof OverlayViewFunctional
>;
declare class OverlayView extends PureComponent<
	OverlayViewProps,
	OverlayViewState
> {
...
declare function GroundOverlayFunctional({
	url,
	bounds,
	options,
	visible,
}: GroundOverlayProps): null;
declare const GroundOverlayF: react.MemoExoticComponent<
	typeof GroundOverlayFunctional
>;
declare class GroundOverlay extends PureComponent<
	GroundOverlayProps,
	GroundOverlayState
> {
	static defaultProps: {
...
declare function HeatmapLayerFunctional({
	data,
	onLoad,
	onUnmount,
	options,
}: HeatmapLayerProps): null;
declare const HeatmapLayerF: react.MemoExoticComponent<
	typeof HeatmapLayerFunctional
>;
declare class HeatmapLayer extends PureComponent<
	HeatmapLayerProps,
	HeatmapLayerState
> {
	static contextType: react.Context<google.maps.Map | null>;
...
declare class StreetViewPanorama extends PureComponent<
...
declare class StreetViewService extends PureComponent<
...
declare class DirectionsService extends PureComponent<
...
declare class DirectionsRenderer extends PureComponent<
...
declare class DistanceMatrixService extends PureComponent<
...
declare class StandaloneSearchBox extends PureComponent<
...
export {
	...
	GoogleMap,
	type GoogleMapProps,
	_default as GoogleMarkerClusterer,
	type GoogleMarkerClustererProps,
	GroundOverlay,
	GroundOverlayF,
	type GroundOverlayProps,
