(function (global, factory) {
	typeof exports === "object" && typeof module !== "undefined"
		...
		: typeof define === "function" && define.amd
			? define(["exports", "react/jsx-runtime", "react", "react-dom"], factory)
			: ((global =
					typeof globalThis !== "undefined" ? globalThis : global || self),
				factory(
					(global.reactGoogleMapsApi = {}),
					global.ReactJSXRuntime,
					global.React,
					global.ReactDOM,
				));
})(this, function (exports, jsxRuntime, react, ReactDOM) {
	"use strict";
				...
				children: [
					...
					this.state.loaded
						...
						: this.props.loadingElement ||
							jsxRuntime.jsx(DefaultLoadingElement, {}),
				],
			});
		}
	}
  ...
  ***************************************************************************** */
				...
				if (!isEqual(this.options, Loader.instance.options)) {
					throw new Error(
						"Loader must not be called again with different options. "
							...
							.concat(JSON.stringify(Loader.instance.options)),
					);
				}
						...
						u = () =>
							...
							(h = new Promise((f, n) =>
								__awaiter(this, void 0, void 0, function* () {
									...
									a.nonce =
										this.nonce ||
										((_a = m.querySelector("script[nonce]")) === null ||
										_a === void 0
											? void 0
											: _a.nonce) ||
										"";
	...
	function DrawingManagerFunctional(_ref) {
		...
		var map = react.useContext(MapContext);
		var [instance, setInstance] = react.useState(null);
		var [circlecompleteListener, setCircleCompleteListener] =
			react.useState(null);
		var [markercompleteListener, setMarkerCompleteListener] =
			react.useState(null);
		var [overlaycompleteListener, setOverlayCompleteListener] =
			react.useState(null);
		var [polygoncompleteListener, setPolygonCompleteListener] =
			react.useState(null);
		var [polylinecompleteListener, setPolylineCompleteListener] =
			react.useState(null);
		var [rectanglecompleteListener, setRectangleCompleteListener] =
			react.useState(null);
		// Order does matter
		react.useEffect(() => {
			if (instance !== null) {
	...
	function MarkerFunctional(_ref) {
		...
		var [clickListener, setClickListener] = react.useState(null);
		var [dragListener, setDragListener] = react.useState(null);
		var [clickableChangedListener, setClickableChangedListener] =
			react.useState(null);
		var [cursorChangedListener, setCursorChangedListener] =
			react.useState(null);
		var [animationChangedListener, setAnimationChangedListener] =
			react.useState(null);
		var [draggableChangedListener, setDraggableChangedListener] =
			react.useState(null);
		...
		var [positionChangedListener, setPositionChangedListener] =
			react.useState(null);
		...
		var [visibleChangedListener, setVisibleChangedListener] =
			react.useState(null);
		var [zIndexChangedListener, setZindexChangedListener] =
			react.useState(null);
		// Order does matter
		react.useEffect(() => {
			if (instance !== null) {
	...
	function MarkerClustererFunctional(props) {
		...
		var map = react.useContext(MapContext);
		var [clickListener, setClickListener] = react.useState(null);
		var [clusteringBeginListener, setClusteringBeginListener] =
			react.useState(null);
		var [clusteringEndListener, setClusteringEndListener] =
			react.useState(null);
		var [mouseoutListener, setMouseoutListener] = react.useState(null);
		var [mouseoverListener, setMouseoverListener] = react.useState(null);
		react.useEffect(() => {
	...
	class ClustererComponent extends react.PureComponent {
		...
		componentDidMount() {
			if (this.context) {
				var markerClusterer = new Clusterer(
					this.context,
					[],
					this.props.options,
				);
	...
	function InfoBoxFunctional(_ref) {
		...
		var [domReadyClickListener, setDomReadyClickListener] =
			react.useState(null);
		var [contentChangedClickListener, setContentChangedClickListener] =
			react.useState(null);
		var [positionChangedClickListener, setPositionChangedClickListener] =
			react.useState(null);
		var [zIndexChangedClickListener, setZindexChangedClickListener] =
			react.useState(null);
	...
	class KDBush {
		...
		constructor(numItems) {
			...
			if (arrayTypeIndex < 0) {
				throw new Error(
					"Unexpected typed array class: ".concat(ArrayType, "."),
				);
			}
  ...
  ***************************************************************************** */
	...
	var extendBoundsToPaddedViewport = (bounds, projection, numPixels) => {
		var { northEast, southWest } = latLngBoundsToPixelBounds(
			bounds,
			projection,
		);
	...
	class DefaultRenderer {
		...
		render(_ref14, stats, map) {
			...
			if (MarkerUtils.isAdvancedMarkerAvailable(map)) {
				...
				var svgEl = parser.parseFromString(
					svg,
					"image/svg+xml",
				).documentElement;
	...
	function RectangleFunctional(_ref) {
		...
		var [clickListener, setClickListener] = react.useState(null);
		var [dragListener, setDragListener] = react.useState(null);
		var [boundsChangedListener, setBoundsChangedListener] =
			react.useState(null);
		// Order does matter
		react.useEffect(() => {
			if (instance !== null) {
	...
	function CircleFunctional(_ref) {
		...
		var [centerChangedListener, setCenterChangedListener] =
			react.useState(null);
		var [radiusChangedListener, setRadiusChangedListener] =
			react.useState(null);
		// Order does matter
		react.useEffect(() => {
			if (instance !== null) {
	...
	function DataFunctional(_ref) {
		...
		var [removeFeatureListener, setRemoveFeatureListener] =
			react.useState(null);
		var [removePropertyListener, setRemovePropertyListener] =
			react.useState(null);
	...
	function createOverlay(
		...
		class Overlay extends google.maps.OverlayView {
			...
			onAdd() {
				var _this$getPanes;
				var pane =
					(_this$getPanes = this.getPanes()) === null ||
					_this$getPanes === void 0
						? void 0
	...
	function convertToLatLngBoundsString(latLngBoundsLike) {
		...
		var latLngBounds =
			latLngBoundsLike instanceof google.maps.LatLngBounds
				...
				: new google.maps.LatLngBounds(
						new google.maps.LatLng(
							latLngBoundsLike.south,
							latLngBoundsLike.east,
						),
						new google.maps.LatLng(
							latLngBoundsLike.north,
							latLngBoundsLike.west,
						),
					);
		return latLngBounds + "";
	}
