...
const LeadContactStep: FC<LeadContactStepProps> = ({
	...
	<div className="space-y-4">
		<div>
			<label className="mb-1 block text-sm" htmlFor="phoneNumber">
				Phone Number
			</label>
			<Input
				id="phoneNumber"
		...
		<div className="space-y-2">
			...
			{showBestTime && (
				<div>
					<label className="mb-1 block text-sm" htmlFor="bestTime">
			...
			{showLeadNotes && (
				<div>
					<label htmlFor="leadNotes" className="mb-1 block text-sm">
						Lead Notes
					</label>
					<textarea
						id="leadNotes"
