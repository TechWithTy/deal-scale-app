...
const ListTraceFlow: React.FC<ListTraceFlowProps> = ({
	...
	const canNextUpload =
		!!uploadedFile && parsedHeaders.length > 0 && listName.trim().length > 0;
			...
			{step === 0 && (
				<div className="space-y-4">
					...
					<div className="space-y-3">
						...
						<label className="block text-sm font-medium" htmlFor="listName">
							List Name
						</label>
						{listMode === "create" ? (
							<input
			...
			{step === 3 && (
				<div className="space-y-4">
					...
					<ul className="text-sm space-y-1">
						...
						<li>
							<strong>File:</strong> {uploadedFile?.name ?? "(none)"}
						</li>
						<li>
							<strong>Columns:</strong> {selectedHeaders.join(", ") || "(none)"}
						</li>
						<li>
							<strong>Enrichment:</strong>{" "}
							{selectedEnrichmentOptions.join(", ") || "(none)"}
						</li>
					</ul>
					<div className="flex justify-between">
