	...
	return (
		<>
			...
			<DataTableRowModalCarousel
				...
				description={(row) =>
					`Status: ${row.original.status} • Priority: ${row.original.priority}`
				}
				render={(row) => (
					<div className="grid gap-2">
						<div className="text-sm">
							<strong>Code:</strong> {row.original.code}
						</div>
						<div className="text-sm">
						...
						<div className="text-sm">
							<strong>Priority:</strong> {row.original.priority}
						</div>
						<div className="text-sm">
							<strong>Estimated Hours:</strong> {row.original.estimatedHours}
						</div>
