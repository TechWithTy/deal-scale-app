...
const _prefixSelector = /*#__PURE__*/ _interop_require_default(
	require("../util/prefixSelector"),
);
const _isPlainObject = /*#__PURE__*/ _interop_require_default(
	require("../util/isPlainObject"),
);
const _escapeClassName = /*#__PURE__*/ _interop_require_default(
	require("../util/escapeClassName"),
);
const _nameClass = /*#__PURE__*/ _interop_require_wildcard(
	require("../util/nameClass"),
);
const _pluginUtils = require("../util/pluginUtils");
const _corePlugins = require("../corePlugins");
const _sharedState = /*#__PURE__*/ _interop_require_wildcard(
	require("./sharedState"),
);
const _toPath = require("../util/toPath");
const _log = /*#__PURE__*/ _interop_require_default(require("../util/log"));
const _negateValue = /*#__PURE__*/ _interop_require_default(
	require("../util/negateValue"),
);
const _isSyntacticallyValidPropertyValue =
	/*#__PURE__*/ _interop_require_default(
						...
						params:
							(_params_trim =
								params === null || params === void 0
									? void 0
									: params.trim()) !== null && _params_trim !== void 0
								? _params_trim
								: "",
					}),
				);
 ...
 */ function buildPluginApi(
	...
	function getConfigValue(path, defaultValue) {
		return path
			? (0, _dlv.default)(tailwindConfig, path, defaultValue)
			: tailwindConfig;
	}
		...
		matchUtilities: function (utilities, options) {
			...
			for (let identifier in utilities) {
				...
				function wrapped(modifier, { isOnlyPlugin }) {
					let [value, coercedType, utilityModifier] = (0,
					_pluginUtils.coerceValue)(
						options.types,
						modifier,
						options,
						tailwindConfig,
			...
			variantFunctions = [].concat(variantFunctions).map((variantFunction) => {
				if (typeof variantFunction !== "string") {
					...
					return (api = {}) => {
						...
						return (
							result && typeof result === "string" && parseVariant(result)(api)
						);
					};
				}
					...
					({ args, container }) => {
						return variantFn(
							...
							modifiersEnabled
								? {
										modifier:
											args === null || args === void 0 ? void 0 : args.modifier,
										container,
									}
								: {
										container,
...
function trackModified(files, fileModifiedMap) {
	...
	for (let file of files) {
		...
		let pathname = parsed.hash
			? parsed.href.replace(parsed.hash, "")
			: parsed.href;
...
function registerPlugins(plugins, context) {
	...
	let safelist = (
		(_context_tailwindConfig_safelist = context.tailwindConfig.safelist) !==
			null && _context_tailwindConfig_safelist !== void 0
							...
							let values = Object.keys(
								(_options_values =
									options === null || options === void 0
										? void 0
										: options.values) !== null && _options_values !== void 0
									? _options_values
									: {},
							);
							let classes = values.map((value) =>
								(0, _nameClass.formatClass)(utilName, value),
							);
							if (
								options === null || options === void 0
									? void 0
				...
				for (let util of utils) {
					for (let { pattern, variants = [] } of checks) {
						...
						patternMatchingCount.set(
							pattern,
							patternMatchingCount.get(pattern) + 1,
						);
						context.changedContent.push({
							content: util,
							extension: "html",
	...
	let darkClassName =
		(_concat_ = [].concat(
			(_context_tailwindConfig_darkMode = context.tailwindConfig.darkMode) !==
				null && _context_tailwindConfig_darkMode !== void 0
	...
	context.getClassOrder = function getClassOrder(classes) {
		...
		let sortedClassNames = new Map(
			sorted.map((className) => [className, null]),
		);
		// Sort all classes in order
		// Non-tailwind classes won't be generated and will be left as `null`
		let rules = (0, _generateRules.generateRules)(
			new Set(sorted),
			context,
			true,
		);
			...
			if (Array.isArray(util)) {
				...
				let modifiers = Object.keys(
					(_utilOptions_modifiers =
						utilOptions === null || utilOptions === void 0
							? void 0
							: utilOptions.modifiers) !== null &&
						_utilOptions_modifiers !== void 0
						? _utilOptions_modifiers
						: {},
				);
				if (
					utilOptions === null || utilOptions === void 0
						? void 0
						: (_utilOptions_types = utilOptions.types) === null ||
								_utilOptions_types === void 0
							? void 0
					...
					modifiers.push(
						...Object.keys(
							(_context_tailwindConfig_theme_opacity =
								context.tailwindConfig.theme.opacity) !== null &&
								_context_tailwindConfig_theme_opacity !== void 0
								? _context_tailwindConfig_theme_opacity
								: {},
						),
					);
				...
				for (let [key, value] of Object.entries(
					(_utilOptions_values =
						utilOptions === null || utilOptions === void 0
							? void 0
							: utilOptions.values) !== null && _utilOptions_values !== void 0
						? _utilOptions_values
						: {},
				)) {
	...
	context.getVariants = function getVariants() {
		...
		for (let [name, options] of context.variantOptions.entries()) {
			...
			result.push({
				...
				values: Object.keys(
					(_options_values = options.values) !== null &&
				...
				selectors({ modifier, value } = {}) {
							...
							args: {
								...
								value:
									(_options_values_value =
										...
										_options_values === void 0
											? void 0
											: _options_values[value]) !== null &&
									_options_values_value !== void 0
										? _options_values_value
										: value,
							},
								...
								container.each((rule) => {
									...
									rule.selectors = rule.selectors.map((selector) => {
										return modifierFunction({
											get className() {
												return (0, _generateRules.getClassNameFromSelector)(
													selector,
												);
											},
											selector,
					...
					if (before !== after) {
						...
						container.walkRules((rule) => {
							...
							// classes, pseudos, ids, ...
							let rebuiltBase = (0, _postcssselectorparser.default)(
								(selectors) => {
									selectors.walkClasses((classNode) => {
					...
					let isArbitraryVariant = !(
						value in
						((_options_values1 = options.values) !== null &&
						_options_values1 !== void 0
							? _options_values1
							: {})
					);
					var _options_INTERNAL_FEATURES;
					let internalFeatures =
						(_options_INTERNAL_FEATURES = options[INTERNAL_FEATURES]) !==
							null && _options_INTERNAL_FEATURES !== void 0
					...
					if (manualFormatStrings.length > 0) {
						result.push(
							(0, _formatVariantSelector.formatVariantSelector)(
								manualFormatStrings,
								opts,
							)
								.toString()
...
function getContext(
	...
	let cssDidChange = (0, _cacheInvalidation.hasContentChanged)(
		sourcePath,
		root,
	);
