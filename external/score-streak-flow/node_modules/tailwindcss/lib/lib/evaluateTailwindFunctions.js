...
const _didyoumean = /*#__PURE__*/ _interop_require_default(
	require("didyoumean"),
);
...
function validatePath(config, path, defaultValue, themeOpts = {}) {
	...
	if (value === undefined) {
		...
		if (isObject(parentValue)) {
			...
			const suggestion = (0, _didyoumean.default)(
 ...
 */ function resolvePath(config, path, defaultValue) {
	const results = Array.from(toPaths(path)).map(([path, alpha]) => {
		return Object.assign(
			validatePath(config, path, defaultValue, {
				opacityValue: alpha,
			}),
			{
				resolvedPath: path,
	...
	var _results_find;
	return (_results_find = results.find((result) => result.isValid)) !== null &&
		_results_find !== void 0
		? _results_find
		: results[0];
}
function _default(context) {
	...
	let functions = {
		theme: (node, path, ...defaultValue) => {
				...
				let candidate =
					(_parentNode_raws_tailwind =
						parentNode === null || parentNode === void 0
							? void 0
							: parentNode.raws.tailwind) === null ||
					_parentNode_raws_tailwind === void 0
						? void 0
						: _parentNode_raws_tailwind.candidate;
			...
			let isColorFunction =
				maybeColor !== undefined && typeof maybeColor === "function";
			if (alpha !== undefined || isColorFunction) {
				if (alpha === undefined) {
					alpha = 1.0;
				}
				value = (0, _withAlphaVariable.withAlphaValue)(
					maybeColor,
					alpha,
					maybeColor,
				);
