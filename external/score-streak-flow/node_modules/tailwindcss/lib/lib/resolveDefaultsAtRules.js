...
let elementSelectorParser = (0, _postcssselectorparser.default)((selectors) => {
	return selectors.map((s) => {
		let nodes = s
			.split((n) => n.type === "combinator" && n.value === " ")
			.pop();
	...
	return (root) => {
		...
		if (
			...
			for (let universal of universals) {
				...
				let rules =
					(_variableNodeMap_get = variableNodeMap.get(universal.params)) !==
						null && _variableNodeMap_get !== void 0
				...
				for (let rule of rules) {
					for (let selector of extractElementSelector(rule.selector)) {
						...
						let selectors =
							(_selectorGroups_get = selectorGroups.get(selectorGroupName)) !==
								null && _selectorGroups_get !== void 0
								? _selectorGroups_get
								: new Set();
