...
function findAtConfigPath(root, result) {
	...
	root.walkAtRules("config", (rule) => {
		...
		relativeTo =
			(_ref =
				(_rule_source_input_file =
					(_rule_source = rule.source) === null || _rule_source === void 0
						? void 0
						: _rule_source.input.file) !== null &&
				_rule_source_input_file !== void 0
					? _rule_source_input_file
					: result.opts.from) !== null && _ref !== void 0
				? _ref
				: null;
		if (relativeTo === null) {
			throw rule.error(
		...
		configPath = _path.default.resolve(
			_path.default.dirname(relativeTo),
			inputPath,
		);
