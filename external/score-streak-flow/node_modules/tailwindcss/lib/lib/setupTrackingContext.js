...
const _quicklru = /*#__PURE__*/ _interop_require_default(
	require("@alloc/quick-lru"),
);
const _hashConfig = /*#__PURE__*/ _interop_require_default(
	require("../util/hashConfig"),
);
const _resolveconfig = /*#__PURE__*/ _interop_require_default(
	require("../public/resolve-config"),
);
const _resolveConfigPath = /*#__PURE__*/ _interop_require_default(
	require("../util/resolveConfigPath"),
);
const _setupContextUtils = require("./setupContextUtils");
const _parseDependency = /*#__PURE__*/ _interop_require_default(
	require("../util/parseDependency"),
);
...
function getCandidateFiles(context, tailwindConfig) {
	...
	let candidateFiles = (0, _content.parseCandidateFiles)(
		context,
		tailwindConfig,
	);
...
function getTailwindConfig(configOrPath) {
	...
	if (userConfigPath !== null) {
		...
		for (let file of newDeps) {
			...
			if (
				!prevModified ||
				!prevModified.has(file) ||
				time > prevModified.get(file)
			) {
				modified = true;
			}
		}
	...
	let newConfig = (0, _resolveconfig.default)(
		(_ref =
			(_configOrPath_config =
				configOrPath === null || configOrPath === void 0
					? void 0
					: configOrPath.config) !== null && _configOrPath_config !== void 0
				? _configOrPath_config
	...
	return ({ tailwindDirectives, registerDependency }) => {
		return (root, result) => {
			...
			if (tailwindDirectives.size > 0) {
				...
				_content.resolvedChangedContent)(
					context,
					candidateFiles,
					fileModifiedMap,
				);
