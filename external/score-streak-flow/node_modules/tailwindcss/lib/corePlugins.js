...
const _buildMediaQuery = /*#__PURE__*/ _interop_require_default(
...
const _toColorValue = /*#__PURE__*/ _interop_require_default(
	require("./util/toColorValue"),
);
...
let variantPlugins = {
	...
	screenVariants: ({ theme, addVariant, matchVariant }) => {
		var _theme;
		let rawScreens =
			(_theme = theme("screens")) !== null && _theme !== void 0 ? _theme : {};
		...
		/** @param {string} value */ function units(value) {
			...
			return (_value_match_ =
				(_value_match = value.match(/(\D+)$/)) === null ||
				_value_match === void 0
					? void 0
		 ...
		 */ function buildScreenValues(type) {
			return Object.fromEntries(
				screens
					.filter(
						(screen) => (0, _normalizeScreens.isScreenSortable)(screen).result,
					)
					.map((screen) => {
		 ...
		 */ function buildSort(type) {
			return (a, z) =>
				(0, _normalizeScreens.compareScreens)(type, a.value, z.value);
		}
		...
		for (let screen of screens) {
			addVariant(
				screen.name,
				`@media ${(0, _buildMediaQuery.default)(screen)}`,
				{
					id,
					sort:
	...
	supportsVariants: ({ matchVariant, theme }) => {
		...
		matchVariant(
			...
			{
				values:
					(_theme = theme("supports")) !== null && _theme !== void 0
						? _theme
						: {},
			},
		);
	...
	hasVariants: ({ matchVariant, prefix }) => {
		matchVariant(
			"has",
			(value) => `&:has(${(0, _dataTypes.normalize)(value)})`,
			{
				values: {},
				[_setupContextUtils.INTERNAL_FEATURES]: {
					respectPrefix: false,
	...
	ariaVariants: ({ matchVariant, theme }) => {
		...
		matchVariant(
			...
			{
				values:
					(_theme = theme("aria")) !== null && _theme !== void 0 ? _theme : {},
			},
		);
		var _theme1;
		matchVariant(
			...
			{
				values:
					(_theme1 = theme("aria")) !== null && _theme1 !== void 0
						? _theme1
						: {},
			},
		);
		...
		matchVariant(
			...
			{
				values:
					(_theme2 = theme("aria")) !== null && _theme2 !== void 0
						? _theme2
						: {},
			},
		);
	...
	dataVariants: ({ matchVariant, theme }) => {
		...
		matchVariant(
			...
			{
				values:
					(_theme = theme("data")) !== null && _theme !== void 0 ? _theme : {},
			},
		);
		var _theme1;
		matchVariant(
			...
			{
				values:
					(_theme1 = theme("data")) !== null && _theme1 !== void 0
						? _theme1
						: {},
			},
		);
		...
		matchVariant(
			...
			{
				values:
					(_theme2 = theme("data")) !== null && _theme2 !== void 0
						? _theme2
						: {},
			},
		);
...
let corePlugins = {
	preflight: ({ addBase }) => {
		let preflightStyles = _postcss.default.parse(
			_fs.default.readFileSync(
				_path.join(__dirname, "./css/preflight.css"),
				"utf8",
			),
		);
		addBase([
	...
	gridRowEnd: (0, _createUtilityPlugin.default)(
		"gridRowEnd",
		[["row-end", ["gridRowEnd"]]],
		{
			supportsNegativeValues: true,
	...
	animation: ({ matchUtilities, theme, config }) => {
		let prefixName = (name) =>
			(0, _escapeClassName.default)(config("prefix") + name);
		var _theme;
		let keyframes = Object.fromEntries(
			Object.entries(
				(_theme = theme("keyframes")) !== null && _theme !== void 0
					? _theme
					: {},
			).map(([key, value]) => {
				return [
	...
	gridTemplateColumns: (0, _createUtilityPlugin.default)(
		"gridTemplateColumns",
		...
		matchUtilities(
			{
				divide: (value) => {
					...
					return {
						["& > :not([hidden]) ~ :not([hidden])"]: (0,
						_withAlphaVariable.default)({
							color: value,
	...
	strokeWidth: (0, _createUtilityPlugin.default)(
		"strokeWidth",
		[["stroke", ["stroke-width"]]],
		{
	...
	textIndent: (0, _createUtilityPlugin.default)(
		"textIndent",
		[["indent", ["text-indent"]]],
		{
			supportsNegativeValues: true,
		...
		matchUtilities(
			{
				font: (value) => {
					let [families, options = {}] =
						Array.isArray(value) && (0, _isPlainObject.default)(value[1])
							? value
							: [value];
		...
		matchUtilities(
			{
				text: (value, { modifier }) => {
					...
					let { lineHeight, letterSpacing, fontWeight } = (0,
					_isPlainObject.default)(options)
						? options
						: {
								lineHeight: options,
							};
	...
	fontWeight: (0, _createUtilityPlugin.default)(
		"fontWeight",
		[["font", ["fontWeight"]]],
		{
	...
	ringWidth: ({ matchUtilities, addDefaults, addUtilities, theme, config }) => {
		let ringColorDefault = (() => {
			...
			if (
				!((_theme = theme("ringColor")) === null || _theme === void 0
					? void 0
					: _theme.DEFAULT)
			) {
			...
			return (0, _withAlphaVariable.withAlphaValue)(
				(_theme1 = theme("ringColor")) === null || _theme1 === void 0
					? void 0
					: _theme1.DEFAULT,
				ringOpacityDefault,
		...
		matchUtilities(
			...
			},
			{
				values: Object.fromEntries(
					Object.entries(
						(0, _flattenColorPalette.default)(theme("ringColor")),
