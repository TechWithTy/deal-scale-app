...
const _postcssnested = /*#__PURE__*/ _interop_require_default(
...
function nesting(opts = _postcssnested.default) {
	return (root, result) => {
		...
		let plugin = (() => {
			...
			if (
				...
				(typeof opts === "object" &&
					(opts === null || opts === void 0
						? void 0
						: (_opts_hasOwnProperty = opts.hasOwnProperty) === null ||
								_opts_hasOwnProperty === void 0
							? void 0
							: _opts_hasOwnProperty.call(opts, "postcssPlugin")))
			) {
				return opts;
			}
			...
			throw new Error(
				"tailwindcss/nesting should be loaded with a nesting plugin.",
			);
		})();
