...
function createWatcher(args, { state, rebuild }) {
		...
		changedContent.push({
			...
			content:
				content !== null && content !== void 0
					? content
					: () => _fs.default.promises.readFile(file, "utf8"),
	...
	watcher.on("raw", (evt, filePath, meta) => {
		...
		filePath = watchedPath.endsWith(filePath)
			? watchedPath
			: _path.default.join(watchedPath, filePath);
		...
		async function enqueue() {
			try {
				...
				let content = await (0, _utils.readFileWithRetries)(
					_path.default.resolve(filePath),
				);
