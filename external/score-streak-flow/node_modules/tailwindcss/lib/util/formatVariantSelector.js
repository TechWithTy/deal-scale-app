...
const _unesc = /*#__PURE__*/ _interop_require_default(
	require("postcss-selector-parser/dist/util/unesc"),
);
...
function formatVariantSelector(formats, { context, candidate }) {
	...
	let prefix =
		(_context_tailwindConfig_prefix =
			context === null || context === void 0
				? void 0
				: context.tailwindConfig.prefix) !== null &&
	...
	let parsedFormats = formats.map((format) => {
		...
		return {
			...format,
			ast: format.respectPrefix
				? (0, _prefixSelector.default)(prefix, ast)
				: ast,
		};
	});
...
function finalizeSelector(current, formats, { context, candidate, base }) {
	...
	base =
		base !== null && base !== void 0
			? base
			: (0, _splitAtTopLevelOnly.splitAtTopLevelOnly)(
					candidate,
					separator,
				).pop();
	...
	selector.walkClasses((node) => {
		if (node.raws && node.value.includes(base)) {
			node.raws.value = (0, _escapeClassName.default)(
				(0, _unesc.default)(node.raws.value),
			);
		}
	});
