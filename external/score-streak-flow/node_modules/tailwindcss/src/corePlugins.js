...
export let variantPlugins = {
	...
	ariaVariants: ({ matchVariant, theme }) => {
		matchVariant(
			"aria",
			(value) => `&[aria-${normalizeAttributeSelectors(normalize(value))}]`,
			{
				values: theme("aria") ?? {},
			},
		);
	...
	dataVariants: ({ matchVariant, theme }) => {
		matchVariant(
			"data",
			(value) => `&[data-${normalizeAttributeSelectors(normalize(value))}]`,
			{
				values: theme("data") ?? {},
			},
		);
...
export let corePlugins = {
	...
	gridColumnStart: createUtilityPlugin(
		"gridColumnStart",
	...
	gridColumnEnd: createUtilityPlugin(
		"gridColumnEnd",
	...
	gridRowStart: createUtilityPlugin(
		"gridRowStart",
