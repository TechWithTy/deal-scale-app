...
export declare function getDefaultConfig(): {
	...
	readonly theme: {
		...
		readonly borderSpacing: readonly [
			typeof isArbitraryValue,
			import("./types").ThemeGetter,
		];
		...
		readonly gradientColorStopPositions: readonly [
			typeof isPercent,
			typeof isArbitraryLength,
		];
