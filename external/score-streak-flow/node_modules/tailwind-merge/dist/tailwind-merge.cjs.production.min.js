		...
		if ("string" != typeof r) {
			if ("function" == typeof r)
				return r.isThemeGetter
					? void a(r(t), e, o, t)
					: void e.validators.push({ validator: r, classGroupId: o });
...
function p() {
	...
	var i,
		...
		p = function (r) {
			...
			return (
				(i = (function (r) {
					return { cache: s(r.cacheSize), splitModifiers: d(r), ...t(r) };
				})(n)),
				(a = i.cache.get),
				(l = i.cache.set),
				(p = f),
			...
			return r
				...
				.map(function (r) {
					var e = o(r),
						...
						d = Boolean(l);
					if (!s) {
						if (!l) return { isTailwindClass: !1, originalClassName: r };
						if (!(s = t(a)))
...
function q() {
	...
	return {
		...
		classGroups: {
			...
			"col-start-end": [{ col: ["auto", { span: ["full", P] }, I] }],
			"col-start": [{ "col-start": B() }],
			"col-end": [{ "col-end": B() }],
			"grid-rows": [{ "grid-rows": [A] }],
			"row-start-end": [{ row: ["auto", { span: [P] }, I] }],
			...
			w: [{ w: ["auto", "min", "max", "fit", I, e] }],
			"min-w": [{ "min-w": ["min", "max", "fit", I, x] }],
			"max-w": [
				{
					"max-w": [
						"0",
			...
			h: [{ h: [I, e, "auto", "min", "max", "fit"] }],
			"min-h": [{ "min-h": ["min", "max", "fit", I, x] }],
			"max-h": [{ "max-h": [I, e, "min", "max", "fit"] }],
			"font-size": [{ text: ["base", N, w] }],
			...
			"line-clamp": [{ "line-clamp": ["none", M, j] }],
			leading: [
				{
					leading: [
						"none",
			...
			"text-decoration-thickness": [{ decoration: ["auto", "from-font", x] }],
			"underline-offset": [{ "underline-offset": ["auto", I, x] }],
			...
			"outline-offset": [{ "outline-offset": [I, x] }],
			"outline-w": [{ outline: [x] }],
			...
			"ring-offset-w": [{ "ring-offset": [x] }],
			"ring-offset-color": [{ "ring-offset": [r] }],
			shadow: [{ shadow: ["", "inner", "none", N, S] }],
			...
			contrast: [{ contrast: [s] }],
			"drop-shadow": [{ "drop-shadow": ["", "none", N, I] }],
...
var U = p(q),
	V = r;
(exports.createTailwindMerge = p),
	(exports.extendTailwindMerge = function (r) {
		for (
			var e = arguments.length, o = new Array(e > 1 ? e - 1 : 0), t = 1;
			t < e;
			t++
		)
			o[t - 1] = arguments[t];
	...
	(exports.fromTheme = f),
	(exports.getDefaultConfig = q),
	(exports.join = V),
	(exports.mergeConfigs = L),
	(exports.twJoin = r),
	(exports.twMerge = U),
	(exports.validators = R);
