import {
	...
	f as P,
	g as E,
} from "./size-rollup-dom-animation-assets.js";
	...
	const i = (e) =>
		(function (t, e, n, s, i) {
			let r,
				...
				a = 0;
			do {
				(o = e + (n - e) / 2), (r = Y(o, s, i) - t), r > 0 ? (n = o) : (e = o);
			} while (Math.abs(r) > 1e-7 && ++a < 12);
			return o;
		})(e, 0, 1, t, n);
	return (t) => (0 === t || 1 === t ? t : Y(i(t), e, s));
}
const z = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
	H = (t) => (e) => 1 - t(1 - e),
	X = $(0.33, 1.53, 0.69, 0.99),
	_ = H(X),
	G = z(_),
	Z = (t) =>
		(t *= 2) < 1 ? 0.5 * _(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))),
	...
	ut = { value: null, addProjectionMetrics: null };
function lt(t, e) {
	let n = !1,
		s = !0;
	const i = { delta: 0, timestamp: 0, isProcessing: !1 },
							...
							(a = t),
								i
									...
									: ((i = !0),
										([n, s] = [s, n]),
										n.forEach(l),
										e && ut.value && ut.value.frameloop[e].push(u),
										(u = 0),
										n.clear(),
										(i = !1),
										r && ((r = !1), h.process(t)));
		...
		f = () => {
			const r = O.useManualTiming ? i.timestamp : performance.now();
			(n = !1),
				O.useManualTiming ||
	...
	return {
		schedule: at.reduce((e, r) => {
			const a = o[r];
			return (
				(e[r] = (e, r = !1, o = !1) => (
					n || ((n = !0), (s = !0), i.isProcessing || t(f)), a.schedule(e, r, o)
				)),
				e
			);
		}, {}),
		cancel: (t) => {
			for (let e = 0; e < at.length; e++) o[at[e]].cancel(t);
		},
		state: i,
		steps: o,
	};
...
const yt = {
		now: () => (
			void 0 === mt &&
				yt.set(
					dt.isProcessing || O.useManualTiming
						? dt.timestamp
						: performance.now(),
				),
			mt
...
const bt =
	...
	wt = (t, e) => (n) =>
		Boolean(
			("string" == typeof n && bt.test(n) && n.startsWith(t)) ||
				(e &&
					!(function (t) {
						return null == t;
					})(n) &&
	...
	St = { ...t, transform: (t) => Math.round(((t) => n(0, 255, t))(t)) },
	At = {
		test: wt("rgb", "red"),
		parse: Tt("red", "green", "blue"),
		transform: ({ red: t, green: n, blue: s, alpha: i = 1 }) =>
			"rgba(" +
			St.transform(t) +
			", " +
			St.transform(n) +
...
const Mt = {
	...
	Vt = {
		...
		transform: ({ hue: t, saturation: n, lightness: i, alpha: r = 1 }) =>
			"hsla(" +
			Math.round(t) +
			", " +
			s.transform(vt(n)) +
	...
	xt = {
		test: (t) => At.test(t) || Mt.test(t) || Vt.test(t),
		parse: (t) =>
			At.test(t) ? At.parse(t) : Vt.test(t) ? Vt.parse(t) : Mt.parse(t),
		transform: (t) =>
			"string" == typeof t
				? t
...
function Ft(t) {
	...
	const o = e
		.replace(
			...
			(t) => (
				xt.test(t)
					? (s.color.push(r), i.push(Pt), n.push(xt.parse(t)))
					: t.startsWith("var(")
						? (s.var.push(r), i.push("var"), n.push(t))
						: (s.number.push(r), i.push(kt), n.push(parseFloat(t))),
				++r,
				"${}"
			),
		)
...
function Dt(t) {
	...
	return (t) => {
		...
		for (let r = 0; r < s; r++)
			if (((i += e[r]), void 0 !== t[r])) {
				const e = n[r];
				i += e === kt ? vt(t[r]) : e === Pt ? xt.transform(t[r]) : t[r];
			}
		return i;
	};
}
const It = (t) =>
	"number" == typeof t ? 0 : xt.test(t) ? xt.getAnimatableNone(t) : t;
const Rt = {
	test: function (t) {
		return (
			isNaN(t) &&
			"string" == typeof t &&
			(t.match(gt)?.length || 0) + (t.match(Ct)?.length || 0) > 0
		);
	},
	parse: Ot,
...
const Bt = (t, e, n) => t + (e - t) * n,
	...
	jt = [Mt, At, Vt];
function Ut(t) {
	const e = ((n = t), jt.find((t) => t.test(n)));
	var n;
...
const qt = (t, e) => {
		...
		const i = { ...n };
		return (t) => (
			(i.red = Lt(n.red, s.red, t)),
			(i.green = Lt(n.green, s.green, t)),
			(i.blue = Lt(n.blue, s.blue, t)),
			(i.alpha = Bt(n.alpha, s.alpha, t)),
			At.transform(i)
		);
	},
...
function Ht(t, e) {
	const n = { ...t, ...e },
		s = {};
	for (const i in n)
		void 0 !== t[i] && void 0 !== e[i] && (s[i] = $t(t[i])(t[i], e[i]));
	return (t) => {
...
const Xt = (t, e) => {
	...
	return s.indexes.var.length === i.indexes.var.length &&
		...
		? (Wt.has(t) && !i.values.length) || (Wt.has(e) && !s.values.length)
			? (function (t, e) {
...
const Gt = (t) => {
		...
		return {
			...
			stop: () => ct(e),
			now: () => (dt.isProcessing ? dt.timestamp : yt.now()),
		};
	},
	Zt = (t, e, n = 10) => {
		let s = "";
...
function Qt(t) {
	let e = 0;
	let n = t.next(e);
	for (; !n.done && e < Jt; ) (e += 50), (n = t.next(e));
	return e >= Jt ? 1 / 0 : e;
}
function te(t, e, n) {
			...
			? ((r = (e) => {
				...
				(o = (e) => {
					const n = e * a * t,
						...
						u = Math.exp(-n),
						l = ve(Math.pow(e, 2), a);
					return ((-r(e) + me > 0 ? -1 : 1) * ((i - o) * u)) / l;
				}))
			: ((r = (e) => Math.exp(-e * t) * ((e - s) * t + 1) - 0.001),
				(o = (e) => Math.exp(-e * t) * (t * t * (s - e))));
	const u = (function (t, e, n) {
		let s = n;
		for (let n = 1; n < ye; n++) s -= t(s) / e(s);
		return s;
	})(r, o, 5 / t);
	if (((t = U(t)), isNaN(u)))
		return { stiffness: ee, damping: ne, duration: t };
	{
		const e = Math.pow(u, 2) * i;
...
function Te(t = ae, e = oe) {
	const s =
		"object" != typeof t
			? { visualDuration: t, keyframes: [0, 1], bounce: e }
			: t;
	let { restSpeed: i, restDelta: r } = s;
			...
			if (!we(t, be) && we(t, ge))
				if (t.visualDuration) {
					const s = t.visualDuration,
						i = (2 * Math.PI) / (1.2 * s),
						r = i * i,
						o = 2 * n(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(r);
					e = { ...e, mass: se, stiffness: r, damping: o };
				} else {
					const n = fe(t);
					(e = { ...e, ...n, mass: se }), (e.isResolvedFromDuration = !0);
				}
			return e;
		})({ ...s, velocity: -q(s.velocity || 0) }),
		f = p || 0,
		y = h / (2 * Math.sqrt(l * c)),
		v = a - o,
		g = q(Math.sqrt(l / c)),
	...
	let w;
	if (
		(i || (i = b ? ue.granular : ue.default),
		r || (r = b ? le.granular : le.default),
		y < 1)
	) {
		const t = ve(g, y);
		w = (e) => {
			const n = Math.exp(-y * g * e);
			return (
				a - n * (((f + y * g * v) / t) * Math.sin(t * e) + v * Math.cos(t * e))
			);
		};
	} else if (1 === y) w = (t) => a - Math.exp(-g * t) * (v + (f + g * v) * t);
	else {
		...
		w = (e) => {
			const n = Math.exp(-y * g * e),
				s = Math.min(t * e, 300);
			return (
				a - (n * ((f + y * g * v) * Math.sinh(s) + t * v * Math.cosh(s))) / t
			);
		};
	}
	const T = {
...
function Se({
	...
	const f = c + m,
		y = void 0 === o ? f : o(f);
	y !== f && (m = y - c);
	const v = (t) => -m * Math.exp(-t / s),
		g = (t) => y + v(t),
		b = (t) => {
			const e = v(t),
				n = g(t);
			(d.done = Math.abs(e) <= l), (d.value = d.done ? y : n);
		};
	let w, T;
	const S = (t) => {
		var e;
...
function Ae(t, e, { clamp: s = !0, ease: i, mixer: r } = {}) {
	const o = t.length;
	...
	const u = (function (t, e, n) {
		...
		h = (n) => {
			...
			const i = L(t[s], t[s + 1], n);
			return u[s](i);
		};
	return s ? (e) => h(n(t[0], t[o - 1], e)) : h;
}
function Me(t) {
	const e = [0];
	return (
...
function Ve({
	...
	const i = ((t) => Array.isArray(t) && "number" != typeof t[0])(s)
			? s.map(ot)
			: ot(s),
		r = { done: !1, value: e[0] },
		o = (function (t, e) {
		...
		a = Ae(o, e, {
			ease: Array.isArray(i)
				? i
				: ((u = e), (l = i), u.map(() => l || st).splice(0, u.length - 1)),
		});
	var u, l;
	return {
...
Te.applyToOptions = (t) => {
	...
	return (
		(t.ease = e.ease), (t.duration = U(e.duration)), (t.type = "keyframes"), t
	);
};
const xe = (t) => null !== t;
...
const ke = { decay: Se, inertia: Se, tween: Ve, keyframes: Ve, spring: Te };
function Pe(t) {
...
class Oe extends Ee {
	constructor(t) {
		super(),
			...
			(this.stop = () => {
				...
				t && t.updatedAt !== yt.now() && this.tick(yt.now()),
					(this.isStopped = !0),
	...
	initAnimation() {
		...
		a !== Ve &&
			"number" != typeof o[0] &&
			((this.mixKeyframes = B(Fe, _t(o[0], o[1]))), (o = [0, 100]));
	...
	tick(t, e = !1) {
		...
		const T = g ? { done: !1, value: h[0] } : w.next(b);
		r && (T.value = r(T.value));
		let { done: S } = T;
		g ||
			null === u ||
		...
		return (
			A && m !== Se && (T.value = Ce(h, this.options, y, this.speed)),
			f && f(T.value),
			A && this.finish(),
			T
		);
	...
	set speed(t) {
		...
		(this.playbackSpeed = t), e && (this.time = q(this.currentTime));
	}
	play() {
		if (this.isStopped) return;
		const { driver: t = Gt, startTime: e } = this.options;
...
const De = (t) => (180 * t) / Math.PI,
	...
	Be = (t) => Math.sqrt(t[4] * t[4] + t[5] * t[5]),
	Le = {
		x: 12,
		y: 13,
		z: 14,
		...
		scaleY: Be,
		scale: (t) => (Ke(t) + Be(t)) / 2,
		rotateX: (t) => Ne(De(Math.atan2(t[6], t[5]))),
		rotateY: (t) => Ne(De(Math.atan2(-t[2], t[0]))),
		rotateZ: Ie,
		rotate: Ie,
...
function Ze() {
	if (_e) {
		const t = Array.from(He).filter((t) => t.needsMeasurement),
	...
	(_e = !1), (Xe = !1), He.forEach((t) => t.complete(Ge)), He.clear();
}
function Je() {
	He.forEach((t) => {
...
class Qe {
	...
	scheduleResolve() {
		(this.state = "scheduled"),
			this.isAsync
				? (He.add(this),
					Xe || ((Xe = !0), ht.read(Je), ht.resolveKeyframes(Ze)))
	...
	cancel() {
		"scheduled" === this.state && (He.delete(this), (this.state = "pending"));
	}
	resume() {
		"pending" === this.state && this.scheduleResolve();
	}
}
const tn = R(() => void 0 !== window.ScrollTimeline),
	en = {};
function nn(t, e) {
	const n = R(t);
	return () => en[e] ?? n();
...
class hn extends Ee {
	constructor(t) {
		...
		(this.animation = un(e, n, s, u, i)),
			!1 === u.autoplay && this.animation.pause(),
			(this.animation.onfinish = () => {
				if (((this.finishedTime = this.time), !i)) {
					const t = Ce(s, this.options, o, this.speed);
	...
	set time(t) {
		(this.finishedTime = null), (this.animation.currentTime = U(t));
	}
	get speed() {
	...
	attachTimeline({ timeline: t, observe: e }) {
		return (
			...
			t && tn() ? ((this.animation.timeline = t), N) : e(this)
		);
	}
}
const cn = { anticipate: Z, backInOut: G, circInOut: tt };
function dn(t) {
...
class pn extends hn {
	...
	updateMotionValue(t) {
		...
		const o = new Oe({ ...r, autoplay: !1 }),
			a = U(this.finishedTime ?? this.time);
...
const yn = new Set(["opacity", "clipPath", "filter", "transform"]),
	vn = R(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
class gn extends Ee {
	constructor({
		autoplay: t = !0,
		delay: e = 0,
	...
	onKeyframesResolved(t, e, n, s) {
		...
		(this.resolvedAt = yt.now()),
			(function (t, e, n, s) {
				...
				((!O.instantAnimations && a) || l?.(Ce(t, n, e)),
				(t[0] = t[t.length - 1]),
				fn(n),
				(n.repeat = 0));
		const h = {
			...
			c =
				...
				(function (t) {
					...
					? new pn({ ...h, element: h.motionValue.owner.current })
					: new Oe(h);
		c.finished.then(() => this.notifyFinished()).catch(N),
	...
	get animation() {
		return (
			this._animation ||
				(this.keyframeResolver?.resume(), (Ge = !0), Je(), Ze(), (Ge = !1)),
			this._animation
		);
	}
	get duration() {
...
function wn(t, e, n = 1) {
	...
	return i(r) ? wn(r, e, n + 1) : r;
}
function Tn(t, e) {
	return t?.[e] ?? t?.default ?? t;
}
const Sn = new Set(["width", "height", "top", "left", "right", "bottom", ...o]),
	An = (t) => (e) => e.test(t),
	Mn = [t, r, s, a, u, l, { test: (t) => "auto" === t, parse: (t) => t }],
	Vn = (t) => Mn.find(An(t));
function xn(t) {
	return "number" == typeof t
		? 0 === t
		: null === t || "none" === t || "0" === t || I(t);
}
const Cn = new Set(["brightness", "contrast", "saturate", "opacity"]);
function kn(t) {
...
function Dn(t, e) {
	let n = On(t);
	return (
		n !== En && (n = Rt), n.getAnimatableNone ? n.getAnimatableNone(e) : void 0
	);
}
...
class Rn extends Qe {
	...
	readKeyframes() {
		...
		for (let n = 0; n < t.length; n++) {
			let s = t[n];
			if ("string" == typeof s && ((s = s.trim()), i(s))) {
				const i = wn(s, e.current);
				void 0 !== i && (t[n] = i),
					n === t.length - 1 && (this.finalKeyframe = s);
			}
		}
		if ((this.resolveNoneKeyframes(), !Sn.has(n) || 2 !== t.length)) return;
		const [s, r] = t,
			o = Vn(s),
			a = Vn(r);
		if (o !== a)
	...
	resolveNoneKeyframes() {
		const { unresolvedKeyframes: t, name: e } = this,
			n = [];
		for (let e = 0; e < t.length; e++) (null === t[e] || xn(t[e])) && n.push(e);
		n.length &&
			(function (t, e, n) {
				let s,
					i = 0;
				...
				if (s && n) for (const i of e) t[i] = Dn(n, s);
			})(t, n, e);
	}
	measureInitialState() {
	...
	measureEndState() {
		...
		const i = n.length - 1,
			r = n[i];
		(n[i] = ze[e](t.measureViewportBox(), window.getComputedStyle(t.current))),
...
class Nn {
	...
	on(t, e) {
		this.events[t] || (this.events[t] = new j());
	...
	getVelocity() {
		...
		return W(parseFloat(this.current) - parseFloat(this.prevFrameValue), e);
	}
	start(t) {
		return (
			this.stop(),
...
const { schedule: Bn, cancel: Ln } = lt(queueMicrotask, !1),
	jn = !1;
function Un() {
	return jn;
}
			...
			const r = e(s, t),
				o = (t, e) => {
					window.removeEventListener("pointerup", a),
						...
						zn.has(s) && zn.delete(s),
						_n(t) && "function" == typeof r && r(t, { success: e });
				},
				a = (t) => {
					o(
						t,
		...
		s.forEach((t) => {
			...
			(n.useGlobalTarget ? window : t).addEventListener("pointerdown", o, i),
				"object" == typeof (s = e = t) &&
						...
						((t, e) => {
							...
							const s = Hn(() => {
								...
								n.addEventListener("keyup", t, e),
									n.addEventListener("blur", () => Xn(n, "cancel"), e);
							});
					...
					(function (t) {
						return $n.has(t.tagName) || -1 !== t.tabIndex;
					})(t) ||
...
function Jn(t, e, n) {
	const s = t.getProps();
	return c(s, e, void 0 !== n ? n : s.custom, t);
}
...
function ns(t, e) {
	...
	if (((s = n), Boolean(d(s) && s.add))) return n.add(e);
	if (!n && O.WillChange) {
...
const is = (t) => null !== t;
const rs = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
...
const ls =
	...
	(o) => {
		...
		})(a) || Object.assign(h, us(t, h)),
			h.duration && (h.duration = U(h.duration)),
			h.repeatDelay && (h.repeatDelay = U(h.repeatDelay)),
			void 0 !== h.from && (h.keyframes[0] = h.from);
		let c = !1;
		if (
			((!1 === h.type || (0 === h.duration && !h.repeatDelay)) &&
				(fn(h), 0 === h.delay && (c = !0)),
			(O.instantAnimations || O.skipAnimations) &&
				((c = !0), fn(h), (h.delay = 0)),
		...
		return a.isSync ? new Oe(h) : new gn(h);
	};
function hs({ protectedKeys: t, needsAnimating: e }, n) {
...
function cs(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
	...
	for (const e in a) {
		const s = t.getValue(e, t.latestValues[e] ?? null),
			i = a[e];
		if (void 0 === i || (l && hs(l, e))) continue;
		const o = { delay: n, ...Tn(r || {}, e) },
			h = s.get();
		if (
			void 0 !== h &&
			!s.isAnimating &&
		...
		ns(t, e),
			s.start(
				ls(e, s, i, t.shouldReduceMotion && Sn.has(e) ? { type: !1 } : o, t, c),
			);
		const d = s.animation;
		d && u.push(d);
	}
				...
				ht.update(() => {
					o &&
						(function (t, e) {
							...
							r = { ...r, ...s };
							for (const e in r) ts(t, e, es(r[e]));
						})(t, o);
				});
			}),
		u
...
function ds(t, e, n, s = 0, i = 1) {
	const r = Array.from(t)
			.sort((t, e) => t.sortNodePosition(e))
			.indexOf(e),
		o = t.size,
		a = (o - 1) * s;
	return "function" == typeof n ? n(r, o) : 1 === i ? r * s : a - r * s;
}
function ps(t, e, n = {}) {
	const s = Jn(t, e, "exit" === n.type ? t.presenceContext?.custom : void 0);
	let { transition: i = t.getDefaultTransition() || {} } = s || {};
	n.transitionOverride && (i = n.transitionOverride);
	const r = s ? () => Promise.all(cs(t, s, n)) : () => Promise.resolve(),
		o =
			t.variantChildren && t.variantChildren.size
				? (s = 0) => {
						...
						return (function (t, e, n = 0, s = 0, i = 0, r = 1, o) {
							const a = [];
			...
			e.map(({ animation: e, options: n }) =>
				(function (t, e, n = {}) {
					...
					if ((t.notify("AnimationStart", e), Array.isArray(e))) {
						const i = e.map((e) => ps(t, e, n));
						s = Promise.all(i);
					} else if ("string" == typeof e) s = ps(t, e, n);
					else {
						const i = "function" == typeof e ? Jn(t, e, n.custom) : e;
...
function ws(t) {
	let e = bs(t),
		...
		s = !0;
	const i = (e) => (n, s) => {
		const i = Jn(t, s, "exit" === e ? t.presenceContext?.custom : void 0);
		if (i) {
	...
	function r(r) {
		...
		for (let e = 0; e < gs; e++) {
			...
			if (
				...
				continue;
			const w = Ts(p.prevProp, m);
			let T = w || (d === r && p.isActive && !b && y) || (e > c && y),
				S = !1;
					...
					...A.map((e) => {
						...
						if (
							...
							if (s.enteringChildren && i) {
								...
								n.delay = ds(s.enteringChildren, t, e);
							}
						}
		...
		if (l.size) {
			...
			if ("boolean" != typeof o.initial) {
				const n = Jn(t, Array.isArray(o.initial) ? o.initial[0] : o.initial);
				n && n.transition && (e.transition = n.transition);
			}
			l.forEach((n) => {
				const s = t.getBaseTarget(n),
					i = t.getValue(n);
				i && (i.liveStyle = !0), (e[n] = s ?? null);
			}),
				u.push({ animation: e });
		}
...
function Ts(t, e) {
	return "string" == typeof e ? e !== t : !!Array.isArray(e) && !ms(e, t);
}
function Ss(t = !1) {
	return {
		isActive: t,
...
function ks(t, e, n) {
	...
	const i = s["onHover" + n];
	i && ht.postRender(() => i(e, Cs(e)));
}
function Ps(t, e, n, s = { passive: !0 }) {
...
function Es(t, e, n) {
	...
	const i = s["onTap" + ("End" === n ? "" : n)];
	i && ht.postRender(() => i(e, Cs(e)));
}
const Fs = new WeakMap(),
	Os = new WeakMap(),
	Ds = (t) => {
		const e = Fs.get(t.target);
		e && e(t);
	},
	Is = (t) => {
		t.forEach(Ds);
...
function Rs(t, e, n) {
	const s = (function ({ root: t, ...e }) {
		...
		const s = Os.get(n),
			i = JSON.stringify(e);
		return (
			s[i] || (s[i] = new IntersectionObserver(Is, { root: t, ...e })), s[i]
		);
	})(e);
	return (
		Fs.set(t, n),
			...
			startObserver() {
				...
				const { viewport: t = {} } = this.node.getProps(),
					...
					r = {
						...
						rootMargin: n,
						threshold: "number" == typeof s ? s : Ns[s],
					};
				return Rs(this.node.current, r, (t) => {
			...
			mount() {
				...
				t &&
					(this.unmount = Gn(
						t,
						(t, e) => (
							Es(this.node, e, "Start"),
							(t, { success: e }) => Es(this.node, t, e ? "End" : "Cancel")
						),
					...
					(this.unmount = (function (t, e, n = {}) {
						const [s, i, r] = qn(t, n),
							o = (t) => {
								...
								const r = (t) => {
									Wn(t) && (s(t), n.removeEventListener("pointerleave", r));
								};
						...
						t,
						(t, e) => (
							ks(this.node, e, "Start"), (t) => ks(this.node, t, "End")
						),
					));
			}
			unmount() {}
...
const Bs = () => ({ x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }),
	Ls = { current: null },
	js = { current: !1 };
...
class Ws {
	...
	constructor(
		...
		const { latestValues: a, renderState: u } = r;
		(this.latestValues = a),
			(this.baseTarget = { ...a }),
					...
					if (((js.current = !0), b))
						if (window.matchMedia) {
							const t = window.matchMedia("(prefers-reduced-motion)"),
								e = () => (Ls.current = t.matches);
							t.addEventListener("change", e), e();
						} else Ls.current = !1;
				})(),
			(this.shouldReduceMotion =
				"never" !== this.reducedMotionConfig &&
				("always" === this.reducedMotionConfig || Ls.current)),
	...
	update(t, e) {
		...
		(this.prevMotionValues = (function (t, e, n) {
			for (const s in e) {
				const i = e[s],
					r = n[s];
				if (d(i)) t.addValue(s, i);
				else if (d(r)) t.addValue(s, Kn(i, { owner: t }));
				else if (r !== i)
					if (t.hasValue(s)) {
						...
						t.addValue(s, Kn(void 0 !== e ? e : i, { owner: t }));
					}
			}
	...
	getValue(t, e) {
		...
		return (
			void 0 === n &&
				void 0 !== e &&
				((n = Kn(null === e ? void 0 : e, { owner: this })),
				this.addValue(t, n)),
			n
		);
	}
	readValue(t, e) {
		...
		return (
			null != n &&
				("string" == typeof n && (D(n) || I(n))
					? (n = parseFloat(n))
					: ((s = n), !Zn.find(An(s)) && Rt.test(e) && (n = Dn(t, e))),
	...
	getBaseTarget(t) {
		...
		if ("string" == typeof e || "object" == typeof e) {
			const s = c(this.props, e, this.presenceContext?.custom);
			s && (n = s[t]);
		}
...
class Ys extends Ws {
	constructor() {
		super(...arguments), (this.KeyframeResolver = Rn);
	}
	...
	readValueFromInstance(t, e) {
					...
					})(t, e);
		{
			const s = ((n = t), window.getComputedStyle(n)),
				i = (A(e) ? s.getPropertyValue(e) : s[e]) || 0;
...
class Xs extends Ys {
	constructor() {
		super(...arguments),
			(this.type = "svg"),
			(this.isSVGTag = !1),
			(this.measureInstanceViewportBox = Bs);
	}
	getBaseTargetFromProps(t, e) {
		return t[e];
	}
	readValueFromInstance(t, e) {
		...
		return (e = Hs.has(e) ? e : x(e)), t.getAttribute(e);
	}
	scrapeMotionValuesFromProps(t, e, n) {
		return C(t, e, n);
	}
	build(t, e, n) {
		k(t, e, this.isSVGTag, n.transformTemplate, n.style);
	}
	renderInstance(t, e, n, s) {
		!(function (t, e, n, s) {
			$s(t, e, void 0, s);
			for (const n in e.attrs) t.setAttribute(Hs.has(n) ? n : x(n), e.attrs[n]);
		})(t, e, 0, s);
	}
	mount(t) {
		(this.isSVGTag = P(t.tagName)), super.mount(t);
	}
}
const _s = {
	renderer: (t, e) =>
		E(t) ? new Xs(e) : new zs(e, { allowProjection: t !== F }),
	...xs,
	...Ks,
};
export { _s as domAnimation };
