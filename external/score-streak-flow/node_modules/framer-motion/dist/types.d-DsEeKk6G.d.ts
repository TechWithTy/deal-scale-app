...
type UseVisualState<Instance, RenderState> = (
	props: MotionProps,
	isStatic: boolean,
...
export {
	...
	type CreateVisualElement as C,
	type DOMMotionComponents as D,
	type ForwardRefComponent as F,
	type HTMLElements as H,
	type IProjectionNode as I,
	type MotionProps as M,
	PresenceContext as P,
	type ResolvedValues as R,
	type SVGMotionComponents as S,
	VisualElement as V,
	MotionConfigContext as a,
	type HTMLMotionProps as b,
	type HTMLMotionComponents as c,
	type VisualElementAnimationOptions as d,
	type HTMLRenderState as e,
	type ScrapeMotionValuesFromProps as f,
	type VisualState as g,
	SwitchLayoutGroupContext as h,
	type MotionStyle as i,
	type MotionTransform as j,
	type VariantLabels as k,
	type SVGAttributesAsMotionValues as l,
	makeUseVisualState as m,
	type SVGMotionProps as n,
