	...
	const i = (e) =>
		(function (t, e, n, s, i) {
			let r,
				...
				o = 0;
			do {
				(a = e + (n - e) / 2), (r = m(a, s, i) - t), r > 0 ? (n = a) : (e = a);
			} while (Math.abs(r) > 1e-7 && ++o < 12);
			return a;
		})(e, 0, 1, t, n);
	return (t) => (0 === t || 1 === t ? t : m(i(t), e, s));
}
const y = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
	g = (t) => (e) => 1 - t(1 - e),
	v = f(0.33, 1.53, 0.69, 0.99),
	b = g(v),
	w = y(b),
	T = (t) =>
	...
	x = f(0, 0, 0.58, 1),
	k = f(0.42, 0, 0.58, 1),
	C = (t) => Array.isArray(t) && "number" != typeof t[0];
function F(t, e) {
	return C(t)
		? t[
				((t, e, n) => {
...
function R(t, e) {
	...
	const r = { delta: 0, timestamp: 0, isProcessing: !1 },
							...
							(o = t),
								i
									...
									: ((i = !0),
										([n, s] = [s, n]),
										n.forEach(u),
										e && I.value && I.value.frameloop[e].push(l),
										(l = 0),
										n.clear(),
										(i = !1),
										r && ((r = !1), h.process(t)));
		...
		y = () => {
			const a = n.useManualTiming ? r.timestamp : performance.now();
			(s = !1),
				n.useManualTiming ||
					(r.delta = i ? 1e3 / 60 : Math.max(Math.min(a - r.timestamp, 40), 1)),
				(r.timestamp = a),
				(r.isProcessing = !0),
				l.process(r),
				u.process(r),
	...
	return {
		schedule: D.reduce((e, n) => {
			const a = o[n];
			return (
				(e[n] = (e, n = !1, o = !1) => (
					s || ((s = !0), (i = !0), r.isProcessing || t(y)), a.schedule(e, n, o)
				)),
				e
			);
		}, {}),
...
const {
	...
	"undefined" != typeof requestAnimationFrame ? requestAnimationFrame : a,
	!0,
);
let W;
function Y() {
...
const $ = {
		now: () => (
			void 0 === W &&
				$.set(
					K.isProcessing || n.useManualTiming ? K.timestamp : performance.now(),
				),
			W
		),
		set: (t) => {
			(W = t), queueMicrotask(Y);
		},
	},
	L = (t) => (e) => "string" == typeof e && e.startsWith(t),
	U = L("--"),
	X = L("var(--"),
	q = (t) => !!X(t) && z.test(t.split("/*")[0].trim()),
	z =
...
const Q =
	...
	tt = (t, e) => (n) =>
		Boolean(
			("string" == typeof n && Q.test(n) && n.startsWith(t)) ||
				(e &&
					!(function (t) {
						return null == t;
					})(n) &&
	...
	nt = { ...Z, transform: (t) => Math.round(((t) => e(0, 255, t))(t)) },
	st = {
		test: tt("rgb", "red"),
...
const it = {
	...
	ct = (() => ({
		...
		transform: (t) => ot.transform(100 * t),
	}))(),
	dt = {
		test: tt("hsl", "hue"),
	...
	pt = {
		test: (t) => st.test(t) || it.test(t) || dt.test(t),
		parse: (t) =>
			st.test(t) ? st.parse(t) : dt.test(t) ? dt.parse(t) : it.parse(t),
		transform: (t) =>
			"string" == typeof t
				? t
		...
		getAnimatableNone: (t) => {
			const e = pt.parse(t);
			return (e.alpha = 0), pt.transform(e);
		},
	},
	mt =
...
function vt(t) {
	...
	const a = e
		.replace(
			...
			(t) => (
				pt.test(t)
					? (s.color.push(r), i.push(yt), n.push(pt.parse(t)))
					: t.startsWith("var(")
						? (s.var.push(r), i.push("var"), n.push(t))
						: (s.number.push(r), i.push(ft), n.push(parseFloat(t))),
				++r,
				"${}"
			),
		)
...
function wt(t) {
	...
	return (t) => {
		...
		for (let r = 0; r < s; r++)
			if (((i += e[r]), void 0 !== t[r])) {
				const e = n[r];
				i += e === ft ? G(t[r]) : e === yt ? pt.transform(t[r]) : t[r];
			}
		return i;
	};
}
const Tt = (t) =>
	"number" == typeof t ? 0 : pt.test(t) ? pt.getAnimatableNone(t) : t;
const Mt = {
	test: function (t) {
		return (
			isNaN(t) &&
			"string" == typeof t &&
			(t.match(J)?.length || 0) + (t.match(mt)?.length || 0) > 0
		);
	},
	parse: bt,
...
const St = (t, e, n) => t + (e - t) * n,
	...
	kt = [it, st, dt];
function Ct(t) {
	const e = ((n = t), kt.find((t) => t.test(n)));
	var n;
...
const Ft = (t, e) => {
		const n = Ct(t),
			s = Ct(e);
		if (!n || !s) return At(t, e);
		const i = { ...n };
		return (t) => (
			(i.red = xt(n.red, s.red, t)),
			(i.green = xt(n.green, s.green, t)),
			(i.blue = xt(n.blue, s.blue, t)),
			(i.alpha = St(n.alpha, s.alpha, t)),
			st.transform(i)
		);
	},
...
function It(t, e) {
	const n = { ...t, ...e },
		s = {};
	for (const i in n)
		void 0 !== t[i] && void 0 !== e[i] && (s[i] = Ot(t[i])(t[i], e[i]));
	return (t) => {
...
const Rt = (t, e) => {
	...
	return s.indexes.var.length === i.indexes.var.length &&
		...
		? (Pt.has(t) && !i.values.length) || (Pt.has(e) && !s.values.length)
			? (function (t, e) {
					return Pt.has(t) ? (n) => (n <= 0 ? t : e) : (n) => (n >= 1 ? e : t);
				})(t, e)
			: l(
					Dt(
						(function (t, e) {
...
const Nt = (t) => {
		...
		return {
			start: (t = !0) => B.update(e, t),
			stop: () => N(e),
			now: () => (K.isProcessing ? K.timestamp : $.now()),
		};
	},
	Kt = (t, e, n = 10) => {
		let s = "";
...
const Lt = 100,
	...
	Zt = 0.3,
	Ht = 0.3,
	_t = { granular: 0.01, default: 2 },
	Gt = { granular: 0.005, default: 0.5 },
	Jt = 0.01,
	Qt = 10,
	te = 0.05,
	ee = 1,
			...
			? ((r = (e) => {
				...
				(a = (e) => {
					const n = e * o * t,
						...
						l = Math.exp(-n),
						u = re(Math.pow(e, 2), o);
					return ((-r(e) + ne > 0 ? -1 : 1) * ((i - a) * l)) / u;
				}))
			: ((r = (e) => Math.exp(-e * t) * ((e - s) * t + 1) - 0.001),
				(a = (e) => Math.exp(-e * t) * (t * t * (s - e))));
	const l = (function (t, e, n) {
		let s = n;
		for (let n = 1; n < ie; n++) s -= t(s) / e(s);
		return s;
	})(r, a, 5 / t);
	if (((t = c(t)), isNaN(l)))
		return { stiffness: Lt, damping: Ut, duration: t };
	{
		const e = Math.pow(l, 2) * i;
		return { stiffness: e, damping: 2 * o * Math.sqrt(i * e), duration: t };
	}
}
const ie = 12;
function re(t, e) {
...
function ue(t = Ht, n = Zt) {
			...
			if (!le(t, oe) && le(t, ae))
				if (t.visualDuration) {
					const s = t.visualDuration,
						i = (2 * Math.PI) / (1.2 * s),
						r = i * i,
						a = 2 * e(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(r);
					n = { ...n, mass: Xt, stiffness: r, damping: a };
				} else {
					const e = se(t);
					(n = { ...n, ...e, mass: Xt }), (n.isResolvedFromDuration = !0);
				}
			return n;
		})({ ...s, velocity: -d(s.velocity || 0) }),
		g = f || 0,
		v = h / (2 * Math.sqrt(u * p)),
		b = o - a,
		w = d(Math.sqrt(u / p)),
	...
	let M;
	if (
		(i || (i = T ? _t.granular : _t.default),
		r || (r = T ? Gt.granular : Gt.default),
		v < 1)
	) {
		const t = re(w, v);
		M = (e) => {
			const n = Math.exp(-v * w * e);
			return (
				o - n * (((g + v * w * b) / t) * Math.sin(t * e) + b * Math.cos(t * e))
			);
		};
	} else if (1 === v) M = (t) => o - Math.exp(-w * t) * (b + (g + w * b) * t);
	else {
		...
		M = (e) => {
			const n = Math.exp(-v * w * e),
				s = Math.min(t * e, 300);
			return (
				o - (n * ((g + v * w * b) * Math.sinh(s) + t * b * Math.cosh(s))) / t
			);
		};
	}
	const V = {
		...
		toString: () => {
			const t = Math.min(Wt(V), jt),
				e = Kt((e) => V.next(t * e).value, t, 30);
			return t + "ms " + e;
		},
		toTransition: () => {},
	};
...
function ce(t, s, { clamp: i = !0, ease: r, mixer: o } = {}) {
	const h = t.length;
	if ((s.length, 1 === h)) return () => s[0];
	if (2 === h && s[0] === s[1]) return () => s[1];
	const c = t[0] === t[1];
	t[0] > t[h - 1] && ((t = [...t].reverse()), (s = [...s].reverse()));
	const d = (function (t, e, s) {
		...
		p = d.length,
		m = (e) => {
			if (c && e < t[0]) return s[0];
			let n = 0;
			if (p > 1) for (; n < t.length - 2 && !(e < t[n + 1]); n++);
			const i = u(t[n], t[n + 1], e);
			return d[n](i);
		};
	return i ? (n) => m(e(t[0], t[h - 1], n)) : m;
}
function de(t, e) {
...
function me({
	...
	const i = C(s) ? s.map(O) : O(s),
		r = { done: !1, value: e[0] },
		a = (function (t, e) {
			return t.map((t) => t * e);
		})(n && n.length === e.length ? n : pe(e), t),
		o = ce(a, e, {
			ease: Array.isArray(i)
				? i
				: ((l = e), (u = i), l.map(() => u || k).splice(0, l.length - 1)),
		});
	var l, u;
	return {
...
ue.applyToOptions = (t) => {
	const e = Yt(t, 100, ue);
	return (
		(t.ease = e.ease), (t.duration = c(e.duration)), (t.type = "keyframes"), t
	);
};
const fe = (t) => null !== t;
...
const ge = { decay: he, inertia: he, tween: me, keyframes: me, spring: ue };
function ve(t) {
	"string" == typeof t.type && (t.type = ge[t.type]);
}
class be {
	constructor() {
		this.updateFinished();
...
class Te extends be {
	constructor(t) {
		super(),
			...
			(this.stop = () => {
				...
				t && t.updatedAt !== $.now() && this.tick($.now()),
					(this.isStopped = !0),
	...
	initAnimation() {
		...
		o !== me &&
			"number" != typeof a[0] &&
			((this.mixKeyframes = l(we, Bt(a[0], a[1]))), (a = [0, 100]));
		const u = o({ ...t, keyframes: a });
		"mirror" === i &&
			...
			null === u.calculatedDuration && (u.calculatedDuration = Wt(u));
	...
	tick(t, n = !1) {
		...
		if (c) {
			...
			let n = Math.floor(t),
				s = t % 1;
			!s && t >= 1 && (s = 1), 1 === s && n--, (n = Math.min(n, c + 1));
			Boolean(n % 2) &&
				("reverse" === d
					? ((s = 1 - s), p && (s -= p / o))
					: "mirror" === d && (w = a)),
		...
		const T = v ? { done: !1, value: h[0] } : w.next(b);
		r && (T.value = r(T.value));
		let { done: M } = T;
		v ||
			null === l ||
		...
		return (
			V && m !== he && (T.value = ye(h, this.options, y, this.speed)),
			f && f(T.value),
			V && this.finish(),
			T
		);
	...
	play() {
		...
		const { driver: t = Nt, startTime: e } = this.options;
...
const Me = (t) => (180 * t) / Math.PI,
	...
	Se = (t) => ((t %= 360) < 0 && (t += 360), t),
	xe = (t) => Math.sqrt(t[0] * t[0] + t[1] * t[1]),
	ke = (t) => Math.sqrt(t[4] * t[4] + t[5] * t[5]),
	Ce = {
		x: 12,
		y: 13,
		z: 14,
		...
		scaleY: ke,
		scale: (t) => (xe(t) + ke(t)) / 2,
		rotateX: (t) => Se(Me(Math.atan2(t[6], t[5]))),
		rotateY: (t) => Se(Me(Math.atan2(-t[2], t[0]))),
		rotateZ: Ve,
		rotate: Ve,
...
function $e() {
	...
	(We = !1), (je = !1), Ke.forEach((t) => t.complete(Ye)), Ke.clear();
}
function Le() {
	Ke.forEach((t) => {
...
class Ue {
	...
	scheduleResolve() {
		(this.state = "scheduled"),
			this.isAsync
				? (Ke.add(this), je || ((je = !0), B.read(Le), B.resolveKeyframes($e)))
...
const Xe = r(() => void 0 !== window.ScrollTimeline),
	qe = {};
function ze(t, e) {
	const n = r(t);
	return () => qe[e] ?? n();
...
class tn extends be {
	constructor(t) {
		...
		(this.animation = Je(e, n, s, l, i)),
			!1 === l.autoplay && this.animation.pause(),
			(this.animation.onfinish = () => {
				if (((this.finishedTime = this.time), !i)) {
					const t = ye(s, this.options, a, this.speed);
	...
	set time(t) {
		(this.finishedTime = null), (this.animation.currentTime = c(t));
	}
	get speed() {
	...
	attachTimeline({ timeline: t, observe: e }) {
		return (
			...
			t && Xe() ? ((this.animation.timeline = t), a) : e(this)
		);
	}
}
const en = { anticipate: T, backInOut: w, circInOut: A };
function nn(t) {
	"string" == typeof t.ease && t.ease in en && (t.ease = en[t.ease]);
}
class sn extends tn {
	constructor(t) {
		nn(t),
	...
	updateMotionValue(t) {
		...
		const a = new Te({ ...r, autoplay: !1 }),
			o = c(this.finishedTime ?? this.time);
...
const on = new Set(["opacity", "clipPath", "filter", "transform"]),
	ln = r(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
class un extends be {
	constructor({
		autoplay: t = !0,
		delay: e = 0,
	...
	onKeyframesResolved(t, e, s, i) {
		...
		(this.resolvedAt = $.now()),
			(function (t, e, n, s) {
				...
				((!n.instantAnimations && u) || c?.(ye(t, s, e)),
				(t[0] = t[t.length - 1]),
				an(s),
				(s.repeat = 0));
		const d = {
			...
			p =
				...
				(function (t) {
					...
					? new sn({ ...d, element: d.motionValue.owner.current })
					: new Te(d);
		p.finished.then(() => this.notifyFinished()).catch(a),
	...
	get animation() {
		return (
			this._animation ||
				(this.keyframeResolver?.resume(), (Ye = !0), Le(), $e(), (Ye = !1)),
			this._animation
		);
	}
	get duration() {
...
function pn(t, e, n = 1) {
	...
	if (a) {
		const t = a.trim();
		return s(t) ? parseFloat(t) : t;
	}
	return q(r) ? pn(r, e, n + 1) : r;
}
function mn(t, e) {
...
const fn = new Set([
	...
	yn = (t) => (e) => e.test(t),
	gn = [Z, lt, ot, at, ht, ut, { test: (t) => "auto" === t, parse: (t) => t }],
	vn = (t) => gn.find(yn(t));
function bn(t) {
	return "number" == typeof t
		? 0 === t
...
function Cn(t, e) {
	let n = kn(t);
	return (
		n !== Vn && (n = Mt), n.getAnimatableNone ? n.getAnimatableNone(e) : void 0
	);
}
...
class Pn extends Ue {
	...
	readKeyframes() {
		...
		for (let n = 0; n < t.length; n++) {
			...
			if ("string" == typeof s && ((s = s.trim()), q(s))) {
				const i = pn(s, e.current);
				void 0 !== i && (t[n] = i),
					n === t.length - 1 && (this.finalKeyframe = s);
			}
		}
		if ((this.resolveNoneKeyframes(), !fn.has(n) || 2 !== t.length)) return;
		const [s, i] = t,
			r = vn(s),
			a = vn(i);
		if (r !== a)
	...
	resolveNoneKeyframes() {
		const { unresolvedKeyframes: t, name: e } = this,
			n = [];
		for (let e = 0; e < t.length; e++) (null === t[e] || bn(t[e])) && n.push(e);
		n.length &&
			(function (t, e, n) {
				let s,
					i = 0;
				...
				if (s && n) for (const i of e) t[i] = Cn(n, s);
			})(t, n, e);
	}
	measureInitialState() {
	...
	measureEndState() {
		...
		const i = n.length - 1,
			r = n[i];
		(n[i] = Ne[e](t.measureViewportBox(), window.getComputedStyle(t.current))),
...
const En = (t, e) => (e && "number" == typeof t ? e.transform(t) : t);
class On {
	constructor(t, e = {}) {
...
const { schedule: In, cancel: Rn } = R(queueMicrotask, !1);
function Bn(t) {
	return "object" == typeof (e = t) && null !== e && "ownerSVGElement" in t;
	var e;
}
const Nn = (t) => Boolean(t && t.getVelocity),
	Kn = [...gn, pt, Mt];
function jn(t) {
	return "object" == typeof t && !Array.isArray(t);
}
function Wn(t, e, n, s) {
	return "string" == typeof t && jn(e)
		? (function (t, e, n) {
...
function Ln(e, n, s, i, r, a) {
	...
	for (let t = 0; t < n.length; t++)
		e.push({ value: n[t], at: St(r, a, i[t]), easing: F(s, t) });
}
function Un(t, e) {
...
function is(t, e) {
	...
	if (((i = s), Boolean(Nn(i) && i.add))) return s.add(e);
	if (!s && n.WillChange) {
...
const rs = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
	as = "data-" + rs("framerAppearId");
function os(t) {
	return t.props[as];
}
const ls = (t) => null !== t;
const us = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
	...
	cs = { type: "keyframes", ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
	ds = (t, { keyframes: e }) =>
		e.length > 2
			? hs
			: De.has(t)
...
const ps =
	...
	(o) => {
		...
		if (
			...
			if (void 0 !== t)
				return void B.update(() => {
					d.onUpdate(t), d.onComplete();
				});
		}
		return l.isSync ? new Te(d) : new un(d);
	};
function ms({ protectedKeys: t, needsAnimating: e }, n) {
	const s = t.hasOwnProperty(n) && !0 !== e[n];
	return (e[n] = !1), s;
}
function fs(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
	...
	for (const e in o) {
		const s = t.getValue(e, t.latestValues[e] ?? null),
			i = o[e];
		if (void 0 === i || (u && ms(u, e))) continue;
		const a = { delay: n, ...mn(r || {}, e) },
			h = s.get();
		if (
			void 0 !== h &&
			!s.isAnimating &&
		...
		if (window.MotionHandoffAnimation) {
			const n = os(t);
			if (n) {
				const t = window.MotionHandoffAnimation(n, e, B);
				null !== t && ((a.startTime = t), (c = !0));
			}
		}
		is(t, e),
			s.start(
				ps(e, s, i, t.shouldReduceMotion && fn.has(e) ? { type: !1 } : a, t, c),
			);
		const d = s.animation;
		d && l.push(d);
	}
...
const ys = {
	...
	gs = {};
for (const t in ys) gs[t] = { isEnabled: (e) => ys[t].some((t) => !!e[t]) };
const vs = () => ({ x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }),
...
class Ss {
	...
	constructor(
		...
		(this.latestValues = o),
			...
			(this.isControllingVariants = Vs(e)),
					...
					if (((Ts.current = !0), bs))
						if (window.matchMedia) {
							const t = window.matchMedia("(prefers-reduced-motion)"),
								e = () => (ws.current = t.matches);
							t.addEventListener("change", e), e();
						} else ws.current = !1;
				})(),
			(this.shouldReduceMotion =
				"never" !== this.reducedMotionConfig &&
				("always" === this.reducedMotionConfig || ws.current)),
	...
	update(t, e) {
		...
		(this.prevMotionValues = (function (t, e, n) {
			for (const s in e) {
				const i = e[s],
					r = n[s];
				if (Nn(i)) t.addValue(s, i);
				else if (Nn(r)) t.addValue(s, Dn(i, { owner: t }));
				else if (r !== i)
					if (t.hasValue(s)) {
						...
						t.addValue(s, Dn(void 0 !== e ? e : i, { owner: t }));
					}
			}
	...
	getValue(t, e) {
		...
		return (
			void 0 === n &&
				void 0 !== e &&
				((n = Dn(null === e ? void 0 : e, { owner: this })),
				this.addValue(t, n)),
			n
		);
	}
	readValue(t, e) {
		...
		return (
			null != n &&
				("string" == typeof n && (s(n) || i(n))
					? (n = parseFloat(n))
					: ((r = n), !Kn.find(yn(r)) && Mt.test(e) && (n = Cn(t, e))),
				this.setBaseTarget(t, Nn(n) ? n.get() : n)),
			Nn(n) ? n.get() : n
		);
	}
	setBaseTarget(t, e) {
	...
	getBaseTarget(t) {
		...
		if ("string" == typeof e || "object" == typeof e) {
			const s = ts(this.props, e, this.presenceContext?.custom);
			s && (n = s[t]);
		}
		if (e && void 0 !== n) return n;
		const s = this.getBaseTargetFromProps(this.props, t);
		return void 0 === s || Nn(s)
...
function Ps(t, { style: e, vars: n }, s, i) {
	...
	let a;
	for (a in e) r[a] = e[a];
	for (a in (i?.applyProjectionStyles(r, s), n)) r.setProperty(a, n[a]);
}
const Es = {};
...
function Ds(t, e, n) {
	...
	for (const r in s)
		(Nn(s[r]) ||
			(e.style && Nn(e.style[r])) ||
			Os(r, t) ||
			void 0 !== n?.getValue(r)?.liveStyle) &&
			(i[r] = s[r]);
	return i;
}
class Is extends xs {
	...
	readValueFromInstance(t, e) {
					...
					})(t, e);
		{
			const s = ((n = t), window.getComputedStyle(n)),
				i = (U(e) ? s.getPropertyValue(e) : s[e]) || 0;
...
function Ks(
	...
	c.transform && ((d.transform = c.transform), delete c.transform),
		...
		d.transform &&
			((d.transformBox = h?.transformBox ?? "fill-box"), delete c.transformBox),
		void 0 !== e && (c.x = e),
		void 0 !== n && (c.y = n),
		void 0 !== s && (c.scale = s),
		void 0 !== i &&
			(function (t, e, n = 1, s = 0, i = !0) {
				t.pathLength = 1;
				const r = i ? Bs : Ns;
				t[r.offset] = lt.transform(-s);
				const a = lt.transform(e),
					o = lt.transform(n);
				t[r.array] = `${a} ${o}`;
			})(c, i, r, a, !1);
}
...
class Ws extends xs {
	constructor() {
		super(...arguments),
			(this.type = "svg"),
			(this.isSVGTag = !1),
			(this.measureInstanceViewportBox = vs);
	}
	getBaseTargetFromProps(t, e) {
		return t[e];
	}
	readValueFromInstance(t, e) {
		...
		return (e = js.has(e) ? e : rs(e)), t.getAttribute(e);
	}
	scrapeMotionValuesFromProps(t, e, n) {
	...
	renderInstance(t, e, n, s) {
		!(function (t, e, n, s) {
			...
			for (const n in e.attrs)
				t.setAttribute(js.has(n) ? n : rs(n), e.attrs[n]);
		})(t, e, 0, s);
	}
	mount(t) {
		var e;
...
function Ys(t) {
	const e = {
		...
		n =
			Bn(t) &&
			!(function (t) {
				return Bn(t) && "svg" === t.tagName;
			})(t)
				? new Ws(e)
				: new Is(e);
	n.mount(t), Jn.set(t, n);
}
function $s(t) {
	const e = new Rs({
		presenceContext: null,
	...
	e.mount(t), Jn.set(t, e);
}
function Ls(t, e, n, s) {
	const i = [];
	if (
		(function (t, e) {
			return Nn(t) || "number" == typeof t || ("string" == typeof t && !jn(e));
		})(t, e)
	)
		i.push(
			(function (t, e, n) {
			...
			})(t, (jn(e) && e.default) || e, (n && n.default) || n),
		);
	else {
		const r = Wn(t, e, s),
			a = r.length;
		for (let t = 0; t < a; t++) {
			const s = r[t],
				o = s instanceof Element ? Ys : $s;
			Jn.has(s) || o(s);
			const l = Jn.get(s),
				u = { ...n };
			"delay" in u && "function" == typeof u.delay && (u.delay = u.delay(t, a)),
				i.push(...fs(l, { ...e, transition: u }, {}));
		}
	}
	return i;
}
	...
	const s = [],
		i = (function (t, { defaultTransition: e = {}, ...n } = {}, s, i) {
			...
			for (let n = 0; n < t.length; n++) {
				...
				if (!Array.isArray(a)) {
					h.set(a.name, $n(p, a.at, d, h));
					continue;
				}
				let [u, f, y = {}] = a;
				void 0 !== y.at && (p = $n(p, y.at, d, h));
				let g = 0;
				const v = (t, n, s, a = 0, o = 0) => {
					const l = Zn(t),
						{
							delay: u = 0,
							times: h = pe(l),
					...
					let { ease: w = e.ease || "easeOut", duration: T } = n;
					const M = "function" == typeof u ? u(a, o) : u,
						V = l.length,
						A = Qe(d) ? d : i?.[d || "keyframes"];
					if (V <= 2 && A) {
						let t = 100;
						if (2 === V && Gn(l)) {
							const e = l[1] - l[0];
					...
					const x = h.length - l.length;
					if ((x > 0 && de(h, x), 1 === l.length && l.unshift(null), f)) {
						T = Yn(T, f);
						const t = [...l],
							e = [...h];
						...
						for (let s = 0; s < f; s++) {
							...
							for (let i = 0; i < t.length; i++)
								h.push(e[i] + (s + 1)),
									w.push(0 === i ? "linear" : F(n, i - 1));
						}
						Un(h, f);
					}
					const k = S + T;
					Ln(s, l, w, h, S, k), (g = Math.max(M + T, g)), (m = Math.max(k, m));
				};
				if (Nn(u)) v(f, y, zn("default", qn(u, o)));
				else {
					const t = Wn(u, f, s, l),
						e = t.length;
					for (let n = 0; n < e; n++) {
						const s = qn(t[n], o);
						for (const t in f) v(f[t], Hn(y, t), zn(t, s), n, e);
					}
				}
				(d = p), (p += g);
			}
				...
				o.forEach((t, s) => {
					for (const i in t) {
						...
						for (let t = 0; t < r.length; t++) {
							...
							o.push(n), l.push(u(0, m, e)), h.push(s || "easeOut");
						}
						0 !== l[0] &&
							(l.unshift(0), o.unshift(o[0]), h.unshift("easeInOut")),
...
const qs = Xs();
export { qs as animate, Xs as createScopedAnimate };
