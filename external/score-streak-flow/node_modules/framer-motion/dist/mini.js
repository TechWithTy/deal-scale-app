!(function (t, e) {
	...
	const h = (t) => t.startsWith("--");
	const d = n(() => void 0 !== window.ScrollTimeline),
		m = {};
	function c(t, e) {
		const i = n(t);
		return () => m[e] ?? i();
	...
	const p = c(() => {
		...
		f = ([t, e, i, n]) => `cubic-bezier(${t}, ${e}, ${i}, ${n})`,
		y = {
			linear: "linear",
			ease: "ease",
			easeIn: "ease-in",
	...
	class T extends l {
				...
				(this.animation.onfinish = () => {
					if (((this.finishedTime = this.time), !s)) {
						const t = (function (
							...
							const a = t.filter(r),
								o =
									s < 0 || (e && "loop" !== i && e % 2 == 1) ? 0 : a.length - 1;
							return o && void 0 !== n ? n : a[o];
						})(n, this.options, o, this.speed);
						this.updateMotionValue
							? this.updateMotionValue(t)
							: (function (t, e, i) {
									h(e) ? t.style.setProperty(e, i) : (t.style[e] = i);
								})(e, i, t),
		...
		set time(t) {
			(this.finishedTime = null), (this.animation.currentTime = a(t));
		}
		get speed() {
		...
		attachTimeline({ timeline: t, observe: e }) {
			return (
				...
				t && d() ? ((this.animation.timeline = t), s) : e(this)
			);
		}
	}
	class b {
	...
	function k(t, e) {
		for (let i = 0; i < t.length; i++)
			"number" == typeof t[i] && S.has(e) && (t[i] = t[i] + "px");
	}
	function M(t, e) {
		const i = window.getComputedStyle(t);
		return h(e) ? i.getPropertyValue(e) : i[e];
	}
	function x(t, e, i, n) {
		...
		for (let t = 0; t < o; t++) {
			...
			for (const t in e) {
				...
				Array.isArray(i) || (i = [i]);
				const s = { ...v(l, t) };
				s.duration && (s.duration = a(s.duration)),
					s.delay && (s.delay = a(s.delay));
				const o = R(n),
					u = E(t, s.pseudoElement || ""),
					h = o.get(u);
				h && h.stop(),
					r.push({
						map: o,
		...
		for (let t = 0; t < r.length; t++) {
			const { unresolvedKeyframes: e, options: i } = r[t],
				{ element: n, name: s, pseudoElement: a } = i;
			a || null !== e[0] || (e[0] = M(n, s)),
				u(e),
				k(e, s),
				!a && e.length < 2 && e.unshift(M(n, s)),
				(i.keyframes = e);
		}
		const l = [];
		for (let t = 0; t < r.length; t++) {
			const { map: e, key: i, options: n } = r[t],
				s = new T(n);
			e.set(i, s), s.finished.finally(() => e.delete(i)), l.push(s);
		}
		return l;
	}
	t.useAnimate = function () {
		const t = i(() => ({ current: null, animations: [] })),
			n = i(() =>
				((t) =>
					function (e, i, n) {
						return new A(x(e, i, n, t));
					})(t),
			);
		var s;
		return (
