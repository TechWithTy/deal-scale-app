...
import {
	V as VisualElement,
	M as MotionProps,
	C as CreateVisualElement,
	a as MotionConfigContext,
	H as HTMLElements,
	b as HTMLMotionProps,
	D as DOMMotionComponents,
	c as HTMLMotionComponents,
	S as SVGMotionComponents,
	d as VisualElementAnimationOptions,
	I as IProjectionNode,
	R as ResolvedValues,
	e as HTMLRenderState,
} from "../types.d-DsEeKk6G.js";
export {
	A as AnimationType,
	p as FlatTree,
	F as ForwardRefComponent,
	i as MotionStyle,
	j as MotionTransform,
	P as PresenceContext,
	l as SVGAttributesAsMotionValues,
	n as SVGMotionProps,
	f as ScrapeMotionValuesFromProps,
	h as SwitchLayoutGroupContext,
	k as VariantLabels,
	g as VisualState,
...
declare function ReorderGroupComponent<
	V,
	TagName extends ReorderElementTag = DefaultGroupElement,
>(
	{
...
declare const ReorderGroup: <V, TagName extends keyof HTMLElements = "ul">(
	props: ReorderGroupProps<V, TagName> & {
...
> = Props<V, TagName> &
	...
	React$1.PropsWithChildren<{}>;
declare function ReorderItemComponent<
	V,
	TagName extends ReorderElementTag = DefaultItemElement,
>(
	{
...
declare const ReorderItem: <V, TagName extends keyof HTMLElements = "li">(
	props: ReorderItemProps<V, TagName> & {
		ref?: React$1.ForwardedRef<any>;
	},
...
declare const m: typeof createMotionComponent &
	HTMLMotionComponents &
	SVGMotionComponents & {
		create: typeof createMotionComponent;
	};

declare const motion: typeof createMotionComponent &
	HTMLMotionComponents &
	SVGMotionComponents & {
		create: typeof createMotionComponent;
	};
...
declare function useMotionValueEvent<
	V,
...
declare class WillChangeMotionValue
...
declare function useAnimate<T extends Element = any>(): [
	AnimationScope<T>,
	{
		(
			sequence: AnimationSequence,
		...
		<V extends string | number>(
			value: V | motion_dom.MotionValue<V>,
			keyframes: V | motion_dom.UnresolvedValueKeyframe<V>[],
			options?: motion_dom.ValueAnimationTransition<V> | undefined,
		): motion_dom.AnimationPlaybackControlsWithThen;
		(
...
declare function useAnimateMini<T extends Element = any>(): [
	AnimationScope<T>,
	(
 ...
 */
declare function isMotionComponent(
 ...
 */
declare function unwrapMotionComponent(
	component: React.ComponentType | string,
...
declare const visualElementStore: WeakMap<
	any,
	VisualElement<unknown, unknown, {}>
>;
...
declare function startOptimizedAppearAnimation(
	element: HTMLElement,
	name: string,
...
export {
	...
	type HydratedFeatureDefinitions,
	IProjectionNode,
	LayoutGroup,
	LayoutGroupContext,
