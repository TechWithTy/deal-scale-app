...
export declare function isButtonElement(
	object: any,
...
>;
export declare function shouldProcessLinkClick(
...
export declare function getSearchParamsForLocation(
...
export declare function getFormSubmissionInfo(
	target: SubmitTarget,
	basename: string,
): {
	action: string | null;
