 ...
 */
function RouterProvider({ fallbackElement, router, future }) {
 ...
 */
function HashRouter({ basename, children, future, window }) {
	let historyRef = React.useRef();
	if (historyRef.current == null) {
 ...
 */
function HistoryRouter({ basename, children, future, history }) {
	let [state, setStateImpl] = React.useState({
		action: history.action,
		location: history.location,
	});
 ...
 * changes.
 */
function ScrollRestoration({ getKey, storageKey }) {
