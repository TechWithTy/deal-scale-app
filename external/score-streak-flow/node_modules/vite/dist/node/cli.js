...
cli
	...
	.action(async (root, options) => {
		...
		const { createServer } = await import("./chunks/dep-D_zLpgQd.js").then(
			function (n) {
				return n.F;
			},
		);
...
cli
	...
	.action(async (root, options) => {
		filterDuplicateOptions(options);
		const { build } = await import("./chunks/dep-D_zLpgQd.js").then(
			function (n) {
				return n.G;
			},
		);
...
cli
	...
	.action(async (root, options) => {
		filterDuplicateOptions(options);
		const { optimizeDeps } = await import("./chunks/dep-D_zLpgQd.js").then(
			function (n) {
				return n.E;
			},
		);
...
cli
	...
	.action(async (root, options) => {
		filterDuplicateOptions(options);
		const { preview } = await import("./chunks/dep-D_zLpgQd.js").then(
			function (n) {
				return n.H;
			},
		);
